...
public final class GregorianMath {
    ...
    public static boolean isLeapYear(int i) {
        return (i <= 1900 || i >= 2100) ? ((i & 3) == 0 && i % 100 != 0) || i % StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB == 0 : (i & 3) == 0;
    }
    ...
    public static long toPackedDate(long j) {
        long j2;
        long safeAdd = MathUtils.safeAdd(j, 678881);
        ...
        if (floorModulo == 146096) {
            ...
            int i6 = i4 % 1461;
            if (i6 == 1460) {
                j2 = (floorDivide * 400) + ((long) (i3 * 100)) + ((long) ((i5 + 1) * 4));
            } else {
                int i7 = i6 / 365;
                int i8 = i6 % 365;
                j2 = (floorDivide * 400) + ((long) (i3 * 100)) + ((long) (i5 * 4)) + ((long) i7);
                i2 = 2 + (((i8 + 31) * 5) / 153);
                i = (i8 - (((i2 + 1) * 153) / 5)) + 123;
                if (i2 > 12) {
                    j2++;
    ...
    public static long toMJD(int i, int i2, int i3) {
        ...
        return (((((((365 * j) + MathUtils.floorDivide(j, 4)) - MathUtils.floorDivide(j, 100)) + MathUtils.floorDivide(j, (int) StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB)) + ((long) (((i2 + 1) * 153) / 5))) - 123) + ((long) i3)) - 678881;
    }
