...
public final class ViewPropertyAnimatorCompat {
    ...
    public ViewPropertyAnimatorCompat setUpdateListener(ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener) {
        ...
        if (view != null && Build.VERSION.SDK_INT >= 19) {
            $$Lambda$ViewPropertyAnimatorCompat$XOeeZ3zgiQP_YgNCy4Y7jVqc r1 = null;
            if (viewPropertyAnimatorUpdateListener != null) {
                r1 = new ValueAnimator.AnimatorUpdateListener(view) {
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ViewPropertyAnimatorUpdateListener.this.onAnimationUpdate(this.f$1);
                    }
                };
            }
            Api19Impl.setUpdateListener(view.animate(), r1);
        }
        return this;
    }
