...
public final class RegionKt {
    ...
    public static final Region plus(Region region, Rect rect) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(rect, JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR);
    ...
    public static final Region plus(Region region, Region region2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(region2, JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR);
