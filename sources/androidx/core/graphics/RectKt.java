...
public final class RectKt {
    ...
    public static final Rect plus(Rect rect, Rect rect2) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        Intrinsics.checkNotNullParameter(rect2, JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR);
    ...
    public static final RectF plus(RectF rectF, RectF rectF2) {
        Intrinsics.checkNotNullParameter(rectF, "<this>");
        Intrinsics.checkNotNullParameter(rectF2, JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR);
    ...
    public static final boolean contains(Rect rect, Point point) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        Intrinsics.checkNotNullParameter(point, JWKParameterNames.RSA_FIRST_PRIME_FACTOR);
        return rect.contains(point.x, point.y);
    }

    public static final boolean contains(RectF rectF, PointF pointF) {
        Intrinsics.checkNotNullParameter(rectF, "<this>");
        Intrinsics.checkNotNullParameter(pointF, JWKParameterNames.RSA_FIRST_PRIME_FACTOR);
