...
public final class PointKt {
    ...
    public static final Point plus(Point point, Point point2) {
        Intrinsics.checkNotNullParameter(point, "<this>");
        Intrinsics.checkNotNullParameter(point2, JWKParameterNames.RSA_FIRST_PRIME_FACTOR);
    ...
    public static final PointF plus(PointF pointF, PointF pointF2) {
        Intrinsics.checkNotNullParameter(pointF, "<this>");
        Intrinsics.checkNotNullParameter(pointF2, JWKParameterNames.RSA_FIRST_PRIME_FACTOR);
