...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    private Font findBaseFont(FontFamily fontFamily, int i) {
        FontStyle fontStyle = new FontStyle((i & 1) != 0 ? 700 : StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB, (i & 2) != 0 ? 1 : 0);
    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fontInfoArr, int i) {
        ...
        try {
            ...
            for (FontsContractCompat.FontInfo fontInfo : fontInfoArr) {
                try {
                    openFileDescriptor = contentResolver.openFileDescriptor(fontInfo.getUri(), JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR, cancellationSignal);
