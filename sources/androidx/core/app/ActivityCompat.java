...
public class ActivityCompat extends ContextCompat {
    ...
    public static void recreate(Activity activity) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            new Handler(activity.getMainLooper()).post(new Runnable(activity) {
    ...
    private static class SharedElementCallback21Impl extends SharedElementCallback {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.mCallback.onSharedElementsArrived(list, list2, new SharedElementCallback.OnSharedElementsReadyListener(onSharedElementsReadyListener) {
