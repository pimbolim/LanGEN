...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:88:0x023a  */
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, isAuthenticationRequired);
        }
        ...
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, isAuthenticationRequired);
    }
