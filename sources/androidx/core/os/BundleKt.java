...
public final class BundleKt {
    public static final Bundle bundleOf(Pair<String, ? extends Object>... pairArr) {
        ...
        while (i < length) {
            ...
            if (component2 == null) {
                bundle.putString(component1, (String) null);
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    ...
                    throw new IllegalArgumentException("Illegal value array type " + canonicalName + " for key \"" + component1 + '\"');
                }
                ...
                throw new IllegalArgumentException("Illegal value type " + canonicalName2 + " for key \"" + component1 + '\"');
            } else {
