...
class FontRequestWorker {
    private static final ExecutorService DEFAULT_EXECUTOR_SERVICE = RequestExecutor.createDefaultExecutor("fonts-androidx", 10, PhotoshopDirectory.TAG_PRINT_FLAGS_INFO);
