...
public class ShortcutManagerCompat {
    ...
    public static boolean pushDynamicShortcut(android.content.Context r6, androidx.core.content.pm.ShortcutInfoCompat r7) {
        ...
        L_0x0094:
            ...
            java.util.List r4 = r3.getShortcuts()     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            int r5 = r4.size()     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            if (r5 < r0) goto L_0x00b1
            java.lang.String[] r0 = new java.lang.String[r1]     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            java.lang.String r4 = getShortcutInfoCompatWithLowestRank(r4)     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            r0[r2] = r4     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            r3.removeShortcuts(r0)     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
        L_0x00b1:
            androidx.core.content.pm.ShortcutInfoCompat[] r0 = new androidx.core.content.pm.ShortcutInfoCompat[r1]     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            r0[r2] = r7     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
            r3.addShortcuts(r0)     // Catch:{ Exception -> 0x0105, all -> 0x00e0 }
