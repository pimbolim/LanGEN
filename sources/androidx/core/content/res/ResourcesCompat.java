...
public final class ResourcesCompat {
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackSuccessAsync(Typeface typeface, Handler handler) {
            getHandler(handler).post(new Runnable(typeface) {
                ...
                public final void run() {
                    ResourcesCompat.FontCallback.this.lambda$callbackSuccessAsync$0$ResourcesCompat$FontCallback(this.f$1);
                }
            });
        }

        public final void callbackFailAsync(int i, Handler handler) {
            getHandler(handler).post(new Runnable(i) {
                ...
                public final void run() {
                    ResourcesCompat.FontCallback.this.lambda$callbackFailAsync$1$ResourcesCompat$FontCallback(this.f$1);
                }
            });
        }
    ...
    private static android.graphics.Typeface loadFont(android.content.Context r17, android.content.res.Resources r18, android.util.TypedValue r19, int r20, int r21, androidx.core.content.res.ResourcesCompat.FontCallback r22, android.os.Handler r23, boolean r24, boolean r25) {
        ...
        L_0x0037:
            ...
            return r16
        L_0x003a:
            java.lang.String r2 = r14.toLowerCase()     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            java.lang.String r3 = ".xml"
            boolean r2 = r2.endsWith(r3)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            if (r2 == 0) goto L_0x0071
            android.content.res.XmlResourceParser r2 = r0.getXml(r4)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = androidx.core.content.res.FontResourcesParserCompat.parse(r2, r0)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            if (r2 != 0) goto L_0x005b
            java.lang.String r0 = "Failed to find font-family tag"
            android.util.Log.e(r13, r0)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            if (r11 == 0) goto L_0x005a
            r11.callbackFailAsync(r15, r12)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
        L_0x005a:
            return r16
        L_0x005b:
            int r6 = r1.assetCookie     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            r1 = r17
            r3 = r18
            r4 = r20
            r5 = r14
            ...
            r9 = r23
            r10 = r24
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            return r0
        L_0x0071:
            int r5 = r1.assetCookie     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            r1 = r17
            r2 = r18
            r3 = r20
            r4 = r14
            r6 = r21
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r2, r3, r4, r5, r6)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            if (r11 == 0) goto L_0x008b
            if (r0 == 0) goto L_0x0088
            r11.callbackSuccessAsync(r0, r12)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
            goto L_0x008b
        L_0x0088:
            r11.callbackFailAsync(r15, r12)     // Catch:{ XmlPullParserException -> 0x00a2, IOException -> 0x008c }
        L_0x008b:
