...
public class NavController {
    ...
    public NavController(Context context2) {
        ...
        this.lifecycleObserver = new LifecycleEventObserver() {
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                NavController.m4227lifecycleObserver$lambda2(NavController.this, lifecycleOwner, event);
            }
        };
    ...
    public static final void m4227lifecycleObserver$lambda2(NavController navController, LifecycleOwner lifecycleOwner2, Lifecycle.Event event) {
        ...
        if (!Intrinsics.areEqual((Object) this._graph, (Object) navGraph)) {
            ...
            if (navGraph2 != null) {
                for (Integer num : new ArrayList(this.backStackMap.keySet())) {
                    Intrinsics.checkNotNullExpressionValue(num, MessageExtension.FIELD_ID);
            ...
            if (stringArrayList2 != null) {
                for (String str : stringArrayList2) {
                    ...
                    if (parcelableArray != null) {
                        ...
                        Intrinsics.checkNotNullExpressionValue(str, MessageExtension.FIELD_ID);
