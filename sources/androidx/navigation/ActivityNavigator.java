...
public class ActivityNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public boolean equals(Object obj) {
            ...
            Intent intent2 = this.intent;
            Boolean valueOf = intent2 == null ? null : Boolean.valueOf(intent2.filterEquals(((Destination) obj).intent));
            if (!(valueOf == null ? ((Destination) obj).intent == null : valueOf.booleanValue()) || !Intrinsics.areEqual((Object) this.dataPattern, (Object) ((Destination) obj).dataPattern)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            Intent intent2 = this.intent;
            int i = 0;
            int filterHashCode = (hashCode + (intent2 == null ? 0 : intent2.filterHashCode())) * 31;
