...
public final class Navigation {
    ...
    public static final View.OnClickListener createNavigateOnClickListener(int i, Bundle bundle) {
        return new View.OnClickListener(i, bundle) {
            ...
            public final void onClick(View view) {
                Navigation.m4228createNavigateOnClickListener$lambda0(this.f$0, this.f$1, view);
            }
        };
    }
    ...
    public static final void m4228createNavigateOnClickListener$lambda0(int i, Bundle bundle, View view) {
    ...
    public static final View.OnClickListener createNavigateOnClickListener(NavDirections navDirections) {
        ...
        return new View.OnClickListener() {
            public final void onClick(View view) {
                Navigation.m4229createNavigateOnClickListener$lambda1(NavDirections.this, view);
            }
        };
    }
    ...
    public static final void m4229createNavigateOnClickListener$lambda1(NavDirections navDirections, View view) {
        Intrinsics.checkNotNullParameter(navDirections, "$directions");
        Intrinsics.checkNotNullExpressionValue(view, "view");
