...
final class ConstrainScope$resetDimensions$1 extends Lambda implements Function1<State, Unit> {
    ...
    public final void invoke(State state) {
        ...
        Dimension solverDimension$compose_release = ((DimensionDescription) Dimension.Companion.getWrapContent()).toSolverDimension$compose_release(state);
        state.constraints(this.this$0.getId$compose_release()).width(solverDimension$compose_release).height(solverDimension$compose_release);
    }
}
