...
final class ConstrainScope$horizontalChainWeight$1 extends Lambda implements Function1<State, Unit> {
    final /* synthetic */ float $value;
    final /* synthetic */ ConstrainScope this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConstrainScope$horizontalChainWeight$1(ConstrainScope constrainScope, float f) {
        super(1);
