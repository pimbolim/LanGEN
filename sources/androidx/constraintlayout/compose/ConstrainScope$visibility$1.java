...
final class ConstrainScope$visibility$1 extends Lambda implements Function1<State, Unit> {
    ...
    ConstrainScope$visibility$1(ConstrainScope constrainScope, Visibility visibility) {
        super(1);
    ...
    public final void invoke(State state) {
        ...
        if (Intrinsics.areEqual((Object) visibility, (Object) Visibility.Companion.getInvisible())) {
