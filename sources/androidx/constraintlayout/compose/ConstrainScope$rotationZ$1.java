...
final class ConstrainScope$rotationZ$1 extends Lambda implements Function1<ConstraintReference, Unit> {
    final /* synthetic */ float $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConstrainScope$rotationZ$1(float f) {
        super(1);
        this.$value = f;
    }
    ...
    public final void invoke(ConstraintReference constraintReference) {
        ...
        constraintReference.rotationZ(this.$value);
    }
}
