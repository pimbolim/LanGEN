...
final class ConstraintLayoutBaseScope$createGuidelineFromStart$2 extends Lambda implements Function1<State, Unit> {
    final /* synthetic */ float $fraction;
    final /* synthetic */ int $id;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConstraintLayoutBaseScope$createGuidelineFromStart$2(int i, float f) {
        super(1);
        this.$id = i;
        this.$fraction = f;
    }
