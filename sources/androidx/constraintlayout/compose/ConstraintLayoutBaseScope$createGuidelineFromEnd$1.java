...
final class ConstraintLayoutBaseScope$createGuidelineFromEnd$1 extends Lambda implements Function1<State, Unit> {
    final /* synthetic */ int $id;
    final /* synthetic */ float $offset;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ConstraintLayoutBaseScope$createGuidelineFromEnd$1(int i, float f) {
        super(1);
        this.$id = i;
        this.$offset = f;
    }
    ...
    public final void invoke(State state) {
        ...
        if (state.getLayoutDirection() == LayoutDirection.Ltr) {
            verticalGuideline.end(Dp.m3857boximpl(f));
        } else {
            verticalGuideline.start(Dp.m3857boximpl(f));
        }
    }
}
