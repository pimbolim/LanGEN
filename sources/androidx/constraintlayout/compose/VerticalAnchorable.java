...
public interface VerticalAnchorable {
    ...
    void m4213linkToVpY3zN4(ConstraintLayoutBaseScope.VerticalAnchor verticalAnchor, float f, float f2);

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    /* compiled from: ConstraintScopeCommon.kt */
    public static final class DefaultImpls {
        /* renamed from: linkTo-VpY3zN4$default  reason: not valid java name */
        public static /* synthetic */ void m4214linkToVpY3zN4$default(VerticalAnchorable verticalAnchorable, ConstraintLayoutBaseScope.VerticalAnchor verticalAnchor, float f, float f2, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                ...
                verticalAnchorable.m4213linkToVpY3zN4(verticalAnchor, f, f2);
                return;
            }
