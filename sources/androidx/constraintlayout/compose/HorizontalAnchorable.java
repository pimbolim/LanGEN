...
public interface HorizontalAnchorable {
    ...
    void m4174linkToVpY3zN4(ConstraintLayoutBaseScope.HorizontalAnchor horizontalAnchor, float f, float f2);

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    /* compiled from: ConstraintScopeCommon.kt */
    public static final class DefaultImpls {
        /* renamed from: linkTo-VpY3zN4$default  reason: not valid java name */
        public static /* synthetic */ void m4175linkToVpY3zN4$default(HorizontalAnchorable horizontalAnchorable, ConstraintLayoutBaseScope.HorizontalAnchor horizontalAnchor, float f, float f2, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                ...
                horizontalAnchorable.m4174linkToVpY3zN4(horizontalAnchor, f, f2);
                return;
            }
