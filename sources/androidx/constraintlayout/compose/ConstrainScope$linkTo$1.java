...
final class ConstrainScope$linkTo$1 extends Lambda implements Function1<State, Unit> {
    ...
    ConstrainScope$linkTo$1(float f, ConstrainScope constrainScope) {
        super(1);
        this.$bias = f;
    ...
    public final void invoke(State state) {
        ...
        state.constraints(this.this$0.getId$compose_release()).horizontalBias(state.getLayoutDirection() == LayoutDirection.Rtl ? ((float) 1) - this.$bias : this.$bias);
    }
}
