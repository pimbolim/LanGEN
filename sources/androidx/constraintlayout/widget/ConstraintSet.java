...
public class ConstraintSet {
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            if (i == 0) {
                i = context.getResources().getIdentifier(trim, MessageExtension.FIELD_ID, context.getPackageName());
            }
    ...
    class WriteXmlEngine {
        ...
        public void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout2.mBarrierDirection, new String[]{ViewProps.LEFT, ViewProps.RIGHT, ViewProps.TOP, ViewProps.BOTTOM, ViewProps.START, ViewProps.END}, -1);
