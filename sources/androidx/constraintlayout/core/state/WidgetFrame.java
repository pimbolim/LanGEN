...
public class WidgetFrame {
    ...
    public StringBuilder serialize(StringBuilder sb, boolean z) {
        sb.append("{\n");
        add(sb, ViewProps.LEFT, this.left);
        add(sb, ViewProps.TOP, this.top);
    ...
    public void printCustomAttributes() {
        ...
        if (this.widget != null) {
            str = str2 + "/" + (this.widget.hashCode() % 1000) + StringUtils.SPACE;
        } else {
            str = str2 + "/NULL ";
        }
    ...
    public void logv(String str) {
        String str2;
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str3 = (".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + StringUtils.SPACE + (hashCode() % 1000);
        if (this.widget != null) {
