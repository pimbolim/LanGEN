...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f42me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f42me.tracker = VelocityTracker.obtain();
            return f42me;
        }
    ...
    class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + StringUtils.SPACE + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + StringUtils.SPACE + constraintWidget + StringUtils.SPACE + sb8);
            }
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            Log.v(TAG, StringUtils.SPACE + Debug.getLocation() + StringUtils.SPACE + Debug.getName(this) + StringUtils.SPACE + Debug.getName(getContext(), this.mCurrentState) + StringUtils.SPACE + Debug.getName(childAt) + childAt.getLeft() + StringUtils.SPACE + childAt.getTop());
        }
    }
