...
public final class AndroidViewHolder$layoutNode$1$5 implements MeasurePolicy {
    ...
    public MeasureResult m4096measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$receiver");
        Intrinsics.checkNotNullParameter(list, "measurables");
        if (Constraints.m3805getMinWidthimpl(j) != 0) {
            this.$this_run.getChildAt(0).setMinimumWidth(Constraints.m3805getMinWidthimpl(j));
        }
        if (Constraints.m3804getMinHeightimpl(j) != 0) {
            this.$this_run.getChildAt(0).setMinimumHeight(Constraints.m3804getMinHeightimpl(j));
        }
        ...
        int r10 = Constraints.m3802getMaxHeightimpl(j);
        ...
        return MeasureScope.DefaultImpls.layout$default(measureScope, this.$this_run.getMeasuredWidth(), this.$this_run.getMeasuredHeight(), (Map) null, new AndroidViewHolder$layoutNode$1$5$measure$1(this.$this_run, this.$layoutNode), 4, (Object) null);
    }
