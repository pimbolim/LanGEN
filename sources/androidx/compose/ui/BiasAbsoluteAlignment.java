...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public long m1254alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m4019getWidthimpl(j2) - IntSize.m4019getWidthimpl(j), IntSize.m4018getHeightimpl(j2) - IntSize.m4018getHeightimpl(j));
        float f = (float) 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((((float) IntSize.m4019getWidthimpl(IntSize)) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((((float) IntSize.m4018getHeightimpl(IntSize)) / 2.0f) * (f + this.verticalBias)));
    }
