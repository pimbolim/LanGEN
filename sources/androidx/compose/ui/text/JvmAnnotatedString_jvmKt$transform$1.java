...
final class JvmAnnotatedString_jvmKt$transform$1 extends Lambda implements Function1<List<? extends Integer>, Integer> {
    ...
    public final Integer invoke(List<Integer> list) {
        Intrinsics.checkNotNullParameter(list, "$dstr$start$end");
        int intValue = list.get(0).intValue();
        int intValue2 = list.get(1).intValue();
        Ref.ObjectRef<String> objectRef = this.$resultStr;
        objectRef.element = Intrinsics.stringPlus((String) objectRef.element, this.$transform.invoke(this.$this_transform.getText(), Integer.valueOf(intValue), Integer.valueOf(intValue2)));
