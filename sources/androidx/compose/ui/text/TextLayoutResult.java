...
public final class TextLayoutResult {
    ...
    public final long m3555getSizeYbymL2g() {
        return this.size;
    }
    ...
    public final boolean getDidOverflowHeight() {
        return this.multiParagraph.getDidExceedMaxLines() || ((float) IntSize.m4018getHeightimpl(m3555getSizeYbymL2g())) < this.multiParagraph.getHeight();
    }

    public final boolean getDidOverflowWidth() {
        return ((float) IntSize.m4019getWidthimpl(m3555getSizeYbymL2g())) < this.multiParagraph.getWidth();
    }
    ...
    public final int m3554getOffsetForPositionk4lQ0M(long j) {
        return this.multiParagraph.m3495getOffsetForPositionk4lQ0M(j);
    }
    ...
    public final long m3556getWordBoundaryjx7JFs(int i) {
        return this.multiParagraph.m3496getWordBoundaryjx7JFs(i);
    }
    ...
    public static /* synthetic */ TextLayoutResult m3552copyO0kMr_c$default(TextLayoutResult textLayoutResult, TextLayoutInput textLayoutInput, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            textLayoutInput = textLayoutResult.layoutInput;
        }
        if ((i & 2) != 0) {
            j = textLayoutResult.m3555getSizeYbymL2g();
        }
        return textLayoutResult.m3553copyO0kMr_c(textLayoutInput, j);
    }

    /* renamed from: copy-O0kMr_c  reason: not valid java name */
    public final TextLayoutResult m3553copyO0kMr_c(TextLayoutInput textLayoutInput, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!Intrinsics.areEqual((Object) this.layoutInput, (Object) textLayoutResult.layoutInput) || !Intrinsics.areEqual((Object) this.multiParagraph, (Object) textLayoutResult.multiParagraph) || !IntSize.m4017equalsimpl0(m3555getSizeYbymL2g(), textLayoutResult.m3555getSizeYbymL2g())) {
            return false;
        }
        if (!(this.firstBaseline == textLayoutResult.firstBaseline)) {
            return false;
        }
        return ((this.lastBaseline > textLayoutResult.lastBaseline ? 1 : (this.lastBaseline == textLayoutResult.lastBaseline ? 0 : -1)) == 0) && Intrinsics.areEqual((Object) this.placeholderRects, (Object) textLayoutResult.placeholderRects);
    }

    public int hashCode() {
        return (((((((((this.layoutInput.hashCode() * 31) + this.multiParagraph.hashCode()) * 31) + IntSize.m4020hashCodeimpl(m3555getSizeYbymL2g())) * 31) + Float.floatToIntBits(this.firstBaseline)) * 31) + Float.floatToIntBits(this.lastBaseline)) * 31) + this.placeholderRects.hashCode();
    }

    public String toString() {
        return "TextLayoutResult(layoutInput=" + this.layoutInput + ", multiParagraph=" + this.multiParagraph + ", size=" + IntSize.m4022toStringimpl(m3555getSizeYbymL2g()) + ", firstBaseline=" + this.firstBaseline + ", lastBaseline=" + this.lastBaseline + ", placeholderRects=" + this.placeholderRects + ')';
    }
}
