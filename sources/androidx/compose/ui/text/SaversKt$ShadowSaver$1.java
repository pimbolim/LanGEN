...
final class SaversKt$ShadowSaver$1 extends Lambda implements Function2<SaverScope, Shadow, Object> {
    ...
    public final Object invoke(SaverScope saverScope, Shadow shadow) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m1586boximpl(shadow.m1893getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope), SaversKt.save(Offset.m1342boximpl(shadow.m1894getOffsetF1C5BW0()), SaversKt.getSaver(Offset.Companion), saverScope), SaversKt.save(Float.valueOf(shadow.getBlurRadius())));
    }
}
