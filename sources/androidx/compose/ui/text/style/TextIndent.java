...
public final class TextIndent {
    ...
    public final long m3776getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* renamed from: getRestLine-XSAIIZE  reason: not valid java name */
    public final long m3777getRestLineXSAIIZE() {
    ...
    public static /* synthetic */ TextIndent m3774copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = textIndent.m3776getFirstLineXSAIIZE();
        }
        if ((i & 2) != 0) {
            j2 = textIndent.m3777getRestLineXSAIIZE();
        }
        return textIndent.m3775copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo  reason: not valid java name */
    public final TextIndent m3775copyNB67dxo(long j, long j2) {
    ...
    public boolean equals(Object obj) {
        ...
        return TextUnit.m4037equalsimpl0(m3776getFirstLineXSAIIZE(), textIndent.m3776getFirstLineXSAIIZE()) && TextUnit.m4037equalsimpl0(m3777getRestLineXSAIIZE(), textIndent.m3777getRestLineXSAIIZE());
    }

    public int hashCode() {
        return (TextUnit.m4041hashCodeimpl(m3776getFirstLineXSAIIZE()) * 31) + TextUnit.m4041hashCodeimpl(m3777getRestLineXSAIIZE());
    }

    public String toString() {
        return "TextIndent(firstLine=" + TextUnit.m4047toStringimpl(m3776getFirstLineXSAIIZE()) + ", restLine=" + TextUnit.m4047toStringimpl(m3777getRestLineXSAIIZE()) + ')';
    }
}
