...
public interface Paragraph {
    ...
    int m3498getOffsetForPositionk4lQ0M(long j);
    ...
    long m3499getWordBoundaryjx7JFs(int i);

    boolean isLineEllipsized(int i);

    /* renamed from: paint-RPmYEkk  reason: not valid java name */
    void m3500paintRPmYEkk(Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration);
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void m3501paintRPmYEkk$default(Paragraph paragraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    j = Color.Companion.m1632getUnspecified0d7_KjU();
                }
                paragraph.m3500paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
                return;
            }
