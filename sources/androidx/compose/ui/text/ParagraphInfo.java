...
public final class ParagraphInfo {
    ...
    public final long m3503toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m1353getXimpl(j), Offset.m1354getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m1390translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.m1821translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI  reason: not valid java name */
    public final long m3502toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m3571getStartimpl(j)), toGlobalIndex(TextRange.m3566getEndimpl(j)));
    }
}
