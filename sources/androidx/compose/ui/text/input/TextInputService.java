...
public class TextInputService {
    ...
    public void stopInput(TextInputSession textInputSession) {
        ...
        if (this._currentInputSession.compareAndSet(textInputSession, (Object) null)) {
