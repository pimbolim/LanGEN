...
final class AndroidCompositionLocals_androidKt$LocalContext$1 extends Lambda implements Function0<Context> {
    ...
    public final Context invoke() {
        Void unused = AndroidCompositionLocals_androidKt.noLocalProvidedFor("LocalContext");
