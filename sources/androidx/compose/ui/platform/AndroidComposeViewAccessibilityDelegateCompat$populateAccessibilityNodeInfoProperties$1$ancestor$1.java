...
final class AndroidComposeViewAccessibilityDelegateCompat$populateAccessibilityNodeInfoProperties$1$ancestor$1 extends Lambda implements Function1<LayoutNode, Boolean> {
    ...
    public final Boolean invoke(LayoutNode layoutNode) {
        ...
        Intrinsics.checkNotNullParameter(layoutNode, "parent");
