...
public final class ComposeView extends AbstractComposeView {
    ...
    public void Content(Composer composer, int i) {
        Composer startRestartGroup = composer.startRestartGroup(2083049676);
        ComposerKt.sourceInformation(startRestartGroup, "C(Content)409@16211L8:ComposeView.android.kt#itgzvw");
