...
public final class AndroidPopup_androidKt$SimpleStack$1 implements MeasurePolicy {
    ...
    public final MeasureResult m4109measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        int i;
        int i2;
        ...
        if (size != 0) {
            ...
            if (size != 1) {
                ...
                return MeasureScope.DefaultImpls.layout$default(measureScope, i2, i, (Map) null, new AndroidPopup_androidKt$SimpleStack$1$measure$3(list2), 4, (Object) null);
            }
            Placeable r12 = ((Measurable) list.get(0)).m3151measureBRTryo0(j);
            return MeasureScope.DefaultImpls.layout$default(measureScope, r12.getWidth(), r12.getHeight(), (Map) null, new AndroidPopup_androidKt$SimpleStack$1$measure$2(r12), 4, (Object) null);
        }
        return MeasureScope.DefaultImpls.layout$default(measureScope, 0, 0, (Map) null, AndroidPopup_androidKt$SimpleStack$1$measure$1.INSTANCE, 4, (Object) null);
    }
}
