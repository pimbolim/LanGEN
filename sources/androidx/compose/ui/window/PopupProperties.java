...
public final class PopupProperties {
    ...
    public int hashCode() {
        return (((((((((((((C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.dismissOnBackPress) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.focusable)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.dismissOnBackPress)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.dismissOnClickOutside)) * 31) + this.securePolicy.hashCode()) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.excludeFromSystemGesture)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.clippingEnabled)) * 31) + C$r8$backportedMethods$utility$Boolean$1$hashCode.hashCode(this.usePlatformDefaultWidth);
    }
}
