...
public interface DrawTransform {
    ...
    void m2142clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    void m2143clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: getCenter-F1C5BW0  reason: not valid java name */
    long m2144getCenterF1C5BW0();

    /* renamed from: getSize-NH-jbRc  reason: not valid java name */
    long m2145getSizeNHjbRc();

    void inset(float f, float f2, float f3, float f4);

    /* renamed from: rotate-Uv8p0NA  reason: not valid java name */
    void m2146rotateUv8p0NA(float f, long j);

    /* renamed from: scale-0AR0LA0  reason: not valid java name */
    void m2147scale0AR0LA0(float f, float f2, long j);

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    void m2148transform58bKbWc(float[] fArr);
    ...
    public static final class DefaultImpls {
        /* renamed from: getCenter-F1C5BW0  reason: not valid java name */
        public static long m2151getCenterF1C5BW0(DrawTransform drawTransform) {
            Intrinsics.checkNotNullParameter(drawTransform, "this");
            float f = (float) 2;
            return OffsetKt.Offset(Size.m1422getWidthimpl(drawTransform.m2145getSizeNHjbRc()) / f, Size.m1419getHeightimpl(drawTransform.m2145getSizeNHjbRc()) / f);
        }

        /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
        public static /* synthetic */ void m2150clipRectN_I0leg$default(DrawTransform drawTransform, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 1) != 0) {
                    f = 0.0f;
                }
                ...
                if ((i2 & 4) != 0) {
                    f3 = Size.m1422getWidthimpl(drawTransform.m2145getSizeNHjbRc());
                }
                if ((i2 & 8) != 0) {
                    f4 = Size.m1419getHeightimpl(drawTransform.m2145getSizeNHjbRc());
                }
                if ((i2 & 16) != 0) {
                    i = ClipOp.Companion.m1585getIntersectrtfAjoo();
                }
                drawTransform.m2143clipRectN_I0leg(f, f2, f3, f4, i);
                return;
            }
        ...
        public static /* synthetic */ void m2149clipPathmtrdDE$default(DrawTransform drawTransform, Path path, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m1585getIntersectrtfAjoo();
                }
                drawTransform.m2142clipPathmtrdDE(path, i);
                return;
            }
        ...
        public static /* synthetic */ void m2152rotateUv8p0NA$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    j = drawTransform.m2144getCenterF1C5BW0();
                }
                drawTransform.m2146rotateUv8p0NA(f, j);
                return;
            }
        ...
        public static /* synthetic */ void m2153scale0AR0LA0$default(DrawTransform drawTransform, float f, float f2, long j, int i, Object obj) {
            if (obj == null) {
                if ((i & 4) != 0) {
                    j = drawTransform.m2144getCenterF1C5BW0();
                }
                drawTransform.m2147scale0AR0LA0(f, f2, j);
                return;
            }
