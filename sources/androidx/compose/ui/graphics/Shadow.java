...
public final class Shadow {
    ...
    public static /* synthetic */ void m1890getColor0d7_KjU$annotations() {
    }

    /* renamed from: getOffset-F1C5BW0$annotations  reason: not valid java name */
    public static /* synthetic */ void m1891getOffsetF1C5BW0$annotations() {
    }
    ...
    public /* synthetic */ Shadow(long j, long j2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? ColorKt.Color(4278190080L) : j, (i & 2) != 0 ? Offset.Companion.m1369getZeroF1C5BW0() : j2, (i & 4) != 0 ? 0.0f : f, (DefaultConstructorMarker) null);
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public final long m1893getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getOffset-F1C5BW0  reason: not valid java name */
    public final long m1894getOffsetF1C5BW0() {
        return this.offset;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Color.m1597equalsimpl0(m1893getColor0d7_KjU(), shadow.m1893getColor0d7_KjU()) || !Offset.m1350equalsimpl0(m1894getOffsetF1C5BW0(), shadow.m1894getOffsetF1C5BW0())) {
            return false;
        }
    ...
    public int hashCode() {
        return (((Color.m1603hashCodeimpl(m1893getColor0d7_KjU()) * 31) + Offset.m1355hashCodeimpl(m1894getOffsetF1C5BW0())) * 31) + Float.floatToIntBits(this.blurRadius);
    }

    public String toString() {
        return "Shadow(color=" + Color.m1604toStringimpl(m1893getColor0d7_KjU()) + ", offset=" + Offset.m1361toStringimpl(m1894getOffsetF1C5BW0()) + ", blurRadius=" + this.blurRadius + ')';
    }

    /* renamed from: copy-qcb84PM$default  reason: not valid java name */
    public static /* synthetic */ Shadow m1889copyqcb84PM$default(Shadow shadow, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = shadow.m1893getColor0d7_KjU();
        }
        long j3 = j;
        if ((i & 2) != 0) {
            j2 = shadow.m1894getOffsetF1C5BW0();
        }
        long j4 = j2;
        if ((i & 4) != 0) {
            f = shadow.blurRadius;
        }
        return shadow.m1892copyqcb84PM(j3, j4, f);
    }

    /* renamed from: copy-qcb84PM  reason: not valid java name */
    public final Shadow m1892copyqcb84PM(long j, long j2, float f) {
