...
public final class ColorSpaces {
    ...
    static {
        ...
        float[] fArr3 = fArr;
        Rgb rgb = new Rgb("sRGB IEC61966-2.1", fArr3, Illuminant.INSTANCE.getD65(), transferParameters, 0);
        Srgb = rgb;
        Rgb rgb2 = new Rgb("sRGB IEC61966-2.1 (Linear)", fArr3, Illuminant.INSTANCE.getD65(), 1.0d, 0.0f, 1.0f, 1);
        LinearSrgb = rgb2;
        Rgb rgb3 = new Rgb("scRGB-nl IEC 61966-2-2:2003", fArr3, Illuminant.INSTANCE.getD65(), (float[]) null, ColorSpaces$ExtendedSrgb$1.INSTANCE, ColorSpaces$ExtendedSrgb$2.INSTANCE, -0.799f, 2.399f, transferParameters, 2);
        ExtendedSrgb = rgb3;
        Rgb rgb4 = new Rgb("scRGB IEC 61966-2-2:2003", fArr3, Illuminant.INSTANCE.getD65(), 1.0d, -0.5f, 7.499f, 3);
        LinearExtendedSrgb = rgb4;
        Rgb rgb5 = new Rgb("Rec. ITU-R BT.709-5", new float[]{0.64f, 0.33f, 0.3f, 0.6f, 0.15f, 0.06f}, Illuminant.INSTANCE.getD65(), new TransferParameters(2.2222222222222223d, 0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, 0.0d, 0.0d, 96, (DefaultConstructorMarker) null), 4);
        Bt709 = rgb5;
        Rgb rgb6 = new Rgb("Rec. ITU-R BT.2020-1", new float[]{0.708f, 0.292f, 0.17f, 0.797f, 0.131f, 0.046f}, Illuminant.INSTANCE.getD65(), new TransferParameters(2.2222222222222223d, 0.9096697898662786d, 0.09033021013372146d, 0.2222222222222222d, 0.08145d, 0.0d, 0.0d, 96, (DefaultConstructorMarker) null), 5);
        Bt2020 = rgb6;
        ...
        DisplayP3 = rgb8;
        Rgb rgb9 = new Rgb("NTSC (1953)", fArr2, Illuminant.INSTANCE.getC(), new TransferParameters(2.2222222222222223d, 0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, 0.0d, 0.0d, 96, (DefaultConstructorMarker) null), 8);
        Ntsc1953 = rgb9;
        Rgb rgb10 = new Rgb("SMPTE-C RGB", new float[]{0.63f, 0.34f, 0.31f, 0.595f, 0.155f, 0.07f}, Illuminant.INSTANCE.getD65(), new TransferParameters(2.2222222222222223d, 0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, 0.0d, 0.0d, 96, (DefaultConstructorMarker) null), 9);
        SmpteC = rgb10;
        ...
        AdobeRgb = rgb11;
        Rgb rgb12 = new Rgb("ROMM RGB ISO 22028-2:2013", new float[]{0.7347f, 0.2653f, 0.1596f, 0.8404f, 0.0366f, 1.0E-4f}, Illuminant.INSTANCE.getD50(), new TransferParameters(1.8d, 1.0d, 0.0d, 0.0625d, 0.031248d, 0.0d, 0.0d, 96, (DefaultConstructorMarker) null), 11);
        ProPhotoRgb = rgb12;
        ...
        Acescg = rgb14;
        ColorSpace xyz = new Xyz("Generic XYZ", 14);
        CieXyz = xyz;
        ColorSpace lab = new Lab("Generic L*a*b*", 15);
        CieLab = lab;
        Rgb rgb15 = new Rgb("None", fArr, Illuminant.INSTANCE.getD65(), transferParameters2, 16);
        Unspecified = rgb15;
        ColorSpace oklab = new Oklab("Oklab", 17);
        Oklab = oklab;
    ...
    public final ColorSpace match(float[] fArr, TransferParameters transferParameters) {
        ...
        int i = 0;
        while (i < length) {
            ColorSpace colorSpace = colorSpaceArr[i];
            i++;
            if (ColorModel.m1971equalsimpl0(colorSpace.m1980getModelxdoWZVw(), ColorModel.Companion.m1978getRgbxdoWZVw())) {
                Rgb rgb = (Rgb) ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), (Adaptation) null, 2, (Object) null);
