...
@JvmInline
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0004\b@\u0018\u0000 \u00172\u00020\u0001:\u0001\u0017B\u0014\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005J\u001a\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u000f\u0010\u0010J\u0010\u0010\u0011\u001a\u00020\u0007HÖ\u0001¢\u0006\u0004\b\u0012\u0010\u000bJ\u000f\u0010\u0013\u001a\u00020\u0014H\u0016¢\u0006\u0004\b\u0015\u0010\u0016R\u001a\u0010\u0006\u001a\u00020\u00078FX\u0004¢\u0006\f\u0012\u0004\b\b\u0010\t\u001a\u0004\b\n\u0010\u000bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000\u0001\u0002\u0001\u00020\u0003ø\u0001\u0000\u0002\u0004\n\u0002\b\u0019¨\u0006\u0018"}, d2 = {"Landroidx/compose/ui/graphics/colorspace/ColorModel;", "", "packedValue", "", "constructor-impl", "(J)J", "componentCount", "", "getComponentCount$annotations", "()V", "getComponentCount-impl", "(J)I", "equals", "", "other", "equals-impl", "(JLjava/lang/Object;)Z", "hashCode", "hashCode-impl", "toString", "", "toString-impl", "(J)Ljava/lang/String;", "Companion", "ui-graphics_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
...
public final class ColorModel {
    ...
    public static final /* synthetic */ ColorModel m1968boximpl(long j) {
    ...
    public static boolean m1970equalsimpl(long j, Object obj) {
        return (obj instanceof ColorModel) && j == ((ColorModel) obj).m1975unboximpl();
    }
    ...
    public static final int m1972getComponentCountimpl(long j) {
        return (int) (j >> 32);
    }
    ...
    public final /* synthetic */ long m1975unboximpl() {
    ...
    public static final class Companion {
        ...
        public final long m1978getRgbxdoWZVw() {
            return ColorModel.Rgb;
        }

        /* renamed from: getXyz-xdoWZVw  reason: not valid java name */
        public final long m1979getXyzxdoWZVw() {
            return ColorModel.Xyz;
        }

        /* renamed from: getLab-xdoWZVw  reason: not valid java name */
        public final long m1977getLabxdoWZVw() {
            return ColorModel.Lab;
        }

        /* renamed from: getCmyk-xdoWZVw  reason: not valid java name */
        public final long m1976getCmykxdoWZVw() {
    ...
    static {
        long j = (long) 3;
        long j2 = j << 32;
        Rgb = m1969constructorimpl((((long) 0) & 4294967295L) | j2);
        Xyz = m1969constructorimpl((((long) 1) & 4294967295L) | j2);
        Lab = m1969constructorimpl(j2 | (((long) 2) & 4294967295L));
        Cmyk = m1969constructorimpl((j & 4294967295L) | (((long) 4) << 32));
    }
    ...
    public static String m1974toStringimpl(long j) {
        if (m1971equalsimpl0(j, Rgb)) {
            return "Rgb";
        }
        if (m1971equalsimpl0(j, Xyz)) {
            return "Xyz";
        }
        if (m1971equalsimpl0(j, Lab)) {
            return "Lab";
        }
        return m1971equalsimpl0(j, Cmyk) ? "Cmyk" : BinData.UNKNOWN;
    }
}
