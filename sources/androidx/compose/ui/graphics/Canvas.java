...
public interface Canvas {
    ...
    void m1565drawCircle9KIMszo(long j, float f, Paint paint);

    /* renamed from: drawImage-d-4ec7I  reason: not valid java name */
    void m1566drawImaged4ec7I(ImageBitmap imageBitmap, long j, Paint paint);

    /* renamed from: drawImageRect-HPBpro0  reason: not valid java name */
    void m1567drawImageRectHPBpro0(ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint);

    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    void m1568drawLineWko1d7g(long j, long j2, Paint paint);
    ...
    void m1569drawPointsO7TthRY(int i, List<Offset> list, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY  reason: not valid java name */
    void m1570drawRawPointsO7TthRY(int i, float[] fArr, Paint paint);
    ...
    void m1571drawVerticesTPEHhCM(Vertices vertices, int i, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void m1575clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m1585getIntersectrtfAjoo();
                }
                canvas.m1563clipRectmtrdDE(rect, i);
                return;
            }
        ...
        /* renamed from: clipRect-mtrdD-E  reason: not valid java name */
        public static void m1574clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(canvas, "this");
            Intrinsics.checkNotNullParameter(rect, "rect");
            canvas.m1562clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
        }

        /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
        public static /* synthetic */ void m1573clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 16) != 0) {
                    i = ClipOp.Companion.m1585getIntersectrtfAjoo();
                }
                canvas.m1562clipRectN_I0leg(f, f2, f3, f4, i);
                return;
            }
        ...
        public static /* synthetic */ void m1572clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj == null) {
                if ((i2 & 2) != 0) {
                    i = ClipOp.Companion.m1585getIntersectrtfAjoo();
                }
                canvas.m1561clipPathmtrdDE(path, i);
                return;
            }
        ...
        public static /* synthetic */ void m1576drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj == null) {
                long r4 = (i & 2) != 0 ? IntOffset.Companion.m3987getZeronOccac() : j;
                long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
                canvas.m1567drawImageRectHPBpro0(imageBitmap, r4, IntSize, (i & 8) != 0 ? IntOffset.Companion.m3987getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
                return;
            }
