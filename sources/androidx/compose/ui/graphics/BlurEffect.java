...
public final class BlurEffect extends RenderEffect {
    ...
    public RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m1863createBlurEffect8A3gB4(this.renderEffect, this.radiusX, this.radiusY, this.edgeTreatment);
    }
    ...
    public /* synthetic */ BlurEffect(RenderEffect renderEffect2, float f, float f2, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(renderEffect2, f, (i2 & 4) != 0 ? f : f2, (i2 & 8) != 0 ? TileMode.Companion.m1937getClamp3opZhB0() : i, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return ((this.radiusY > blurEffect.radiusY ? 1 : (this.radiusY == blurEffect.radiusY ? 0 : -1)) == 0) && TileMode.m1933equalsimpl0(this.edgeTreatment, blurEffect.edgeTreatment) && Intrinsics.areEqual((Object) this.renderEffect, (Object) blurEffect.renderEffect);
    }

    public int hashCode() {
        RenderEffect renderEffect2 = this.renderEffect;
        return ((((((renderEffect2 == null ? 0 : renderEffect2.hashCode()) * 31) + Float.floatToIntBits(this.radiusX)) * 31) + Float.floatToIntBits(this.radiusY)) * 31) + TileMode.m1934hashCodeimpl(this.edgeTreatment);
    }

    public String toString() {
        return "BlurEffect(renderEffect=" + this.renderEffect + ", radiusX=" + this.radiusX + ", radiusY=" + this.radiusY + ", edgeTreatment=" + TileMode.m1935toStringimpl(this.edgeTreatment) + ')';
    }
}
