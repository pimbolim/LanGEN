...
final class BlockGraphicsLayerModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public BlockGraphicsLayerModifier(Function1<? super GraphicsLayerScope, Unit> function1, Function1<? super InspectorInfo, Unit> function12) {
        super(function12);
    ...
    public MeasureResult m1537measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        Placeable r9 = measurable.m3151measureBRTryo0(j);
        return MeasureScope.DefaultImpls.layout$default(measureScope, r9.getWidth(), r9.getHeight(), (Map) null, new BlockGraphicsLayerModifier$measure$1(r9, this), 4, (Object) null);
    }
