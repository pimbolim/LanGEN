...
public final class VectorKt {
    private static final int DefaultFillType = PathFillType.Companion.m1833getNonZeroRgk1Os();
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m1916getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m1927getMiterLxFBmk8();
    public static final float DefaultStrokeLineMiter = 4.0f;
    public static final float DefaultStrokeLineWidth = 0.0f;
    private static final int DefaultTintBlendMode = BlendMode.Companion.m1532getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m1631getTransparent0d7_KjU();
