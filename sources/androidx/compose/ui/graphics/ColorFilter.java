...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m1637tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.Companion.m1532getSrcIn0nO6VwU();
            }
            return companion.m1640tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds  reason: not valid java name */
        public final ColorFilter m1640tintxETnrds(long j, int i) {
            return AndroidColorFilter_androidKt.m1461actualTintColorFilterxETnrds(j, i);
        }

        /* renamed from: colorMatrix-jHG-Opc  reason: not valid java name */
        public final ColorFilter m1638colorMatrixjHGOpc(float[] fArr) {
            Intrinsics.checkNotNullParameter(fArr, "colorMatrix");
            return AndroidColorFilter_androidKt.m1459actualColorMatrixColorFilterjHGOpc(fArr);
        }

        /* renamed from: lighting--OWjLjI  reason: not valid java name */
        public final ColorFilter m1639lightingOWjLjI(long j, long j2) {
            return AndroidColorFilter_androidKt.m1460actualLightingColorFilterOWjLjI(j, j2);
        }
    }
