...
public abstract class Painter {
    ...
    public abstract long m2184getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m2182drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter2, int i, Object obj) {
        if (obj == null) {
            float f2 = (i & 2) != 0 ? 1.0f : f;
            if ((i & 4) != 0) {
                colorFilter2 = null;
            }
            painter.m2183drawx_KDEd0(drawScope, j, f2, colorFilter2);
            return;
        }
    ...
    public final void m2183drawx_KDEd0(DrawScope drawScope, long j, float f, ColorFilter colorFilter2) {
        Intrinsics.checkNotNullParameter(drawScope, "$receiver");
        configureAlpha(f);
        configureColorFilter(colorFilter2);
        configureLayoutDirection(drawScope.getLayoutDirection());
        float r8 = Size.m1422getWidthimpl(drawScope.m2092getSizeNHjbRc()) - Size.m1422getWidthimpl(j);
        float r0 = Size.m1419getHeightimpl(drawScope.m2092getSizeNHjbRc()) - Size.m1419getHeightimpl(j);
        drawScope.getDrawContext().getTransform().inset(0.0f, 0.0f, r8, r0);
        if (f > 0.0f && Size.m1422getWidthimpl(j) > 0.0f && Size.m1419getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect r5 = RectKt.m1393Recttz77jQw(Offset.Companion.m1369getZeroF1C5BW0(), SizeKt.Size(Size.m1422getWidthimpl(j), Size.m1419getHeightimpl(j)));
