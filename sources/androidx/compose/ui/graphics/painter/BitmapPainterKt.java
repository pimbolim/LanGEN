...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m2178BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j = IntOffset.Companion.m3987getZeronOccac();
        }
        long j3 = j;
        if ((i2 & 4) != 0) {
        ...
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.Companion.m1682getLowfv9h1I();
        }
        return m2177BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY  reason: not valid java name */
    public static final BitmapPainter m2177BitmapPainterQZhYCtY(ImageBitmap imageBitmap, long j, long j2, int i) {
        ...
        bitmapPainter.m2176setFilterQualityvDHp3xo$ui_graphics_release(i);
