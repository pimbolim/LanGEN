...
public interface OwnedLayer {
    ...
    boolean m3367isInLayerk4lQ0M(long j);

    void mapBounds(MutableRect mutableRect, boolean z);

    /* renamed from: mapOffset-8S9VItk  reason: not valid java name */
    long m3368mapOffset8S9VItk(long j, boolean z);

    /* renamed from: move--gyyYBs  reason: not valid java name */
    void m3369movegyyYBs(long j);

    /* renamed from: resize-ozmzZPI  reason: not valid java name */
    void m3370resizeozmzZPI(long j);
    ...
    void m3371updateLayerPropertiesYPkPJjM(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, LayoutDirection layoutDirection, Density density);
}
