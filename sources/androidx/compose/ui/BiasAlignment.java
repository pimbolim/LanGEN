...
public final class BiasAlignment implements Alignment {
    ...
    public long m1255alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        float f;
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        float r0 = ((float) (IntSize.m4019getWidthimpl(j2) - IntSize.m4019getWidthimpl(j))) / 2.0f;
        float r3 = ((float) (IntSize.m4018getHeightimpl(j2) - IntSize.m4018getHeightimpl(j))) / 2.0f;
        ...
        float f2 = (float) 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(r0 * (f + f2)), MathKt.roundToInt(r3 * (f2 + this.verticalBias)));
    }
    ...
    public static final class Horizontal implements Alignment.Horizontal {
        ...
        public int align(int i, int i2, LayoutDirection layoutDirection) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            return MathKt.roundToInt((((float) (i2 - i)) / 2.0f) * (((float) 1) + (layoutDirection == LayoutDirection.Ltr ? this.bias : ((float) -1) * this.bias)));
        }
    }
    ...
    public static final class Vertical implements Alignment.Vertical {
        ...
        public int align(int i, int i2) {
            return MathKt.roundToInt((((float) (i2 - i)) / 2.0f) * (((float) 1) + this.bias));
        }
    }
}
