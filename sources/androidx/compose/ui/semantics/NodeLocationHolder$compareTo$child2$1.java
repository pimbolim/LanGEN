...
final class NodeLocationHolder$compareTo$child2$1 extends Lambda implements Function1<LayoutNode, Boolean> {
    ...
    public final Boolean invoke(LayoutNode layoutNode) {
        ...
        return Boolean.valueOf(findWrapperToGetBounds.isAttached() && !Intrinsics.areEqual((Object) this.$view2Bounds, (Object) LayoutCoordinatesKt.boundsInRoot(findWrapperToGetBounds)));
    }
}
