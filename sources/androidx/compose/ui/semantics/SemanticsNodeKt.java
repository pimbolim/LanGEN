...
public final class SemanticsNodeKt {
    ...
    public static final SemanticsWrapper getOuterMergingSemantics(LayoutNode layoutNode) {
        ...
        for (LayoutNodeWrapper outerLayoutNodeWrapper$ui_release = layoutNode.getOuterLayoutNodeWrapper$ui_release(); outerLayoutNodeWrapper$ui_release != null; outerLayoutNodeWrapper$ui_release = outerLayoutNodeWrapper$ui_release.getWrapped$ui_release()) {
            if (outerLayoutNodeWrapper$ui_release instanceof SemanticsWrapper) {
                ...
                if (((SemanticsModifier) semanticsWrapper.getModifier()).getSemanticsConfiguration().isMergingSemanticsOfDescendants()) {
    ...
    public static final SemanticsWrapper nearestSemantics(LayoutNodeWrapper layoutNodeWrapper, Function1<? super SemanticsWrapper, Boolean> function1) {
        Intrinsics.checkNotNullParameter(layoutNodeWrapper, "<this>");
        Intrinsics.checkNotNullParameter(function1, "predicate");
        while (layoutNodeWrapper != null) {
            if ((layoutNodeWrapper instanceof SemanticsWrapper) && function1.invoke(layoutNodeWrapper).booleanValue()) {
