...
final class NestedScrollDelegatingWrapper$refreshChildrenWithParentConnection$1$2 extends Lambda implements Function0<CoroutineScope> {
    final /* synthetic */ NestedScrollDelegatingWrapper $outerChild;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NestedScrollDelegatingWrapper$refreshChildrenWithParentConnection$1$2(NestedScrollDelegatingWrapper nestedScrollDelegatingWrapper) {
        super(0);
