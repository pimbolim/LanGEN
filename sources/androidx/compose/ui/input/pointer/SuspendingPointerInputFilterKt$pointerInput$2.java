...
final class SuspendingPointerInputFilterKt$pointerInput$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C218@8906L7,219@8965L7,*220@8977L78,222@9098L99:SuspendingPointerInputFilter.kt#a556rk");
        ...
        EffectsKt.LaunchedEffect(suspendingPointerInputFilter, this.$key1, new SuspendingPointerInputFilterKt$pointerInput$2$2$1(suspendingPointerInputFilter, this.$block, suspendingPointerInputFilter, (Continuation<? super SuspendingPointerInputFilterKt$pointerInput$2$2$1>) null), composer, 64);
        composer.endReplaceableGroup();
