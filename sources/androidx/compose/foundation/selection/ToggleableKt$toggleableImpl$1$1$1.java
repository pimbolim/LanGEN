...
public final class ToggleableKt$toggleableImpl$1$1$1 implements ModifierLocalConsumer {
    ...
    ToggleableKt$toggleableImpl$1$1$1(MutableState<Boolean> mutableState) {
    ...
    public void onModifierLocalsUpdated(ModifierLocalReadScope modifierLocalReadScope) {
        ...
        this.$isToggleableInScrollableContainer.setValue(modifierLocalReadScope.getCurrent(ScrollableKt.getModifierLocalScrollableContainer()));
    }
}
