...
final class ToggleableKt$triStateToggleable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        Modifier r8 = ToggleableKt.m585toggleableImpl3WzHGRc(modifier, toggleableState, z, role, (MutableInteractionSource) rememberedValue, (Indication) consume, this.$onClick);
        composer.endReplaceableGroup();
        return r8;
    }
}
