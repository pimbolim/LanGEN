...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline m607createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1422getWidthimpl(j) - f, 0.0f);
        Path.lineTo(Size.m1422getWidthimpl(j), f);
        float f6 = layoutDirection == LayoutDirection.Ltr ? f3 : f4;
        Path.lineTo(Size.m1422getWidthimpl(j), Size.m1419getHeightimpl(j) - f6);
        Path.lineTo(Size.m1422getWidthimpl(j) - f6, Size.m1419getHeightimpl(j));
        if (layoutDirection == LayoutDirection.Ltr) {
            f3 = f4;
        }
        Path.lineTo(f3, Size.m1419getHeightimpl(j));
        Path.lineTo(0.0f, Size.m1419getHeightimpl(j) - f3);
        Path.close();
