...
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m611component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m612copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m613copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final DpCornerSize m613copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m3864equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }

    public int hashCode() {
        return Dp.m3865hashCodeimpl(this.size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m3857boximpl(m614getValueOverrideD9Ej5fM());
    }

    /* renamed from: toPx-TmRCtEA  reason: not valid java name */
    public float m615toPxTmRCtEA(long j, Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.m3828toPx0680j_4(this.size);
    }
    ...
    public float m614getValueOverrideD9Ej5fM() {
        return this.size;
    }
}
