...
public final class DragInteractionKt {
    public static final State<Boolean> collectIsDraggedAsState(InteractionSource interactionSource, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect((Object) interactionSource, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new DragInteractionKt$collectIsDraggedAsState$1(interactionSource, mutableState, (Continuation<? super DragInteractionKt$collectIsDraggedAsState$1>) null), composer, i & 14);
        composer.endReplaceableGroup();
        return mutableState;
    }
}
