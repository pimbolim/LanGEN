...
public final class PressInteractionKt {
    public static final State<Boolean> collectIsPressedAsState(InteractionSource interactionSource, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect((Object) interactionSource, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) new PressInteractionKt$collectIsPressedAsState$1(interactionSource, mutableState, (Continuation<? super PressInteractionKt$collectIsPressedAsState$1>) null), composer, i & 14);
        composer.endReplaceableGroup();
        return mutableState;
    }
}
