...
final class SelectionManager$modifier$4 extends Lambda implements Function1<KeyEvent, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m791invokeZmokQxo(((KeyEvent) obj).m2844unboximpl());
    }

    /* renamed from: invoke-ZmokQxo  reason: not valid java name */
    public final Boolean m791invokeZmokQxo(android.view.KeyEvent keyEvent) {
        boolean z;
        Intrinsics.checkNotNullParameter(keyEvent, "it");
        if (SelectionManager_androidKt.m794isCopyKeyEventZmokQxo(keyEvent)) {
