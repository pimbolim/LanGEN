...
public final class Selection {
    ...
    public final Selection copy(AnchorInfo anchorInfo, AnchorInfo anchorInfo2, boolean z) {
        Intrinsics.checkNotNullParameter(anchorInfo, ViewProps.START);
        Intrinsics.checkNotNullParameter(anchorInfo2, ViewProps.END);
    ...
    public static final class AnchorInfo {
        ...
        public int hashCode() {
            return (((this.direction.hashCode() * 31) + this.offset) * 31) + C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.selectableId);
        }
    ...
    public final long m759toTextRanged9O1mEE() {
