...
final class HorizontalScrollLayoutModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        this.this$0.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(density, cursorOffset, transformedText, invoke == null ? null : invoke.getValue(), this.$$receiver.getLayoutDirection() == LayoutDirection.Rtl, this.$placeable.getWidth()), this.$width, this.$placeable.getWidth());
        Placeable.PlacementScope.placeRelative$default(placementScope, this.$placeable, MathKt.roundToInt(-this.this$0.getScrollerPosition().getOffset()), 0, 0.0f, 4, (Object) null);
    }
}
