...
final class BasicTextFieldKt$BasicTextField$8 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        BasicTextFieldKt.BasicTextField(textFieldValue2, (Function1<? super TextFieldValue, Unit>) this.$onValueChange, this.$modifier, this.$enabled, this.$readOnly, this.$textStyle, this.$keyboardOptions, this.$keyboardActions, this.$singleLine, this.$maxLines, this.$visualTransformation, (Function1<? super TextLayoutResult, Unit>) this.$onTextLayout, this.$interactionSource, this.$cursorBrush, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) this.$decorationBox, composer2, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
