...
final class VerticalScrollLayoutModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        this.this$0.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.getCursorRectInScroller(density, cursorOffset, transformedText, invoke == null ? null : invoke.getValue(), false, this.$placeable.getWidth()), this.$height, this.$placeable.getHeight());
        Placeable.PlacementScope.placeRelative$default(placementScope, this.$placeable, 0, MathKt.roundToInt(-this.this$0.getScrollerPosition().getOffset()), 0.0f, 4, (Object) null);
    }
}
