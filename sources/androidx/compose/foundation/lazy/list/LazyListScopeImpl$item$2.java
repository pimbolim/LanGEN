...
final class LazyListScopeImpl$item$2 extends Lambda implements Function2<LazyItemScope, Integer, Function2<? super Composer, ? super Integer, ? extends Unit>> {
    ...
    LazyListScopeImpl$item$2(Function3<? super LazyItemScope, ? super Composer, ? super Integer, Unit> function3) {
        super(2);
    ...
    public final Function2<Composer, Integer, Unit> invoke(final LazyItemScope lazyItemScope, int i) {
        ...
        return ComposableLambdaKt.composableLambdaInstance(-985532813, true, new Function2<Composer, Integer, Unit>() {
            public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            ...
            public final void invoke(Composer composer, int i) {
                ComposerKt.sourceInformation(composer, "C50@1842L9:LazyListScopeImpl.kt#77c2e6");
