...
public final class LazyDslKt$items$4 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    ...
    public LazyDslKt$items$4(Function4<? super LazyItemScope, ? super T, ? super Composer, ? super Integer, Unit> function4, T[] tArr) {
        super(4);
    ...
    public final void invoke(LazyItemScope lazyItemScope, int i, Composer composer, int i2) {
        ...
        ComposerKt.sourceInformation(composer, "C140@6548L22:LazyDsl.kt#428nma");
        if ((i2 & 14) == 0) {
