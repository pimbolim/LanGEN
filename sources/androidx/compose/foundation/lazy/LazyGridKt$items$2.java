...
public final class LazyGridKt$items$2 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ Function4<LazyItemScope, T, Composer, Integer, Unit> $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyGridKt$items$2(Function4<? super LazyItemScope, ? super T, ? super Composer, ? super Integer, Unit> function4, List<? extends T> list) {
        super(4);
    ...
    public final void invoke(LazyItemScope lazyItemScope, int i, Composer composer, int i2) {
        ...
        ComposerKt.sourceInformation(composer, "C170@6589L22:LazyGrid.kt#428nma");
        if ((i2 & 14) == 0) {
