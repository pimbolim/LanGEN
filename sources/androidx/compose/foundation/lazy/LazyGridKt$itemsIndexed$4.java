...
public final class LazyGridKt$itemsIndexed$4 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ Function5<LazyItemScope, Integer, T, Composer, Integer, Unit> $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyGridKt$itemsIndexed$4(Function5<? super LazyItemScope, ? super Integer, ? super T, ? super Composer, ? super Integer, Unit> function5, T[] tArr) {
        super(4);
    ...
    public final void invoke(LazyItemScope lazyItemScope, int i, Composer composer, int i2) {
        ...
        ComposerKt.sourceInformation(composer, "C233@8792L26:LazyGrid.kt#428nma");
        if ((i2 & 14) == 0) {
