...
final class MaxIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public MeasureResult m408measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
    ...
    public long m407calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m3812fixedHeightOenEA2s(measurable.maxIntrinsicHeight(Constraints.m3803getMaxWidthimpl(j)));
    }
