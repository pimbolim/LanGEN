...
final class Arrangement$spacedBy$2 extends Lambda implements Function2<Integer, LayoutDirection, Integer> {
    final /* synthetic */ Alignment.Horizontal $alignment;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    Arrangement$spacedBy$2(Alignment.Horizontal horizontal) {
        super(2);
