...
public final class AspectRatioKt {
    ...
    public static final Modifier aspectRatio(Modifier modifier, float f, boolean z) {
        ...
        return modifier.then(new AspectRatioModifier(f, z, InspectableValueKt.isDebugInspectorInfoEnabled() ? new AspectRatioKt$aspectRatio$$inlined$debugInspectorInfo$1(f, z) : InspectableValueKt.getNoInspectorInfo()));
    }
}
