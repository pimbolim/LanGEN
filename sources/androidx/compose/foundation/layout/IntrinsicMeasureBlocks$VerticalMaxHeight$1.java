...
final class IntrinsicMeasureBlocks$VerticalMaxHeight$1 extends Lambda implements Function3<List<? extends IntrinsicMeasurable>, Integer, Integer, Integer> {
    ...
    public final Integer invoke(List<? extends IntrinsicMeasurable> list, int i, int i2) {
        ...
        return Integer.valueOf(RowColumnImplKt.intrinsicSize(list, AnonymousClass1.INSTANCE, AnonymousClass2.INSTANCE, i, i2, LayoutOrientation.Vertical, LayoutOrientation.Vertical));
    }
}
