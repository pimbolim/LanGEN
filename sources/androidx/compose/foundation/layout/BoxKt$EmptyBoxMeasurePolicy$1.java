...
final class BoxKt$EmptyBoxMeasurePolicy$1 implements MeasurePolicy {
    ...
    public final MeasureResult m387measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$MeasurePolicy");
        Intrinsics.checkNotNullParameter(list, "$noName_0");
        return MeasureScope.DefaultImpls.layout$default(measureScope, Constraints.m3805getMinWidthimpl(j), Constraints.m3804getMinHeightimpl(j), (Map) null, BoxKt$EmptyBoxMeasurePolicy$1$measure$1.INSTANCE, 4, (Object) null);
    }
}
