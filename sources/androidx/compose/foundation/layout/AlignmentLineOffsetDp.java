...
final class AlignmentLineOffsetDp extends InspectorValueInfo implements LayoutModifier {
    ...
    public final float m341getBeforeD9Ej5fM() {
        return this.before;
    }

    /* renamed from: getAfter-D9Ej5fM  reason: not valid java name */
    public final float m340getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    private AlignmentLineOffsetDp(AlignmentLine alignmentLine2, float f, float f2, Function1<? super InspectorInfo, Unit> function1) {
        ...
        this.before = f;
        this.after = f2;
        if (!((m341getBeforeD9Ej5fM() >= 0.0f || Dp.m3864equalsimpl0(m341getBeforeD9Ej5fM(), Dp.Companion.m3879getUnspecifiedD9Ej5fM())) && (m340getAfterD9Ej5fM() >= 0.0f || Dp.m3864equalsimpl0(m340getAfterD9Ej5fM(), Dp.Companion.m3879getUnspecifiedD9Ej5fM())))) {
            throw new IllegalArgumentException("Padding from alignment line must be a non-negative number".toString());
        }
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m342measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return AlignmentLineKt.m331alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, m341getBeforeD9Ej5fM(), m340getAfterD9Ej5fM(), measurable, j);
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m3865hashCodeimpl(m341getBeforeD9Ej5fM())) * 31) + Dp.m3865hashCodeimpl(m340getAfterD9Ej5fM());
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (alignmentLineOffsetDp != null && Intrinsics.areEqual((Object) this.alignmentLine, (Object) alignmentLineOffsetDp.alignmentLine) && Dp.m3864equalsimpl0(m341getBeforeD9Ej5fM(), alignmentLineOffsetDp.m341getBeforeD9Ej5fM()) && Dp.m3864equalsimpl0(m340getAfterD9Ej5fM(), alignmentLineOffsetDp.m340getAfterD9Ej5fM())) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + Dp.m3870toStringimpl(m341getBeforeD9Ej5fM()) + ", after=" + Dp.m3870toStringimpl(m340getAfterD9Ej5fM()) + ')';
    }
}
