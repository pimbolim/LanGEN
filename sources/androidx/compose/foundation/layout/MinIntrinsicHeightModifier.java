...
final class MinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public MeasureResult m412measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        return IntrinsicSizeModifier.DefaultImpls.minIntrinsicWidth(this, intrinsicMeasureScope, intrinsicMeasurable, i);
    }
    ...
    public long m411calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m3812fixedHeightOenEA2s(measurable.minIntrinsicHeight(Constraints.m3803getMaxWidthimpl(j)));
    }
