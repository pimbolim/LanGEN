...
public final class PaddingKt$paddingqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set(ViewProps.START, Dp.m3857boximpl(this.$start$inlined));
        inspectorInfo.getProperties().set(ViewProps.TOP, Dp.m3857boximpl(this.$top$inlined));
        inspectorInfo.getProperties().set(ViewProps.END, Dp.m3857boximpl(this.$end$inlined));
