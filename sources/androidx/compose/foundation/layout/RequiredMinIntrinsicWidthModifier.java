...
final class RequiredMinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public MeasureResult m473measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
    ...
    public long m472calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.Companion.m3813fixedWidthOenEA2s(measurable.minIntrinsicWidth(Constraints.m3802getMaxHeightimpl(j)));
    }
