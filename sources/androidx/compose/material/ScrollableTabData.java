...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int r6 = density.m3822roundToPx0680j_4(((TabPosition) CollectionsKt.last(list)).m1150getRightD9Ej5fM()) + i;
        int maxValue = r6 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.m3822roundToPx0680j_4(tabPosition.m1149getLeftD9Ej5fM()) - ((maxValue / 2) - (density.m3822roundToPx0680j_4(tabPosition.m1151getWidthD9Ej5fM()) / 2)), 0, RangesKt.coerceAtLeast(r6 - maxValue, 0));
    }
}
