...
final class SliderKt$SliderThumb$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$interactionSource.getInteractions().collect(new SliderKt$SliderThumb$1$1$1$invokeSuspend$$inlined$collect$1(this.$interactions), this) == coroutine_suspended) {
