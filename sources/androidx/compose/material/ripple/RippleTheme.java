...
public interface RippleTheme {
    ...
    long m1215defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1217defaultRippleColor5vOe2sY(long j, boolean z) {
            return (z || ((double) ColorKt.m1649luminance8_81llA(j)) >= 0.5d) ? j : Color.Companion.m1633getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc  reason: not valid java name */
        public final RippleAlpha m1216defaultRippleAlphaDxMtmZc(long j, boolean z) {
            if (!z) {
                return RippleThemeKt.DarkThemeRippleAlpha;
            }
            if (((double) ColorKt.m1649luminance8_81llA(j)) > 0.5d) {
