...
public final class RippleHostView extends View {
    ...
    public final void m1211addRippleKOepWvA(PressInteraction.Press press, boolean z, long j, int i, long j2, float f, Function0<Unit> function0) {
        boolean z2 = z;
        ...
        m1212updateRipplePropertiesbiQXAtU(j, i, j2, f);
        if (z2) {
            unprojectedRipple.setHotspot(Offset.m1353getXimpl(press.m329getPressPositionF1C5BW0()), Offset.m1354getYimpl(press.m329getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m1212updateRipplePropertiesbiQXAtU(long j, int i, long j2, float f) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple != null) {
            unprojectedRipple.trySetRadius(i);
            unprojectedRipple.m1220setColorDxMtmZc(j2, f);
            Rect androidRect = RectHelper_androidKt.toAndroidRect(SizeKt.m1443toRectuvyYCjk(j));
    ...
    private final void setRippleState(boolean z) {
        ...
        if (z || longValue >= 5) {
            ...
            $$Lambda$RippleHostView$Xdb_1Gc1JGZel2dMr_C_hEFI5M r8 = new Runnable() {
                public final void run() {
                    RippleHostView.m1210setRippleState$lambda2(RippleHostView.this);
                }
            };
    ...
    public static final void m1210setRippleState$lambda2(RippleHostView rippleHostView) {
