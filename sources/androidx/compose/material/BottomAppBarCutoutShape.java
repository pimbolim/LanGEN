...
final class BottomAppBarCutoutShape implements Shape {
    ...
    public Outline m853createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Path Path = AndroidPath_androidKt.Path();
        Path.addRect(new Rect(0.0f, 0.0f, Size.m1422getWidthimpl(j), Size.m1419getHeightimpl(j)));
        Path Path2 = AndroidPath_androidKt.Path();
        addCutoutShape(Path2, layoutDirection, density);
        Path2.m1819opN5in7k0(Path, Path2, PathOperation.Companion.m1841getDifferenceb3I0S0c());
    ...
    private final void addCutoutShape(Path path, LayoutDirection layoutDirection, Density density) {
        float r0 = density.m3828toPx0680j_4(AppBarKt.BottomAppBarCutoutOffset);
        float f = ((float) 2) * r0;
        ...
        float r7 = left + Size.m1422getWidthimpl(Size);
        float r8 = Size.m1419getHeightimpl(Size) / 2.0f;
        OutlineKt.addOutline(path, this.cutoutShape.m1895createOutlinePq9zytI(Size, layoutDirection, density));
        path.m1821translatek4lQ0M(OffsetKt.Offset(left, -r8));
        if (Intrinsics.areEqual((Object) this.cutoutShape, (Object) RoundedCornerShapeKt.getCircleShape())) {
            addRoundedEdges(path, left, r7, r8, density.m3828toPx0680j_4(AppBarKt.BottomAppBarRoundedEdgeRadius), 0.0f);
        }
    }
