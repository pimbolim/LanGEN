...
final class MenuKt$DropdownMenuContent$1$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    ...
    public final void invoke(GraphicsLayerScope graphicsLayerScope) {
        ...
        graphicsLayerScope.setScaleX(MenuKt.m1025DropdownMenuContent$lambda1(this.$scale$delegate));
        graphicsLayerScope.setScaleY(MenuKt.m1025DropdownMenuContent$lambda1(this.$scale$delegate));
        graphicsLayerScope.setAlpha(MenuKt.m1026DropdownMenuContent$lambda3(this.$alpha$delegate));
