...
public final class KeyboardArrowDownKt {
    ...
    public static final ImageVector getKeyboardArrowDown(Icons.Rounded rounded) {
        ...
        ImageVector.Builder builder2 = new ImageVector.Builder("Rounded.KeyboardArrowDown", Dp.m3859constructorimpl(24.0f), Dp.m3859constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, 96, (DefaultConstructorMarker) null);
        ...
        pathBuilder3.curveToRelative(0.39f, -0.38f, 1.03f, -0.39f, 1.42f, 0.0f);
        pathBuilder.close();
