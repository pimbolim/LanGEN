...
public final class PhoneKt {
    ...
    public static final ImageVector getPhone(Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder3 = new ImageVector.Builder("TwoTone.Phone", Dp.m3859constructorimpl(24.0f), Dp.m3859constructorimpl(24.0f), 24.0f, 24.0f, 0, 0, 96, (DefaultConstructorMarker) null);
        ...
        pathBuilder2.curveToRelative(-0.23f, -0.84f, -0.38f, -1.71f, -0.44f, -2.6f);
        ...
        pathBuilder3.moveTo(9.07f, 7.57f);
        ...
        pathBuilder5.curveToRelative(0.0f, 9.39f, 7.61f, 17.0f, 17.0f, 17.0f);
        pathBuilder5.curveToRelative(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        ...
        pathBuilder6.curveToRelative(-1.24f, 0.0f, -2.45f, -0.2f, -3.57f, -0.57f);
        pathBuilder6.curveToRelative(-0.1f, -0.04f, -0.21f, -0.05f, -0.31f, -0.05f);
        pathBuilder6.curveToRelative(-0.26f, 0.0f, -0.51f, 0.1f, -0.71f, 0.29f);
        pathBuilder3.lineToRelative(-2.2f, 2.2f);
        pathBuilder6.curveToRelative(-2.83f, -1.45f, -5.15f, -3.76f, -6.59f, -6.59f);
        pathBuilder3.lineToRelative(2.2f, -2.2f);
        pathBuilder6.curveToRelative(0.28f, -0.28f, 0.36f, -0.67f, 0.25f, -1.02f);
        pathBuilder3.close();
        ...
        pathBuilder7.curveToRelative(-1.32f, -0.09f, -2.59f, -0.35f, -3.8f, -0.75f);
        pathBuilder3.lineToRelative(1.2f, -1.19f);
        pathBuilder3.close();
        pathBuilder3.moveTo(5.79f, 8.8f);
        pathBuilder7.curveToRelative(-0.41f, -1.21f, -0.67f, -2.48f, -0.76f, -3.8f);
        pathBuilder3.horizontalLineToRelative(1.5f);
        pathBuilder3.curveToRelative(0.07f, 0.89f, 0.22f, 1.76f, 0.46f, 2.59f);
        pathBuilder3.lineTo(5.79f, 8.8f);
        pathBuilder3.close();
