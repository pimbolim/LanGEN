...
final class DefaultRadioButtonColors implements RadioButtonColors {
    ...
    public State<Color> radioColor(boolean z, boolean z2, Composer composer, int i) {
        ...
        if (z) {
            ...
            state = SingleValueAnimationKt.m87animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (Function1<? super Color, Unit>) null, composer, 48, 4);
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m1597equalsimpl0(this.selectedColor, defaultRadioButtonColors.selectedColor) && Color.m1597equalsimpl0(this.unselectedColor, defaultRadioButtonColors.unselectedColor) && Color.m1597equalsimpl0(this.disabledColor, defaultRadioButtonColors.disabledColor);
    }

    public int hashCode() {
        return (((Color.m1603hashCodeimpl(this.selectedColor) * 31) + Color.m1603hashCodeimpl(this.unselectedColor)) * 31) + Color.m1603hashCodeimpl(this.disabledColor);
    }
}
