...
final class BottomNavigationKt$BottomNavigationTransition$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (((i & 11) ^ 2) != 0 || !composer.getSkipping()) {
            this.$content.invoke(Float.valueOf(BottomNavigationKt.m858BottomNavigationTransition_Klgx_Pg$lambda3(this.$animationProgress$delegate)), composer, Integer.valueOf((this.$$dirty >> 6) & 112));
        } else {
