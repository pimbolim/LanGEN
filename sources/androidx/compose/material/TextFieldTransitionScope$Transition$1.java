...
final class TextFieldTransitionScope$Transition$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    final /* synthetic */ Function7<Float, Color, Color, Dp, Float, Composer, Integer, Unit> $content;
    ...
    TextFieldTransitionScope$Transition$1(TextFieldTransitionScope textFieldTransitionScope, InputPhase inputPhase, long j, long j2, Function3<? super InputPhase, ? super Composer, ? super Integer, Color> function3, boolean z, Function7<? super Float, ? super Color, ? super Color, ? super Dp, ? super Float, ? super Composer, ? super Integer, Unit> function7, int i) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        this.$tmp0_rcvr.m1187TransitionDTcfvLk(this.$inputState, this.$focusedTextStyleColor, this.$unfocusedTextStyleColor, this.$contentColor, this.$showLabel, this.$content, composer, this.$$changed | 1);
    }
}
