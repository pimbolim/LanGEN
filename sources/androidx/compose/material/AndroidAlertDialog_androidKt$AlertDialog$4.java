...
final class AndroidAlertDialog_androidKt$AlertDialog$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        AndroidAlertDialog_androidKt.m828AlertDialogwqdebIU(this.$onDismissRequest, this.$buttons, this.$modifier, this.$title, this.$text, this.$shape, this.$backgroundColor, this.$contentColor, this.$properties, composer, this.$$changed | 1, this.$$default);
    }
}
