...
final class ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$6 implements MeasurePolicy {
    ...
    public final MeasureResult m1195measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$this$Layout");
        Intrinsics.checkNotNullParameter(list, "$noName_0");
        this.$popupLayout.setParentLayoutDirection(this.$layoutDirection);
        return MeasureScope.DefaultImpls.layout$default(measureScope, 0, 0, (Map) null, ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$6$measure$1.INSTANCE, 4, (Object) null);
    }
}
