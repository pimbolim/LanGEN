...
final class PopupLayout$dismissOnOutsideClick$1 extends Lambda implements Function2<Offset, IntRect, Boolean> {
    ...
    public final Boolean invoke(Offset offset, IntRect intRect) {
        ...
        boolean z = false;
        if (offset != null && (Offset.m1353getXimpl(offset.m1363unboximpl()) < ((float) intRect.getLeft()) || Offset.m1353getXimpl(offset.m1363unboximpl()) > ((float) intRect.getRight()) || Offset.m1354getYimpl(offset.m1363unboximpl()) < ((float) intRect.getTop()) || Offset.m1354getYimpl(offset.m1363unboximpl()) > ((float) intRect.getBottom()))) {
            z = true;
        }
