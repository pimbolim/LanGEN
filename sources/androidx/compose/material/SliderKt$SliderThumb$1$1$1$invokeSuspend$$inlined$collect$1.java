...
public final class SliderKt$SliderThumb$1$1$1$invokeSuspend$$inlined$collect$1 implements FlowCollector<Interaction> {
    final /* synthetic */ SnapshotStateList $interactions$inlined;

    public SliderKt$SliderThumb$1$1$1$invokeSuspend$$inlined$collect$1(SnapshotStateList snapshotStateList) {
    ...
    public Object emit(Interaction interaction, Continuation<? super Unit> continuation) {
        ...
        if (interaction2 instanceof PressInteraction.Press) {
            ...
            this.$interactions$inlined.remove((Object) ((DragInteraction.Stop) interaction2).getStart());
        } else if (interaction2 instanceof DragInteraction.Cancel) {
            this.$interactions$inlined.remove((Object) ((DragInteraction.Cancel) interaction2).getStart());
        }
