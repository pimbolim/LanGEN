...
public final class ElevationOverlayKt {
    ...
    public static final long m984calculateForegroundColorCLU3JFs(long j, float f, Composer composer, int i) {
        ...
        long r9 = Color.m1595copywmQWz5c$default(ColorsKt.m932contentColorForek8zF_U(j, composer, i & 14), ((((float) Math.log((double) (f + ((float) 1)))) * 4.5f) + 2.0f) / 100.0f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
