...
final class BottomNavigationKt$BottomNavigationItem$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        BottomNavigationKt.m856BottomNavigationItemjY6E1Zs(rowScope2, this.$selected, this.$onClick, this.$icon, this.$modifier, this.$enabled, this.$label, this.$alwaysShowLabel, this.$interactionSource, this.$selectedContentColor, this.$unselectedContentColor, composer, this.$$changed | 1, this.$$changed1, this.$$default);
    }
}
