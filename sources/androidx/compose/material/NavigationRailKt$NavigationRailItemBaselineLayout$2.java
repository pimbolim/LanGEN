...
final class NavigationRailKt$NavigationRailItemBaselineLayout$2 implements MeasurePolicy {
    ...
    public final MeasureResult m1050measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        Placeable placeable;
        ...
        for (Measurable measurable : iterable) {
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), (Object) "icon")) {
                ...
                if (this.$label == null) {
                    return NavigationRailKt.m1048placeIcon3p2s80s(measureScope, r12, j2);
                }
                Intrinsics.checkNotNull(placeable);
                return NavigationRailKt.m1049placeLabelAndIconDIyivk0(measureScope, placeable, r12, j, this.$iconPositionAnimationProgress);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
