...
final class CompositionLocalKt$CompositionLocalProvider$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) (ProvidedValue[]) Arrays.copyOf(providedValueArr, providedValueArr.length), (Function2<? super Composer, ? super Integer, Unit>) this.$content, composer, this.$$changed | 1);
    }
}
