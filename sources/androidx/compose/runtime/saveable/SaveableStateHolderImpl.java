...
final class SaveableStateHolderImpl implements SaveableStateHolder {
    ...
    public void SaveableStateProvider(Object obj, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(ReusableContent)P(1)145@5253L9:Composables.kt#9igjgp");
        startRestartGroup.startReusableGroup(ComposerKt.reuseKey, obj);
        startRestartGroup.startReplaceableGroup(1516495192);
        ComposerKt.sourceInformation(startRestartGroup, "C76@3023L321,83@3357L150,87@3520L360:SaveableStateHolder.kt#r2ddri");
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            ...
            if (parentSaveableStateRegistry2 == null ? true : parentSaveableStateRegistry2.canBeSaved(obj)) {
    ...
    public final class RegistryHolder {
        ...
        public RegistryHolder(SaveableStateHolderImpl saveableStateHolderImpl, Object obj) {
            Intrinsics.checkNotNullParameter(saveableStateHolderImpl, "this$0");
            Intrinsics.checkNotNullParameter(obj, "key");
