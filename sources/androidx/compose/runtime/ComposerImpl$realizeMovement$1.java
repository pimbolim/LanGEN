...
final class ComposerImpl$realizeMovement$1 extends Lambda implements Function3<Applier<?>, SlotWriter, RememberManager, Unit> {
    final /* synthetic */ int $count;
    final /* synthetic */ int $removeIndex;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ComposerImpl$realizeMovement$1(int i, int i2) {
        super(3);
        this.$removeIndex = i;
        this.$count = i2;
    }
