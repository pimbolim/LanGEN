...
public final class LaunchedEffectImpl implements RememberObserver {
    ...
    public void onRemembered() {
        Job job2 = this.job;
        if (job2 != null) {
            JobKt__JobKt.cancel$default(job2, "Old job was still running!", (Throwable) null, 2, (Object) null);
        }
        this.job = BuildersKt__Builders_commonKt.launch$default(this.scope, (CoroutineContext) null, (CoroutineStart) null, this.task, 3, (Object) null);
    }
