...
@DebugMetadata(c = "androidx.compose.runtime.SnapshotStateKt__SnapshotFlowKt$collectAsState$1", f = "SnapshotFlow.kt", i = {}, l = {175, 66}, m = "invokeSuspend", n = {}, s = {})
...
final class SnapshotStateKt__SnapshotFlowKt$collectAsState$1 extends SuspendLambda implements Function2<ProduceStateScope<R>, Continuation<? super Unit>, Object> {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass2(flow, produceStateScope, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (flow.collect(new SnapshotStateKt__SnapshotFlowKt$collectAsState$1$2$invokeSuspend$$inlined$collect$1(produceStateScope), this) == coroutine_suspended) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Intrinsics.areEqual((Object) this.$context, (Object) EmptyCoroutineContext.INSTANCE)) {
                this.label = 1;
                if (this.$this_collectAsState.collect(new SnapshotStateKt__SnapshotFlowKt$collectAsState$1$invokeSuspend$$inlined$collect$1(produceStateScope), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
