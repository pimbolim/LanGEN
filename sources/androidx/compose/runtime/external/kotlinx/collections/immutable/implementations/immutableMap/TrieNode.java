...
public final class TrieNode<K, V> {
    ...
    public static final class ModificationResult<K, V> {
        ...
        public final ModificationResult<K, V> replaceNode(Function1<? super TrieNode<K, V>, TrieNode<K, V>> function1) {
            ...
            modificationResult.setNode(function1.invoke(modificationResult.getNode()));
    ...
    private final boolean collisionContainsKey(K k) {
        ...
        if ((step2 > 0 && first <= last) || (step2 < 0 && last <= first)) {
            while (true) {
                int i = first + step2;
                if (Intrinsics.areEqual((Object) k, this.buffer[first])) {
                    return true;
                }
                if (first == last) {
                    break;
    ...
    private final V collisionGet(K k) {
        ...
        while (true) {
            int i = first + step2;
            if (Intrinsics.areEqual((Object) k, keyAtIndex(first))) {
    ...
    private final TrieNode<K, V> collisionRemove(K k, V v) {
        ...
        if ((step2 > 0 && first <= last) || (step2 < 0 && last <= first)) {
            while (true) {
                int i = first + step2;
                if (Intrinsics.areEqual((Object) k, keyAtIndex(first)) && Intrinsics.areEqual((Object) v, valueAtKeyIndex(first))) {
                    return collisionRemoveEntryAtIndex(first);
                }
                if (first == last) {
                    break;
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        CommonFunctionsKt.m1249assert(this.nodeMap == 0);
        CommonFunctionsKt.m1249assert(this.dataMap == 0);
        CommonFunctionsKt.m1249assert(trieNode.nodeMap == 0);
        CommonFunctionsKt.m1249assert(trieNode.dataMap == 0);
        Object[] objArr = this.buffer;
        Object[] copyOf = Arrays.copyOf(objArr, objArr.length + trieNode.buffer.length);
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
        int length = this.buffer.length;
        IntProgression step = RangesKt.step((IntProgression) RangesKt.until(0, trieNode.buffer.length), 2);
        int first = step.getFirst();
        int last = step.getLast();
        int step2 = step.getStep();
        if ((step2 > 0 && first <= last) || (step2 < 0 && last <= first)) {
    ...
    private final TrieNode<K, V> mutablePutAllFromOtherNodeCell(TrieNode<K, V> trieNode, int i, int i2, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (trieNode.hasNodeAt(i)) {
            ...
            if (hasEntryAt$runtime_release(i7)) {
                ...
                int i9 = i2 + 5;
                if (nodeAtIndex$runtime_release2.containsKey(i4, keyAtIndex2, i9)) {
                    deltaCounter2.setCount(deltaCounter.getCount() + 1);
                } else {
                    ...
                    return nodeAtIndex$runtime_release2.mutablePut(i5, keyAtIndex2, valueAtKeyIndex2, i9, persistentHashMapBuilder);
                }
            }
            return nodeAtIndex$runtime_release2;
        }
        int entryKeyIndex$runtime_release3 = entryKeyIndex$runtime_release(i7);
        ...
        if (keyAtIndex4 != null) {
            i8 = keyAtIndex4.hashCode();
        }
        return makeNode(i3, keyAtIndex3, valueAtKeyIndex3, i8, keyAtIndex4, valueAtKeyIndex4, i2 + 5, persistentHashMapBuilder.getOwnership$runtime_release());
    }
    ...
    public final boolean containsKey(int i, K k, int i2) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            return Intrinsics.areEqual((Object) k, keyAtIndex(entryKeyIndex$runtime_release(indexSegment)));
        }
    ...
    public final V get(int i, K k, int i2) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            ...
            if (Intrinsics.areEqual((Object) k, keyAtIndex(entryKeyIndex$runtime_release))) {
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> trieNode, int i, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (this == trieNode3) {
            ...
            int i7 = 0;
            if ((i2 & i6) == 0) {
                if (Intrinsics.areEqual((Object) this.ownedBy, (Object) persistentHashMapBuilder.getOwnership$runtime_release()) && this.dataMap == i6 && this.nodeMap == i2) {
                    trieNode2 = this;
                } else {
                ...
                while (i8 != 0) {
                    ...
                    trieNode2.getBuffer$runtime_release()[(trieNode2.getBuffer$runtime_release().length - 1) - i9] = mutablePutAllFromOtherNodeCell(trieNode, lowestOneBit2, i, deltaCounter, persistentHashMapBuilder);
                    i9++;
                    i8 ^= lowestOneBit2;
                }
                while (i6 != 0) {
                    ...
                    if (!trieNode3.hasEntryAt$runtime_release(lowestOneBit3)) {
                        ...
                        trieNode2.getBuffer$runtime_release()[i10] = keyAtIndex(entryKeyIndex$runtime_release);
                        trieNode2.getBuffer$runtime_release()[i10 + 1] = valueAtKeyIndex(entryKeyIndex$runtime_release);
                    } else {
                        int entryKeyIndex$runtime_release2 = trieNode3.entryKeyIndex$runtime_release(lowestOneBit3);
                        trieNode2.getBuffer$runtime_release()[i10] = trieNode3.keyAtIndex(entryKeyIndex$runtime_release2);
                        trieNode2.getBuffer$runtime_release()[i10 + 1] = trieNode3.valueAtKeyIndex(entryKeyIndex$runtime_release2);
    ...
    public final TrieNode<K, V> remove(int i, K k, int i2) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            return Intrinsics.areEqual((Object) k, keyAtIndex(entryKeyIndex$runtime_release)) ? removeEntryAtIndex(entryKeyIndex$runtime_release, indexSegment) : this;
        } else if (!hasNodeAt(indexSegment)) {
            return this;
        } else {
            int nodeIndex$runtime_release = nodeIndex$runtime_release(indexSegment);
    ...
    public final TrieNode<K, V> mutableRemove(int i, K k, int i2, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            return Intrinsics.areEqual((Object) k, keyAtIndex(entryKeyIndex$runtime_release)) ? mutableRemoveEntryAtIndex(entryKeyIndex$runtime_release, indexSegment, persistentHashMapBuilder) : this;
        } else if (!hasNodeAt(indexSegment)) {
            return this;
        } else {
            int nodeIndex$runtime_release = nodeIndex$runtime_release(indexSegment);
    ...
    public final TrieNode<K, V> remove(int i, K k, V v, int i2) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            return (!Intrinsics.areEqual((Object) k, keyAtIndex(entryKeyIndex$runtime_release)) || !Intrinsics.areEqual((Object) v, valueAtKeyIndex(entryKeyIndex$runtime_release))) ? this : removeEntryAtIndex(entryKeyIndex$runtime_release, indexSegment);
        } else if (!hasNodeAt(indexSegment)) {
            return this;
        } else {
            int nodeIndex$runtime_release = nodeIndex$runtime_release(indexSegment);
    ...
    public final TrieNode<K, V> mutableRemove(int i, K k, V v, int i2, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            return (!Intrinsics.areEqual((Object) k, keyAtIndex(entryKeyIndex$runtime_release)) || !Intrinsics.areEqual((Object) v, valueAtKeyIndex(entryKeyIndex$runtime_release))) ? this : mutableRemoveEntryAtIndex(entryKeyIndex$runtime_release, indexSegment, persistentHashMapBuilder2);
        } else if (!hasNodeAt(indexSegment)) {
            return this;
        } else {
            int nodeIndex$runtime_release = nodeIndex$runtime_release(indexSegment);
