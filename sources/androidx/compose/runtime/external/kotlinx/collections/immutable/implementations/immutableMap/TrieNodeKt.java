...
public final class TrieNodeKt {
    ...
    public static final <K, V> Object[] insertEntryAtIndex(Object[] objArr, int i, K k, V v) {
        ...
        ArraysKt.copyInto((T[]) objArr, (T[]) objArr2, i + 2, i, objArr.length);
        objArr2[i] = k;
        objArr2[i + 1] = v;
        return objArr2;
    }
    ...
    public static final Object[] replaceEntryWithNode(Object[] objArr, int i, int i2, TrieNode<?, ?> trieNode) {
        ...
        ArraysKt.copyInto$default(objArr, objArr2, 0, 0, i, 6, (Object) null);
        ArraysKt.copyInto((T[]) objArr, (T[]) objArr2, i, i + 2, i2);
        objArr2[i3] = trieNode;
        ArraysKt.copyInto((T[]) objArr, (T[]) objArr2, i3 + 1, i2, objArr.length);
        return objArr2;
    }
    ...
    public static final <K, V> Object[] replaceNodeWithEntry(Object[] objArr, int i, int i2, K k, V v) {
        ...
        ArraysKt.copyInto((T[]) copyOf, (T[]) copyOf, i + 2, i + 1, objArr.length);
        ArraysKt.copyInto((T[]) copyOf, (T[]) copyOf, i2 + 2, i2, i);
        copyOf[i2] = k;
        copyOf[i2 + 1] = v;
        return copyOf;
    }
    ...
    public static final Object[] removeEntryAtIndex(Object[] objArr, int i) {
        Object[] objArr2 = new Object[(objArr.length - 2)];
        ArraysKt.copyInto$default(objArr, objArr2, 0, 0, i, 6, (Object) null);
        ArraysKt.copyInto((T[]) objArr, (T[]) objArr2, i, i + 2, objArr.length);
        return objArr2;
    }
    ...
    public static final Object[] removeNodeAtIndex(Object[] objArr, int i) {
        ...
        ArraysKt.copyInto$default(objArr, objArr2, 0, 0, i, 6, (Object) null);
        ArraysKt.copyInto((T[]) objArr, (T[]) objArr2, i, i + 1, objArr.length);
        return objArr2;
    }
}
