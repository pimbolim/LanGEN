...
final class AnimatedContentScope$slideOutOfContainer$5 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m3978getYimpl(this.this$0.m14calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), r0))) + IntSize.m4018getHeightimpl(r0)));
    }
}
