...
final class AnimatedContentScope$slideIntoContainer$5 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        return this.$initialOffset.invoke(Integer.valueOf((-IntOffset.m3978getYimpl(this.this$0.m14calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.this$0.m17getCurrentSizeYbymL2g()))) - i));
    }
}
