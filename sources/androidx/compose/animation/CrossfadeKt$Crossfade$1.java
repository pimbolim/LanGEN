...
final class CrossfadeKt$Crossfade$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    CrossfadeKt$Crossfade$1(T t, Modifier modifier, FiniteAnimationSpec<Float> finiteAnimationSpec, Function3<? super T, ? super Composer, ? super Integer, Unit> function3, int i, int i2) {
        super(2);
        this.$targetState = t;
