...
final class TransitionKt$createTransitionAnimation$1 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
        ...
        return new TransitionKt$createTransitionAnimation$1$invoke$$inlined$onDispose$1(this.$this_createTransitionAnimation, this.$transitionAnimation);
    }
}
