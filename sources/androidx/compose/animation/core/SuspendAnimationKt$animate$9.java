...
final class SuspendAnimationKt$animate$9 extends Lambda implements Function1<Long, Unit> {
    ...
    SuspendAnimationKt$animate$9(Ref.ObjectRef<AnimationScope<T, V>> objectRef, Animation<T, V> animation, AnimationState<T, V> animationState, Function1<? super AnimationScope<T, V>, Unit> function1) {
        super(1);
