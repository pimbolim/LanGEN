...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m115boximpl(long j) {
        return new Motion(j);
    }
    ...
    public static boolean m119equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m125unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m120equalsimpl0(long j, long j2) {
        return j == j2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m123hashCodeimpl(long j) {
        return C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(j);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m124toStringimpl(long j) {
        return "Motion(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m119equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m123hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m124toStringimpl(this.packedValue);
    }
    ...
    public static final long m117copyXB9eQnU(long j, float f, float f2) {
        return SpringSimulationKt.Motion(f, f2);
    }

    /* renamed from: copy-XB9eQnU$default  reason: not valid java name */
    public static /* synthetic */ long m118copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m121getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m122getVelocityimpl(j);
        }
        return m117copyXB9eQnU(j, f, f2);
    }

    /* renamed from: getValue-impl  reason: not valid java name */
    public static final float m121getValueimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getVelocity-impl  reason: not valid java name */
    public static final float m122getVelocityimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
