...
public final class SpringSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SpringSpec) {
            ...
            if (springSpec.dampingRatio == this.dampingRatio) {
                if (!(springSpec.stiffness == this.stiffness) || !Intrinsics.areEqual((Object) springSpec.visibilityThreshold, (Object) this.visibilityThreshold)) {
                    return false;
                }
                return true;
            }
    ...
    public int hashCode() {
        ...
        return ((((t == null ? 0 : t.hashCode()) * 31) + Float.floatToIntBits(this.dampingRatio)) * 31) + Float.floatToIntBits(this.stiffness);
    }
}
