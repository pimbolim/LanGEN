...
final class SuspendAnimationKt$animate$6 extends Lambda implements Function1<Long, Unit> {
    ...
    SuspendAnimationKt$animate$6(Ref.ObjectRef<AnimationScope<T, V>> objectRef, T t, Animation<T, V> animation, V v, AnimationState<T, V> animationState, Function1<? super AnimationScope<T, V>, Unit> function1) {
        super(1);
    ...
    public final void invoke(long j) {
        ...
        AnimationScope animationScope = new AnimationScope(t, typeConverter, v, j, targetValue, j, true, new Function0<Unit>() {
            public final void invoke() {
                animationState.setRunning$animation_core_release(false);
            }
        });
        SuspendAnimationKt.doAnimationFrame(animationScope, j, this.$animation, this.$this_animate, this.$block);
