...
public final class Scale {
    ...
    public static /* synthetic */ Scale m82copybnNdC4k$default(Scale scale2, float f, long j, FiniteAnimationSpec<Float> finiteAnimationSpec, int i, Object obj) {
        if ((i & 1) != 0) {
            f = scale2.scale;
        }
        if ((i & 2) != 0) {
        ...
        return scale2.m84copybnNdC4k(f, j, finiteAnimationSpec);
    }
    ...
    public final Scale m84copybnNdC4k(float f, long j, FiniteAnimationSpec<Float> finiteAnimationSpec) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) Float.valueOf(this.scale), (Object) Float.valueOf(scale2.scale)) && TransformOrigin.m1949equalsimpl0(this.transformOrigin, scale2.transformOrigin) && Intrinsics.areEqual((Object) this.animationSpec, (Object) scale2.animationSpec);
    }

    public int hashCode() {
        return (((Float.floatToIntBits(this.scale) * 31) + TransformOrigin.m1952hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + TransformOrigin.m1953toStringimpl(this.transformOrigin) + ", animationSpec=" + this.animationSpec + ')';
    }
