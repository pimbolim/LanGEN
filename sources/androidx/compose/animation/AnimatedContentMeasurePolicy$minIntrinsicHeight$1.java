...
final class AnimatedContentMeasurePolicy$minIntrinsicHeight$1 extends Lambda implements Function1<IntrinsicMeasurable, Integer> {
    final /* synthetic */ int $width;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AnimatedContentMeasurePolicy$minIntrinsicHeight$1(int i) {
        super(1);
        this.$width = i;
    }
