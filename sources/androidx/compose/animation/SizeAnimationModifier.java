...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final class AnimData {
        ...
        public static /* synthetic */ AnimData m90copyO0kMr_c$default(AnimData animData, Animatable<IntSize, AnimationVector2D> animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual((Object) this.anim, (Object) animData.anim) && IntSize.m4017equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m4020hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + IntSize.m4022toStringimpl(this.startSize) + ')';
        }
    ...
    public MeasureResult m89measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measureScope, "$receiver");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        Placeable r9 = measurable.m3151measureBRTryo0(j);
        long r10 = m88animateTomzRDjE0(IntSizeKt.IntSize(r9.getWidth(), r9.getHeight()));
        return MeasureScope.DefaultImpls.layout$default(measureScope, IntSize.m4019getWidthimpl(r10), IntSize.m4018getHeightimpl(r10), (Map) null, new SizeAnimationModifier$measure$1(r9), 4, (Object) null);
    }

    /* renamed from: animateTo-mzRDjE0  reason: not valid java name */
    public final long m88animateTomzRDjE0(long j) {
        long j2 = j;
        AnimData animData2 = this.animData;
        if (animData2 == null) {
            animData2 = null;
        } else if (!IntSize.m4017equalsimpl0(j2, animData2.getAnim().getTargetValue().m4023unboximpl())) {
            animData2.m94setStartSizeozmzZPI(animData2.getAnim().getValue().m4023unboximpl());
            Job unused = BuildersKt__Builders_commonKt.launch$default(getScope(), (CoroutineContext) null, (CoroutineStart) null, new SizeAnimationModifier$animateTo$data$1$1(animData2, j, this, (Continuation<? super SizeAnimationModifier$animateTo$data$1$1>) null), 3, (Object) null);
        }
        if (animData2 == null) {
            animData2 = new AnimData(new Animatable(IntSize.m4011boximpl(j), VectorConvertersKt.getVectorConverter(IntSize.Companion), IntSize.m4011boximpl(IntSizeKt.IntSize(1, 1))), j2, (DefaultConstructorMarker) null);
        }
        this.animData = animData2;
        return animData2.getAnim().getValue().m4023unboximpl();
    }
}
