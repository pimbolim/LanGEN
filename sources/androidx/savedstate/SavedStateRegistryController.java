...
public final class SavedStateRegistryController {
    ...
    public final void performAttach() {
        ...
        if (lifecycle.getCurrentState() == Lifecycle.State.INITIALIZED) {
            ...
            this.savedStateRegistry.performAttach(lifecycle);
            this.attached = true;
            return;
        }
    ...
    public final void performRestore(Bundle bundle) {
        ...
        if (!lifecycle.getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
            this.savedStateRegistry.performRestore(bundle);
            return;
        }
        throw new IllegalStateException(Intrinsics.stringPlus("performRestore cannot be called when owner is ", lifecycle.getCurrentState()).toString());
    }
