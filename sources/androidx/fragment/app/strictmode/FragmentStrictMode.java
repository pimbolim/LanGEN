...
public final class FragmentStrictMode {
    ...
    private final void handlePolicyViolation(Policy policy, Violation violation) {
        ...
        if (policy.getListener$fragment_release() != null) {
            runOnHostThread(fragment, new Runnable(violation) {
                ...
                public final void run() {
                    FragmentStrictMode.m4218handlePolicyViolation$lambda0(FragmentStrictMode.Policy.this, this.f$1);
                }
            });
        }
        if (policy.getFlags$fragment_release().contains(Flag.PENALTY_DEATH)) {
            runOnHostThread(fragment, new Runnable(name, violation) {
                ...
                public final void run() {
                    FragmentStrictMode.m4219handlePolicyViolation$lambda1(this.f$0, this.f$1);
                }
            });
        }
    }
    ...
    public static final void m4218handlePolicyViolation$lambda0(Policy policy, Violation violation) {
    ...
    public static final void m4219handlePolicyViolation$lambda1(String str, Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "$violation");
    ...
    public static final class Policy {
        ...
        public static final class Builder {
            ...
            public final Builder penaltyListener(OnViolationListener onViolationListener) {
                Intrinsics.checkNotNullParameter(onViolationListener, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
                this.listener = onViolationListener;
                return this;
            }
