        ...
        if (view == null) {
            ...
            if (z) {
                if (z2) {
                    ...
                    this.mListContainer.startAnimation(AnimationUtils.loadAnimation(getContext(), Opcodes.ASM10_EXPERIMENTAL));
                } else {
                    view.clearAnimation();
            ...
            if (z2) {
                view.startAnimation(AnimationUtils.loadAnimation(getContext(), Opcodes.ASM10_EXPERIMENTAL));
