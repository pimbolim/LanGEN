...
public class EmojiCompatInitializer implements Initializer<Boolean> {
    ...
    static class BackgroundDefaultLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void load(EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback) {
            ...
            createBackgroundPriorityExecutor.execute(new Runnable(metadataRepoLoaderCallback, createBackgroundPriorityExecutor) {
                ...
                public final void run() {
                    EmojiCompatInitializer.BackgroundDefaultLoader.this.lambda$load$0$EmojiCompatInitializer$BackgroundDefaultLoader(this.f$1, this.f$2);
                }
            });
        }
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: doLoad */
        public void lambda$load$0$EmojiCompatInitializer$BackgroundDefaultLoader(final EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback, final ThreadPoolExecutor threadPoolExecutor) {
            try {
