...
public final class LiveDataScopeImpl<T> implements LiveDataScope<T> {
    ...
    public LiveDataScopeImpl(CoroutineLiveData<T> coroutineLiveData, CoroutineContext coroutineContext2) {
        Intrinsics.checkNotNullParameter(coroutineLiveData, "target");
        Intrinsics.checkNotNullParameter(coroutineContext2, "context");
        this.target = coroutineLiveData;
        this.coroutineContext = coroutineContext2.plus(Dispatchers.getMain().getImmediate());
    }
    ...
    public Object emitSource(LiveData<T> liveData, Continuation<? super DisposableHandle> continuation) {
        return BuildersKt.withContext(this.coroutineContext, new LiveDataScopeImpl$emitSource$2(this, liveData, (Continuation<? super LiveDataScopeImpl$emitSource$2>) null), continuation);
    }

    public Object emit(T t, Continuation<? super Unit> continuation) {
        Object withContext = BuildersKt.withContext(this.coroutineContext, new LiveDataScopeImpl$emit$2(this, t, (Continuation<? super LiveDataScopeImpl$emit$2>) null), continuation);
