...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(CoroutineContext coroutineContext, Runnable runnable) {
        ...
        if (immediate.isDispatchNeeded(coroutineContext) || canRun()) {
            immediate.dispatch(coroutineContext, new Runnable(runnable) {
                ...
                public final void run() {
                    DispatchQueue.m4221dispatchAndEnqueue$lambda2$lambda1(DispatchQueue.this, this.f$1);
                }
            });
        } else {
            enqueue(runnable);
    ...
    public static final void m4221dispatchAndEnqueue$lambda2$lambda1(DispatchQueue dispatchQueue, Runnable runnable) {
