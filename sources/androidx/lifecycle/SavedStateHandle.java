...
public final class SavedStateHandle {
    ...
    public static final Bundle m4223savedStateProvider$lambda0(SavedStateHandle savedStateHandle) {
        ...
        for (Map.Entry next : MapsKt.toMap(savedStateHandle.savedStateProviders).entrySet()) {
            Bundle saveState = ((SavedStateRegistry.SavedStateProvider) next.getValue()).saveState();
            Intrinsics.checkNotNullExpressionValue(saveState, "value.saveState()");
            savedStateHandle.set((String) next.getKey(), saveState);
        }
    ...
    public SavedStateHandle(Map<String, ? extends Object> map) {
        ...
        this.savedStateProvider = new SavedStateRegistry.SavedStateProvider() {
            public final Bundle saveState() {
                return SavedStateHandle.m4223savedStateProvider$lambda0(SavedStateHandle.this);
            }
        };
    ...
    public static final class Companion {
        ...
        public final boolean validateValue(Object obj) {
            ...
            Class[] access$getACCEPTABLE_CLASSES$cp = SavedStateHandle.ACCEPTABLE_CLASSES;
