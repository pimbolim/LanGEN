...
public class ViewModelProvider {
    ...
    public interface Factory {
        ...
        public final /* synthetic */ class CC {
            ...
            public static <T extends ViewModel> ViewModel $default$create(Factory _this, Class cls) {
                Intrinsics.checkNotNullParameter(cls, "modelClass");
                throw new UnsupportedOperationException("Factory.create(String) is unsupported.  This Factory requires `CreationExtras` to be passed into `create` method.");
            }

            public static <T extends ViewModel> ViewModel $default$create(Factory _this, Class cls, CreationExtras creationExtras) {
                Intrinsics.checkNotNullParameter(cls, "modelClass");
                Intrinsics.checkNotNullParameter(creationExtras, "extras");
                return _this.create(cls);
            }
        }
    ...
    public <T extends ViewModel> T get(String str, Class<T> cls) {
        ...
        T create = this.factory.create(cls, mutableCreationExtras);
    ...
    public static class AndroidViewModelFactory extends NewInstanceFactory {
        ...
        public <T extends ViewModel> T create(Class<T> cls, CreationExtras creationExtras) {
            ...
            Application application3 = (Application) creationExtras.get(APPLICATION_KEY);
            if (application3 != null) {
                return create(cls, application3);
            }
