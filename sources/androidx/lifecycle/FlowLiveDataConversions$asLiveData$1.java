...
final class FlowLiveDataConversions$asLiveData$1 extends SuspendLambda implements Function2<LiveDataScope<T>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$this_asLiveData.collect(new FlowLiveDataConversions$asLiveData$1$invokeSuspend$$inlined$collect$1((LiveDataScope) this.L$0), this) == coroutine_suspended) {
