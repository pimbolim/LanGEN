...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        long j6 = j3;
        boolean z2 = z;
        instance.calculateTwilight(DateUtils.MILLIS_PER_DAY + currentTimeMillis, location.getLatitude(), location.getLongitude());
        long j7 = instance.sunrise;
        if (j6 == -1 || j5 == -1) {
            j = 43200000 + currentTimeMillis;
        } else {
            j = (currentTimeMillis > j5 ? 0 + j7 : currentTimeMillis > j6 ? 0 + j5 : 0 + j6) + DateUtils.MILLIS_PER_MINUTE;
        }
