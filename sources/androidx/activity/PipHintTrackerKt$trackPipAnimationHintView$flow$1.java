...
final class PipHintTrackerKt$trackPipAnimationHintView$flow$1 extends SuspendLambda implements Function2<ProducerScope<? super Rect>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final $$Lambda$PipHintTrackerKt$trackPipAnimationHintView$flow$1$4ion0smgNNILo7u6DNVHbCOCSDk r1 = new View.OnLayoutChangeListener() {
                public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    PipHintTrackerKt$trackPipAnimationHintView$flow$1.m2invokeSuspend$lambda0(ProducerScope.this, view, i, i2, i3, i4, i5, i6, i7, i8);
                }
            };
            final $$Lambda$PipHintTrackerKt$trackPipAnimationHintView$flow$1$r95DZduMC1yZ2Ffp03M69mkmmB8 r4 = new ViewTreeObserver.OnScrollChangedListener(this.$view) {
                ...
                public final void onScrollChanged() {
                    PipHintTrackerKt$trackPipAnimationHintView$flow$1.m3invokeSuspend$lambda1(ProducerScope.this, this.f$1);
                }
            };
            ...
            if (Api19Impl.INSTANCE.isAttachedToWindow(this.$view)) {
                producerScope.m6176trySendJP2dKIU(PipHintTrackerKt.trackPipAnimationHintView$positionInWindow(this.$view));
    ...
    public static final void m2invokeSuspend$lambda0(ProducerScope producerScope, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        if (i != i5 || i3 != i7 || i2 != i6 || i4 != i8) {
            Intrinsics.checkNotNullExpressionValue(view, "v");
            producerScope.m6176trySendJP2dKIU(PipHintTrackerKt.trackPipAnimationHintView$positionInWindow(view));
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: invokeSuspend$lambda-1  reason: not valid java name */
    public static final void m3invokeSuspend$lambda1(ProducerScope producerScope, View view) {
        producerScope.m6176trySendJP2dKIU(PipHintTrackerKt.trackPipAnimationHintView$positionInWindow(view));
    }
}
