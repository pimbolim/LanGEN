...
public class PayPalLineItem implements Parcelable {
    ...
    public JSONObject toJson() {
        try {
            return new JSONObject().putOpt(DESCRIPTION_KEY, this.mDescription).putOpt(KIND_KEY, this.mKind).putOpt("name", this.mName).putOpt("product_code", this.mProductCode).putOpt("quantity", this.mQuantity).putOpt(UNIT_AMOUNT_KEY, this.mUnitAmount).putOpt(UNIT_TAX_AMOUNT_KEY, this.mUnitTaxAmount).putOpt("url", this.mUrl);
