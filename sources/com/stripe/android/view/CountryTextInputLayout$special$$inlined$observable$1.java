...
public final class CountryTextInputLayout$special$$inlined$observable$1 extends ObservableProperty<CountryCode> {
    final /* synthetic */ Object $initialValue;
    final /* synthetic */ CountryTextInputLayout this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CountryTextInputLayout$special$$inlined$observable$1(Object obj, CountryTextInputLayout countryTextInputLayout) {
        super(obj);
    ...
    public void afterChange(KProperty<?> kProperty, CountryCode countryCode, CountryCode countryCode2) {
        Intrinsics.checkNotNullParameter(kProperty, "property");
        CountryCode countryCode3 = countryCode2;
        CountryCode countryCode4 = countryCode;
        if (countryCode3 != null) {
            this.this$0.getCountryCodeChangeCallback().invoke(countryCode3);
            Country countryByCode = CountryUtils.INSTANCE.getCountryByCode(countryCode3, this.this$0.getLocale());
