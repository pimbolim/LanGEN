...
public final class CardMultilineWidget$special$$inlined$observable$2 extends ObservableProperty<Integer> {
    final /* synthetic */ Object $initialValue;
    final /* synthetic */ CardMultilineWidget this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CardMultilineWidget$special$$inlined$observable$2(Object obj, CardMultilineWidget cardMultilineWidget) {
        super(obj);
    ...
    public void afterChange(KProperty<?> kProperty, Integer num, Integer num2) {
        ...
        Integer num3 = num2;
        Integer num4 = num;
        TextInputLayout expiryTextInputLayout = this.this$0.getExpiryTextInputLayout();
        if (num3 == null) {
            str = null;
        } else {
