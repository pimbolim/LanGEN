...
public final class CardMultilineWidget$special$$inlined$observable$6 extends ObservableProperty<StripeEditText.ErrorMessageListener> {
    final /* synthetic */ Object $initialValue;
    final /* synthetic */ CardMultilineWidget this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CardMultilineWidget$special$$inlined$observable$6(Object obj, CardMultilineWidget cardMultilineWidget) {
        super(obj);
    ...
    public void afterChange(KProperty<?> kProperty, StripeEditText.ErrorMessageListener errorMessageListener, StripeEditText.ErrorMessageListener errorMessageListener2) {
        ...
        this.this$0.getCvcEditText().setErrorMessageListener(errorMessageListener2);
    }
}
