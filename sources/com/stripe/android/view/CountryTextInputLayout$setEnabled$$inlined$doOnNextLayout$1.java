...
public final class CountryTextInputLayout$setEnabled$$inlined$doOnNextLayout$1 implements View.OnLayoutChangeListener {
    final /* synthetic */ boolean $enabled$inlined;
    final /* synthetic */ CountryTextInputLayout this$0;

    public CountryTextInputLayout$setEnabled$$inlined$doOnNextLayout$1(CountryTextInputLayout countryTextInputLayout, boolean z) {
    ...
    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        this.this$0.getCountryAutocomplete().setEnabled(this.$enabled$inlined);
    }
}
