...
final class PaymentSessionViewModel$fetchCustomer$1$onCustomerRetrieved$1 extends Lambda implements Function0<Unit> {
    ...
    PaymentSessionViewModel$fetchCustomer$1$onCustomerRetrieved$1(PaymentSessionViewModel paymentSessionViewModel, MutableLiveData<PaymentSessionViewModel.FetchCustomerResult> mutableLiveData) {
        super(0);
