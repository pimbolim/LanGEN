...
final class PaymentOptionsViewModelModule$providePrefsRepositoryFactory$1 extends Lambda implements Function1<PaymentSheet.CustomerConfiguration, PrefsRepository> {
    final /* synthetic */ Context $appContext;
    final /* synthetic */ CoroutineContext $workContext;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PaymentOptionsViewModelModule$providePrefsRepositoryFactory$1(Context context, CoroutineContext coroutineContext) {
        super(1);
