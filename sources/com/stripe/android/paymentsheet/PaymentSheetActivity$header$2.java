...
final class PaymentSheetActivity$header$2 extends Lambda implements Function0<ComposeView> {
    final /* synthetic */ PaymentSheetActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PaymentSheetActivity$header$2(PaymentSheetActivity paymentSheetActivity) {
        super(0);
