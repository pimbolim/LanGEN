...
/* renamed from: com.stripe.android.paymentsheet.forms.FormViewModel$completeFormValues$lambda-18$$inlined$combine$1  reason: invalid class name */
/* compiled from: SafeCollector.common.kt */
public final class FormViewModel$completeFormValues$lambda18$$inlined$combine$1 implements Flow<Map<IdentifierSpec, ? extends FormFieldEntry>> {
    final /* synthetic */ Flow[] $flowArray$inlined;

    public FormViewModel$completeFormValues$lambda18$$inlined$combine$1(Flow[] flowArr) {
    ...
    @DebugMetadata(c = "com.stripe.android.paymentsheet.forms.FormViewModel$completeFormValues$lambda-18$$inlined$combine$1$3", f = "FormViewModel.kt", i = {}, l = {333}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.stripe.android.paymentsheet.forms.FormViewModel$completeFormValues$lambda-18$$inlined$combine$1$3  reason: invalid class name */
    ...
    public static final class AnonymousClass3 extends SuspendLambda implements Function3<FlowCollector<? super Map<IdentifierSpec, ? extends FormFieldEntry>>, List<? extends Pair<? extends IdentifierSpec, ? extends FormFieldEntry>>[], Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Map map = MapsKt.toMap(CollectionsKt.flatten(ArraysKt.toList((T[]) (List[]) ((Object[]) this.L$1))));
                this.label = 1;
                if (((FlowCollector) this.L$0).emit(map, this) == coroutine_suspended) {
