...
final class GooglePayLauncherViewModel$Factory$create$1 extends Lambda implements Function0<String> {
    final /* synthetic */ String $publishableKey;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GooglePayLauncherViewModel$Factory$create$1(String str) {
        super(0);
