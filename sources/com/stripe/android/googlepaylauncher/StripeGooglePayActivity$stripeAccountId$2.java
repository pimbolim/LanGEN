...
final class StripeGooglePayActivity$stripeAccountId$2 extends Lambda implements Function0<String> {
    final /* synthetic */ StripeGooglePayActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StripeGooglePayActivity$stripeAccountId$2(StripeGooglePayActivity stripeGooglePayActivity) {
        super(0);
