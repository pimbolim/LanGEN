...
final class SimpleDialogElementUIKt$SimpleDialogElementUI$3$3$1$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Function0<Unit> $onDismissListener;
    final /* synthetic */ MutableState<Boolean> $openDialog;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SimpleDialogElementUIKt$SimpleDialogElementUI$3$3$1$1(MutableState<Boolean> mutableState, Function0<Unit> function0) {
        super(0);
