...
public final class CvcConfig implements CardDetailsTextFieldConfig {
    ...
    public int m4566getCapitalizationIUNYP9k() {
    ...
    public int m4567getKeyboardPjHm6EE() {
    ...
    public TextFieldState determineState(CardBrand cardBrand, String str, int i) {
        ...
        if (cardBrand == CardBrand.Unknown) {
            ...
            return valid;
        } else if (z2 && str.length() < i) {
            return new TextFieldStateConstants.Error.Incomplete(R.string.invalid_cvc);
        } else {
            if (z2 && str.length() > i) {
                return new TextFieldStateConstants.Error.Invalid(R.string.invalid_cvc, (Object[]) null, 2, (DefaultConstructorMarker) null);
            }
            if (!z2 || str.length() != i) {
                return new TextFieldStateConstants.Error.Invalid(R.string.invalid_cvc, (Object[]) null, 2, (DefaultConstructorMarker) null);
            }
