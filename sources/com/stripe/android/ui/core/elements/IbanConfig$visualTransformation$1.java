...
final class IbanConfig$visualTransformation$1 implements VisualTransformation {
    public static final IbanConfig$visualTransformation$1 INSTANCE = new IbanConfig$visualTransformation$1();

    IbanConfig$visualTransformation$1() {
    }
    ...
    public final TransformedText filter(AnnotatedString annotatedString) {
        ...
        return new TransformedText(new AnnotatedString(sb2, (List) null, (List) null, 6, (DefaultConstructorMarker) null), new IbanConfig$visualTransformation$1$filter$2());
    }
}
