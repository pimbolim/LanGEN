...
final class TextFieldUIKt$TextField$processedIsFull$2 extends Lambda implements Function0<MutableState<Boolean>> {
    public static final TextFieldUIKt$TextField$processedIsFull$2 INSTANCE = new TextFieldUIKt$TextField$processedIsFull$2();

    TextFieldUIKt$TextField$processedIsFull$2() {
        super(0);
    }
