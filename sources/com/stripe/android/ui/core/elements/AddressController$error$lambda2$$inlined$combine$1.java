...
/* renamed from: com.stripe.android.ui.core.elements.AddressController$error$lambda-2$$inlined$combine$1  reason: invalid class name */
/* compiled from: SafeCollector.common.kt */
public final class AddressController$error$lambda2$$inlined$combine$1 implements Flow<FieldError> {
    final /* synthetic */ Flow[] $flowArray$inlined;

    public AddressController$error$lambda2$$inlined$combine$1(Flow[] flowArr) {
        this.$flowArray$inlined = flowArr;
    }

    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        final Flow[] flowArr = this.$flowArray$inlined;
        Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, new Function0<FieldError[]>() {
            public final FieldError[] invoke() {
                return new FieldError[flowArr.length];
            }
    ...
    @DebugMetadata(c = "com.stripe.android.ui.core.elements.AddressController$error$lambda-2$$inlined$combine$1$3", f = "AddressController.kt", i = {}, l = {333}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class AnonymousClass3 extends SuspendLambda implements Function3<FlowCollector<? super FieldError>, FieldError[], Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                Object firstOrNull = CollectionsKt.firstOrNull(ArraysKt.filterNotNull((FieldError[]) ((Object[]) this.L$1)));
                this.label = 1;
                if (((FlowCollector) this.L$0).emit(firstOrNull, this) == coroutine_suspended) {
