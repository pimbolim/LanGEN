...
@DebugMetadata(c = "com.stripe.android.Stripe$retrieveSourceSynchronous$1", f = "Stripe.kt", i = {}, l = {1090}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: Stripe.kt */
final class Stripe$retrieveSourceSynchronous$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Source>, Object> {
    ...
    Stripe$retrieveSourceSynchronous$1(Stripe stripe, String str, String str2, String str3, Continuation<? super Stripe$retrieveSourceSynchronous$1> continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Source> continuation) {
        return ((Stripe$retrieveSourceSynchronous$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
