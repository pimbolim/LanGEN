...
@Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0014\u0010\u0002\u001a\u00020\u00032\n\u0010\u0004\u001a\u0006\u0012\u0002\b\u00030\u0005H\u0016¨\u0006\u0006"}, d2 = {"com/stripe/android/link/LinkActivityViewModel$Factory$fallbackInitialize$1", "Lcom/stripe/android/link/injection/NonFallbackInjector;", "inject", "", "injectable", "Lcom/stripe/android/core/injection/Injectable;", "link_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* compiled from: LinkActivityViewModel.kt */
public final class LinkActivityViewModel$Factory$fallbackInitialize$1 implements NonFallbackInjector {
    final /* synthetic */ LinkViewModelFactoryComponent $viewModelComponent;

    LinkActivityViewModel$Factory$fallbackInitialize$1(LinkViewModelFactoryComponent linkViewModelFactoryComponent) {
        this.$viewModelComponent = linkViewModelFactoryComponent;
    }

    public void inject(Injectable<?> injectable) {
        Intrinsics.checkNotNullParameter(injectable, "injectable");
        if (injectable instanceof LinkActivityViewModel.Factory) {
            this.$viewModelComponent.inject((LinkActivityViewModel.Factory) injectable);
