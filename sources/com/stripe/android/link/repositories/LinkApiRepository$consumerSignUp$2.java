...
@DebugMetadata(c = "com.stripe.android.link.repositories.LinkApiRepository$consumerSignUp$2", f = "LinkApiRepository.kt", i = {}, l = {65}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: LinkApiRepository.kt */
final class LinkApiRepository$consumerSignUp$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends ConsumerSession>>, Object> {
    ...
    LinkApiRepository$consumerSignUp$2(LinkApiRepository linkApiRepository, String str, String str2, String str3, String str4, Continuation<? super LinkApiRepository$consumerSignUp$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = access$getStripeRepository$p.consumerSignUp(str, str2, str3, str4, options, this);
        ...
        if (r1 == null) {
            ...
            if (result == null) {
                ...
                obj3 = Result.m4709constructorimpl(ResultKt.createFailure(new InternalError("Error signing up consumer")));
            } else {
                obj3 = result.m4718unboximpl();
            }
            return Result.m4708boximpl(obj3);
        }
        linkApiRepository2.logger.error("Error signing up consumer", r1);
