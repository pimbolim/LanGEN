...
@DebugMetadata(c = "com.stripe.android.link.repositories.LinkApiRepository$logout$2", f = "LinkApiRepository.kt", i = {}, l = {148}, m = "invokeSuspend", n = {}, s = {})
...
final class LinkApiRepository$logout$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends ConsumerSession>>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        LinkApiRepository$logout$2 linkApiRepository$logout$2 = new LinkApiRepository$logout$2(this.this$0, this.$consumerSessionClientSecret, this.$authSessionCookie, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = access$getStripeRepository$p.logoutConsumer(str, str2, options, this);
        ...
        if (r1 == null) {
            ...
            if (result == null) {
                ...
                obj3 = Result.m4709constructorimpl(ResultKt.createFailure(new InternalError("Error logging out")));
            } else {
                obj3 = result.m4718unboximpl();
            }
            return Result.m4708boximpl(obj3);
        }
        linkApiRepository2.logger.error("Error logging out", r1);
