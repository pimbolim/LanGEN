...
final class ComposableSingletons$VerificationScreenKt$lambda2$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public final void invoke(RowScope rowScope, Composer composer, int i) {
        ...
        if (((i & 81) ^ 16) != 0 || !composer.getSkipping()) {
            TextKt.m1189TextfLXpl1I(StringResources_androidKt.stringResource(R.string.verification_resend, composer2, 0), (Modifier) null, MaterialTheme.INSTANCE.getColors(composer2, 8).m911getOnPrimary0d7_KjU(), 0, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0, (TextDecoration) null, (TextAlign) null, 0, 0, false, 0, (Function1<? super TextLayoutResult, Unit>) null, MaterialTheme.INSTANCE.getTypography(composer2, 8).getButton(), composer, 0, 0, 32762);
            return;
        }
