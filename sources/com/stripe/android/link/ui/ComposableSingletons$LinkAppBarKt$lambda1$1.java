...
final class ComposableSingletons$LinkAppBarKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if (((i & 11) ^ 2) != 0 || !composer.getSkipping()) {
            LinkAppBarKt.LinkAppBar("email@example.com", AnonymousClass1.INSTANCE, composer, 54);
        } else {
