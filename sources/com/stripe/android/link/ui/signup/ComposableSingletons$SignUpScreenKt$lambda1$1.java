...
final class ComposableSingletons$SignUpScreenKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        if (((i & 11) ^ 2) != 0 || !composer.getSkipping()) {
            SignUpScreenKt.SignUpBody("Example, Inc.", EmailSpec.INSTANCE.transform("email"), SignUpState.InputtingPhone, AnonymousClass1.INSTANCE, composer, 3526);
        } else {
