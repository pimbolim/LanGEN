...
final class PaymentSessionPrefs$Default$prefs$2 extends Lambda implements Function0<SharedPreferences> {
    final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PaymentSessionPrefs$Default$prefs$2(Context context) {
        super(0);
