...
final class ChallengeActionHandler$Default$executeChallengeRequest$1 extends ContinuationImpl {
    ...
    ChallengeActionHandler$Default$executeChallengeRequest$1(ChallengeActionHandler.Default defaultR, Continuation<? super ChallengeActionHandler$Default$executeChallengeRequest$1> continuation) {
        super(continuation);
