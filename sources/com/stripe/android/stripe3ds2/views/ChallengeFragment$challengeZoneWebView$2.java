...
@Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u0004\u0018\u00010\u0001H\n¢\u0006\u0002\b\u0002"}, d2 = {"<anonymous>", "Lcom/stripe/android/stripe3ds2/views/ChallengeZoneWebView;", "invoke"}, k = 3, mv = {1, 6, 0}, xi = 48)
/* compiled from: ChallengeFragment.kt */
final class ChallengeFragment$challengeZoneWebView$2 extends Lambda implements Function0<ChallengeZoneWebView> {
    final /* synthetic */ ChallengeFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChallengeFragment$challengeZoneWebView$2(ChallengeFragment challengeFragment) {
        super(0);
    ...
    public final ChallengeZoneWebView invoke() {
        ...
        if (access$getCresData$p.getUiType() != UiType.Html) {
            return null;
        }
        ...
        return access$getChallengeEntryViewFactory.createChallengeEntryWebView(challengeResponseData);
    }
}
