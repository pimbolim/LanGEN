...
public class RNDeviceModule extends ReactContextBaseJavaModule {
    ...
    public String getUniqueIdSync() {
        return Settings.Secure.getString(getReactApplicationContext().getContentResolver(), b.f);
    }
    ...
    public WritableMap getPowerStateFromIntent(Intent intent) {
        ...
        String str = intExtra3 == 0 ? "unplugged" : intExtra4 == 2 ? "charging" : intExtra4 == 5 ? b.g : "unknown";
