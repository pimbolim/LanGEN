...
public class Base64 {
    ...
    public static final byte[] encode(byte[] bArr, int i) {
        ...
        while (i3 + 3 <= bArr.length) {
            int i6 = i3 + 1;
            int i7 = i6 + 1;
            int i8 = ((bArr[i3] & 255) << Tnaf.POW_2_WIDTH) | ((bArr[i6] & 255) << 8);
            int i9 = i7 + 1;
            ...
            int i13 = i12 + 1;
            bArr2[i12] = bArr3[(i10 & JSONParser.MODE_JSON_SIMPLE) >> 6];
            i4 = i13 + 1;
        ...
        if (bArr.length - i3 == 2) {
            int i14 = ((bArr[i3 + 1] & 255) << 8) | ((bArr[i3] & 255) << Tnaf.POW_2_WIDTH);
            int i15 = i4 + 1;
            byte[] bArr4 = base64;
            bArr2[i4] = bArr4[(i14 & 16515072) >> 18];
            int i16 = i15 + 1;
            bArr2[i15] = bArr4[(i14 & 258048) >> 12];
            bArr2[i16] = bArr4[(i14 & JSONParser.MODE_JSON_SIMPLE) >> 6];
            bArr2[i16 + 1] = 61;
        } else if (bArr.length - i3 == 1) {
            int i17 = (bArr[i3] & 255) << Tnaf.POW_2_WIDTH;
            int i18 = i4 + 1;
            byte[] bArr5 = base64;
