...
public class GestureHandler<ConcreteGestureHandlerT extends GestureHandler<ConcreteGestureHandlerT>> {
    ...
    public static final void m4694setEnabled$lambda3$lambda2(GestureHandler gestureHandler) {
    ...
    private final android.view.MotionEvent adaptEvent(android.view.MotionEvent r27) {
        ...
        L_0x00cc:
            ...
            goto L_0x012b
        L_0x00cf:
            long r5 = r27.getDownTime()     // Catch:{ IllegalArgumentException -> 0x0120 }
            long r16 = r27.getEventTime()     // Catch:{ IllegalArgumentException -> 0x0120 }
            android.view.MotionEvent$PointerProperties[] r0 = pointerProps     // Catch:{ IllegalArgumentException -> 0x0120 }
            if (r0 == 0) goto L_0x011c
            android.view.MotionEvent$PointerCoords[] r3 = pointerCoords     // Catch:{ IllegalArgumentException -> 0x0120 }
            if (r3 == 0) goto L_0x0118
            int r18 = r27.getMetaState()     // Catch:{ IllegalArgumentException -> 0x0120 }
            int r19 = r27.getButtonState()     // Catch:{ IllegalArgumentException -> 0x0120 }
            float r20 = r27.getXPrecision()     // Catch:{ IllegalArgumentException -> 0x0120 }
            float r21 = r27.getYPrecision()     // Catch:{ IllegalArgumentException -> 0x0120 }
            int r22 = r27.getDeviceId()     // Catch:{ IllegalArgumentException -> 0x0120 }
            int r23 = r27.getEdgeFlags()     // Catch:{ IllegalArgumentException -> 0x0120 }
            int r24 = r27.getSource()     // Catch:{ IllegalArgumentException -> 0x0120 }
            int r25 = r27.getFlags()     // Catch:{ IllegalArgumentException -> 0x0120 }
            r10 = r5
            r12 = r16
            r16 = r0
            r17 = r3
            android.view.MotionEvent r0 = android.view.MotionEvent.obtain(r10, r12, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25)     // Catch:{ IllegalArgumentException -> 0x0120 }
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r0, r3)     // Catch:{ IllegalArgumentException -> 0x0120 }
            float r3 = -r4
            float r4 = -r8
            ...
            return r0
        L_0x0118:
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r10)     // Catch:{ IllegalArgumentException -> 0x0120 }
            throw r12     // Catch:{ IllegalArgumentException -> 0x0120 }
        L_0x011c:
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r11)     // Catch:{ IllegalArgumentException -> 0x0120 }
            throw r12     // Catch:{ IllegalArgumentException -> 0x0120 }
        L_0x0120:
            r0 = move-exception
    ...
    public static final class AdaptEventException extends Exception {
        ...
        public AdaptEventException(GestureHandler<?> gestureHandler, MotionEvent motionEvent, IllegalArgumentException illegalArgumentException) {
            ...
            Intrinsics.checkNotNullParameter(motionEvent, "event");
            Intrinsics.checkNotNullParameter(illegalArgumentException, JWKParameterNames.RSA_EXPONENT);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x004f, code lost:
        if ((r7.getY() == r12.getY(r4)) == false) goto L_0x0051;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private final WritableMap createPointerData(PointerData pointerData) {
        ...
        createMap.putInt(MessageExtension.FIELD_ID, pointerData.getPointerId());
        createMap.putDouble("x", (double) PixelUtil.toDIPFromPixel(pointerData.getX()));
        createMap.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, (double) PixelUtil.toDIPFromPixel(pointerData.getY()));
    ...
    public final float getLastPositionInWindowX() {
        return this.lastAbsolutePositionX - ((float) this.windowOffset[0]);
    }

    public final float getLastPositionInWindowY() {
        return this.lastAbsolutePositionY - ((float) this.windowOffset[1]);
    }
        ...
        if (!(access$self.getView() == null || access$self.isEnabled() == z)) {
            UiThreadUtil.runOnUiThread(new Runnable() {
                public final void run() {
                    GestureHandler.m4694setEnabled$lambda3$lambda2(GestureHandler.this);
                }
            });
        }
