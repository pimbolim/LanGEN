...
public class DebugNode extends Node {
    ...
    public DebugNode(int i, ReadableMap readableMap, NodesManager nodesManager) {
        ...
        this.mMessage = MapUtils.getString(readableMap, GraphQLConstants.Keys.MESSAGE, "Reanimated: First argument passed to debug node is either of wrong type or is missing.");
