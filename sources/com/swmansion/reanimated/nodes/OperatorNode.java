...
public class OperatorNode extends Node {
    ...
    public OperatorNode(int i, ReadableMap readableMap, NodesManager nodesManager) {
        ...
        int[] processIntArray = Utils.processIntArray(readableMap.getArray(GraphQLConstants.Keys.INPUT));
        this.mInputIDs = processIntArray;
        this.mInputNodes = new Node[processIntArray.length];
        String string = readableMap.getString("op");
        if ("add".equals(string)) {
            this.mOperator = ADD;
        } else if (JWTClaimNames.SUBJECT.equals(string)) {
            this.mOperator = SUB;
            ...
            this.mOperator = ATAN;
        } else if (JWTClaimNames.EXPIRATION_TIME.equals(string)) {
            this.mOperator = EXP;
