...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void begin() {
        /*
            ...
            monitor-enter(r0)
            r4.assertNotCallingCallbacks()     // Catch:{ all -> 0x00b0 }
            com.bumptech.glide.util.pool.StateVerifier r1 = r4.stateVerifier     // Catch:{ all -> 0x00b0 }
            r1.throwIfRecycled()     // Catch:{ all -> 0x00b0 }
            long r1 = com.bumptech.glide.util.LogTime.getLogTime()     // Catch:{ all -> 0x00b0 }
            r4.startTime = r1     // Catch:{ all -> 0x00b0 }
            java.lang.Object r1 = r4.model     // Catch:{ all -> 0x00b0 }
            if (r1 != 0) goto L_0x003c
            int r1 = r4.overrideWidth     // Catch:{ all -> 0x00b0 }
            int r2 = r4.overrideHeight     // Catch:{ all -> 0x00b0 }
            boolean r1 = com.bumptech.glide.util.Util.isValidDimensions(r1, r2)     // Catch:{ all -> 0x00b0 }
            if (r1 == 0) goto L_0x0027
            int r1 = r4.overrideWidth     // Catch:{ all -> 0x00b0 }
            r4.width = r1     // Catch:{ all -> 0x00b0 }
            int r1 = r4.overrideHeight     // Catch:{ all -> 0x00b0 }
            r4.height = r1     // Catch:{ all -> 0x00b0 }
        L_0x0027:
            android.graphics.drawable.Drawable r1 = r4.getFallbackDrawable()     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0030:
            ...
            r4.onLoadFailed(r2, r1)     // Catch:{ all -> 0x00b0 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b0 }
            return
        L_0x003c:
            com.bumptech.glide.request.SingleRequest$Status r1 = r4.status     // Catch:{ all -> 0x00b0 }
            ...
            com.bumptech.glide.load.engine.Resource<R> r1 = r4.resource     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0052:
            ...
            goto L_0x006d
        L_0x0068:
            com.bumptech.glide.request.target.Target<R> r1 = r4.target     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0079:
            boolean r1 = r4.canNotifyStatusChanged()     // Catch:{ all -> 0x00b0 }
            if (r1 == 0) goto L_0x0088
            com.bumptech.glide.request.target.Target<R> r1 = r4.target     // Catch:{ all -> 0x00b0 }
            android.graphics.drawable.Drawable r2 = r4.getPlaceholderDrawable()     // Catch:{ all -> 0x00b0 }
            r1.onLoadStarted(r2)     // Catch:{ all -> 0x00b0 }
        L_0x0088:
            boolean r1 = IS_VERBOSE_LOGGABLE     // Catch:{ all -> 0x00b0 }
            ...
            long r2 = r4.startTime     // Catch:{ all -> 0x00b0 }
            double r2 = com.bumptech.glide.util.LogTime.getElapsedMillis(r2)     // Catch:{ all -> 0x00b0 }
            r1.append(r2)     // Catch:{ all -> 0x00b0 }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x00b0 }
            r4.logV(r1)     // Catch:{ all -> 0x00b0 }
        L_0x00a6:
            monitor-exit(r0)     // Catch:{ all -> 0x00b0 }
            return
        L_0x00a8:
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r6, com.bumptech.glide.load.DataSource r7, boolean r8) {
        /*
            ...
            r0.throwIfRecycled()
            r0 = 0
            java.lang.Object r1 = r5.requestLock     // Catch:{ all -> 0x00bc }
            monitor-enter(r1)     // Catch:{ all -> 0x00bc }
            r5.loadStatus = r0     // Catch:{ all -> 0x00b9 }
            ...
            java.lang.Class<R> r8 = r5.transcodeClass     // Catch:{ all -> 0x00b9 }
            r7.append(r8)     // Catch:{ all -> 0x00b9 }
        ...
        L_0x002f:
            ...
            java.lang.Class<R> r3 = r5.transcodeClass     // Catch:{ all -> 0x00b9 }
            java.lang.Class r4 = r2.getClass()     // Catch:{ all -> 0x00b9 }
            boolean r3 = r3.isAssignableFrom(r4)     // Catch:{ all -> 0x00b9 }
            if (r3 != 0) goto L_0x0042
            goto L_0x005c
        L_0x0042:
            boolean r3 = r5.canSetResource()     // Catch:{ all -> 0x00b9 }
            if (r3 != 0) goto L_0x0057
            r5.resource = r0     // Catch:{ all -> 0x00b5 }
            com.bumptech.glide.request.SingleRequest$Status r7 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00b5 }
            r5.status = r7     // Catch:{ all -> 0x00b5 }
        ...
        L_0x0056:
            return
        L_0x0057:
            r5.onResourceReady(r6, r2, r7, r8)     // Catch:{ all -> 0x00b9 }
            monitor-exit(r1)     // Catch:{ all -> 0x00b9 }
            return
        L_0x005c:
            r5.resource = r0     // Catch:{ all -> 0x00b5 }
            com.bumptech.glide.load.engine.GlideException r7 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00b5 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x00b5 }
            r8.<init>()     // Catch:{ all -> 0x00b5 }
            java.lang.String r0 = "Expected to receive an object of "
            r8.append(r0)     // Catch:{ all -> 0x00b5 }
            java.lang.Class<R> r0 = r5.transcodeClass     // Catch:{ all -> 0x00b5 }
            r8.append(r0)     // Catch:{ all -> 0x00b5 }
            java.lang.String r0 = " but instead got "
            r8.append(r0)     // Catch:{ all -> 0x00b5 }
            if (r2 == 0) goto L_0x007b
            java.lang.Class r0 = r2.getClass()     // Catch:{ all -> 0x00b5 }
            goto L_0x007d
        L_0x007b:
            java.lang.String r0 = ""
        L_0x007d:
            ...
            java.lang.String r0 = "{"
            r8.append(r0)     // Catch:{ all -> 0x00b5 }
            r8.append(r2)     // Catch:{ all -> 0x00b5 }
            java.lang.String r0 = "} inside Resource{"
            r8.append(r0)     // Catch:{ all -> 0x00b5 }
            r8.append(r6)     // Catch:{ all -> 0x00b5 }
            java.lang.String r0 = "}."
            r8.append(r0)     // Catch:{ all -> 0x00b5 }
        ...
        L_0x009f:
            r8.append(r0)     // Catch:{ all -> 0x00b5 }
            java.lang.String r8 = r8.toString()     // Catch:{ all -> 0x00b5 }
            r7.<init>(r8)     // Catch:{ all -> 0x00b5 }
            r5.onLoadFailed(r7)     // Catch:{ all -> 0x00b5 }
            monitor-exit(r1)     // Catch:{ all -> 0x00b5 }
    ...
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r10, R r11, com.bumptech.glide.load.DataSource r12, boolean r13) {
        ...
        L_0x006a:
            ...
            r6 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00b8 }
        ...
        L_0x0077:
            ...
            java.lang.Object r2 = r9.model     // Catch:{ all -> 0x00b8 }
            com.bumptech.glide.request.target.Target<R> r3 = r9.target     // Catch:{ all -> 0x00b8 }
            r1 = r11
            r4 = r12
            r5 = r13
        ...
        L_0x0090:
            r8 = 0
        L_0x0091:
            com.bumptech.glide.request.RequestListener<R> r0 = r9.targetListener     // Catch:{ all -> 0x00b8 }
        ...
        L_0x00a4:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r10 = r9.animationFactory     // Catch:{ all -> 0x00b8 }
            com.bumptech.glide.request.transition.Transition r10 = r10.build(r12, r13)     // Catch:{ all -> 0x00b8 }
            com.bumptech.glide.request.target.Target<R> r12 = r9.target     // Catch:{ all -> 0x00b8 }
            r12.onResourceReady(r11, r10)     // Catch:{ all -> 0x00b8 }
        L_0x00b2:
