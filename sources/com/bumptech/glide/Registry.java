...
public class Registry {
    ...
    private <Data, TResource, Transcode> List<DecodePath<Data, TResource, Transcode>> getDecodePaths(Class<Data> cls, Class<TResource> cls2, Class<Transcode> cls3) {
        ...
        for (Class next : this.decoderRegistry.getResourceClasses(cls, cls2)) {
            for (Class next2 : this.transcoderRegistry.getTranscodeClasses(next, cls3)) {
                arrayList.add(new DecodePath(cls, next, next2, this.decoderRegistry.getDecoders(cls, next), this.transcoderRegistry.get(next, next2), this.throwableListPool));
            }
        }
        return arrayList;
    }
