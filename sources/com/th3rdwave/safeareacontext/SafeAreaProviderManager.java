...
public class SafeAreaProviderManager extends ViewGroupManager<SafeAreaProvider> {
    ...
    private Map<String, Object> getInitialWindowMetrics() {
        ...
        return MapBuilder.of("insets", SerializationUtils.edgeInsetsToJavaMap(safeAreaInsets), TypedValues.AttributesType.S_FRAME, SerializationUtils.rectToJavaMap(frame));
    }
