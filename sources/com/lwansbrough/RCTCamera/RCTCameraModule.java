...
public class RCTCameraModule extends ReactContextBaseJavaModule implements MediaRecorder.OnInfoListener, MediaRecorder.OnErrorListener, LifecycleEventListener {
    ...
    public RCTCameraModule(ReactApplicationContext reactApplicationContext) {
        ...
        this._sensorOrientationChecker = new RCTSensorOrientationChecker(reactApplicationContext);
    ...
    public void capture(final ReadableMap readableMap, final Promise promise) {
        ...
        int i = readableMap.hasKey(ReactVideoView.EVENT_PROP_ORIENTATION) ? readableMap.getInt(ReactVideoView.EVENT_PROP_ORIENTATION) : RCTCamera.getInstance().getOrientation();
    ...
    public void captureWithOrientation(final ReadableMap readableMap, final Promise promise, int i) {
        ...
        } else if (readableMap.getInt(ModeProp.name) == 1) {
    ...
    /* access modifiers changed from: private */
    /* JADX WARNING: Code restructure failed: missing block: B:129:0x015a, code lost:
        return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void processImage(com.lwansbrough.RCTCamera.MutableImage r12, com.facebook.react.bridge.ReadableMap r13, com.facebook.react.bridge.Promise r14) {
        /*
            ...
            boolean r0 = r13.hasKey(r0)     // Catch:{ all -> 0x015b }
            r1 = 0
            r2 = 1
            if (r0 == 0) goto L_0x0015
            java.lang.String r0 = "fixOrientation"
            boolean r0 = r13.getBoolean(r0)     // Catch:{ all -> 0x015b }
            if (r0 == 0) goto L_0x0015
            r0 = 1
            goto L_0x0016
        L_0x0015:
        ...
        L_0x001c:
            ...
            r14.reject((java.lang.String) r3, (java.lang.Throwable) r0)     // Catch:{ all -> 0x015b }
        L_0x0022:
            int r0 = r12.getWidth()     // Catch:{ all -> 0x015b }
            double r3 = (double) r0     // Catch:{ all -> 0x015b }
            int r0 = r12.getHeight()     // Catch:{ all -> 0x015b }
            double r5 = (double) r0
            double r3 = r3 / r5
            r5 = 4607182418800017408(0x3ff0000000000000, double:1.0)
            java.lang.String r0 = "type"
            int r0 = r13.getInt(r0)     // Catch:{ IllegalArgumentException -> 0x005d }
            com.lwansbrough.RCTCamera.RCTCamera r7 = com.lwansbrough.RCTCamera.RCTCamera.getInstance()     // Catch:{ IllegalArgumentException -> 0x005d }
            int r7 = r7.getPreviewVisibleWidth(r0)     // Catch:{ IllegalArgumentException -> 0x005d }
            double r7 = (double) r7     // Catch:{ IllegalArgumentException -> 0x005d }
            com.lwansbrough.RCTCamera.RCTCamera r9 = com.lwansbrough.RCTCamera.RCTCamera.getInstance()     // Catch:{ IllegalArgumentException -> 0x005d }
            int r0 = r9.getPreviewVisibleHeight(r0)     // Catch:{ IllegalArgumentException -> 0x005d }
            double r9 = (double) r0
            double r7 = r7 / r9
        ...
        L_0x005e:
            ...
            boolean r7 = r13.hasKey(r7)     // Catch:{ all -> 0x015b }
            if (r7 == 0) goto L_0x0070
            java.lang.String r7 = "cropToPreview"
            boolean r7 = r13.getBoolean(r7)     // Catch:{ all -> 0x015b }
            if (r7 == 0) goto L_0x0070
            r7 = 1
            goto L_0x0071
        L_0x0070:
        ...
        L_0x007b:
            ...
            r14.reject((java.lang.String) r4, (java.lang.Throwable) r3)     // Catch:{ all -> 0x015b }
        L_0x0081:
            java.lang.String r3 = "mirrorImage"
            boolean r3 = r13.hasKey(r3)     // Catch:{ all -> 0x015b }
            if (r3 == 0) goto L_0x0092
            java.lang.String r3 = "mirrorImage"
            boolean r3 = r13.getBoolean(r3)     // Catch:{ all -> 0x015b }
            if (r3 == 0) goto L_0x0092
            r1 = 1
        L_0x0092:
        ...
        L_0x0098:
            ...
            r14.reject((java.lang.String) r3, (java.lang.Throwable) r1)     // Catch:{ all -> 0x015b }
        L_0x009e:
            r1 = 80
            ...
            int r1 = r13.getInt(r1)     // Catch:{ all -> 0x015b }
        L_0x00ae:
            if (r0 == 0) goto L_0x00b5
            int r3 = r12.getHeight()     // Catch:{ all -> 0x015b }
            goto L_0x00b9
        L_0x00b5:
            int r3 = r12.getWidth()     // Catch:{ all -> 0x015b }
        L_0x00b9:
            r6 = r3
        ...
        L_0x00c5:
            ...
            int r0 = r13.getInt(r0)     // Catch:{ all -> 0x015b }
            ...
            goto L_0x0159
        L_0x00d8:
            java.io.File r5 = r11.getTempMediaFile(r2)     // Catch:{ all -> 0x015b }
            if (r5 != 0) goto L_0x00e5
            java.lang.String r12 = "Error creating media file."
            r14.reject((java.lang.String) r12)     // Catch:{ all -> 0x015b }
            monitor-exit(r11)
            return
        L_0x00e5:
        ...
        L_0x00ef:
            ...
            r14.reject((java.lang.String) r13, (java.lang.Throwable) r12)     // Catch:{ all -> 0x015b }
            monitor-exit(r11)
            return
        L_0x00f7:
            java.io.File r5 = r11.getOutputCameraRollFile(r2)     // Catch:{ all -> 0x015b }
        ...
        L_0x0104:
            ...
            java.lang.String r12 = r5.getAbsolutePath()     // Catch:{ all -> 0x015b }
        ...
        L_0x0118:
            ...
            return
        L_0x011f:
            java.io.File r5 = r11.getOutputMediaFile(r2)     // Catch:{ all -> 0x015b }
        ...
        L_0x0136:
            ...
            return
        L_0x013e:
            java.lang.String r12 = r12.toBase64(r1)     // Catch:{ all -> 0x015b }
            com.facebook.react.bridge.WritableNativeMap r13 = new com.facebook.react.bridge.WritableNativeMap     // Catch:{ all -> 0x015b }
    ...
    private void resolveImage(File file, int i, int i2, final Promise promise, boolean z) {
        ...
        writableNativeMap.putString(ReactNativeBlobUtilConst.RNFB_RESPONSE_PATH, Uri.fromFile(file).toString());
