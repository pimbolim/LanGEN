...
public class LocalPayment {
    ...
    static void onActivityResult(final BraintreeFragment braintreeFragment, int i, Intent intent) {
        ...
        try {
            ...
            jSONObject.put(MetadataBuilder.META_KEY, new JSONObject().put("source", PaymentMethodOptionsParams.WeChatPay.PARAM_CLIENT).put("integration", braintreeFragment.getIntegrationType()).put("sessionId", braintreeFragment.getSessionId()));
