...
public class PostalAddressParser {
    ...
    public static PostalAddress fromJson(JSONObject jSONObject) {
        ...
        if (optString != null || Json.optString(jSONObject, "name", (String) null) == null) {
            return new PostalAddress().recipientName(Json.optString(jSONObject, RECIPIENT_NAME_KEY, (String) null)).streetAddress(optString).extendedAddress(optString2).locality(Json.optString(jSONObject, LOCALITY_KEY, (String) null)).region(Json.optString(jSONObject, REGION_KEY, (String) null)).postalCode(Json.optString(jSONObject, "postalCode", (String) null)).countryCodeAlpha2(optString3);
        }
    ...
    public static PostalAddress fromUserAddressJson(JSONObject jSONObject) {
        ...
        postalAddress.recipientName(Json.optString(jSONObject, "name", "")).phoneNumber(Json.optString(jSONObject, "phoneNumber", "")).streetAddress(Json.optString(jSONObject, USER_ADDRESS_ADDRESS_1_KEY, "")).extendedAddress(formatExtendedUserAddress(jSONObject)).locality(Json.optString(jSONObject, USER_ADDRESS_LOCALITY_KEY, "")).region(Json.optString(jSONObject, USER_ADDRESS_ADMINISTRATIVE_AREA_KEY, "")).countryCodeAlpha2(Json.optString(jSONObject, "countryCode", "")).postalCode(Json.optString(jSONObject, "postalCode", "")).sortingCode(Json.optString(jSONObject, USER_ADDRESS_SORTING_CODE_KEY, ""));
