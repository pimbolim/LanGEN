...
public class GooglePaymentRequest implements Parcelable {
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:23:0x00b3 */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:26:0x00d4 A[Catch:{ JSONException -> 0x00f3 }] */
    /* JADX WARNING: Removed duplicated region for block: B:33:0x0105 A[Catch:{ JSONException -> 0x0121 }] */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x0118 A[Catch:{ JSONException -> 0x0121 }] */
    /* JADX WARNING: Removed duplicated region for block: B:42:0x016b A[Catch:{ JSONException -> 0x0170 }] */
    ...
    public java.lang.String toJson() {
        ...
        L_0x0047:
            java.lang.String r6 = r12.totalPriceStatusToString()     // Catch:{ JSONException -> 0x0064 }
            java.lang.String r8 = "totalPriceStatus"
            org.json.JSONObject r6 = r2.put(r8, r6)     // Catch:{ JSONException -> 0x0064 }
            java.lang.String r8 = "totalPrice"
            java.lang.String r9 = r3.getTotalPrice()     // Catch:{ JSONException -> 0x0064 }
            org.json.JSONObject r6 = r6.put(r8, r9)     // Catch:{ JSONException -> 0x0064 }
            java.lang.String r8 = "currencyCode"
            java.lang.String r3 = r3.getCurrencyCode()     // Catch:{ JSONException -> 0x0064 }
            r6.put(r8, r3)     // Catch:{ JSONException -> 0x0064 }
        L_0x0064:
        ...
        L_0x006e:
            ...
            org.json.JSONObject r8 = new org.json.JSONObject     // Catch:{ JSONException -> 0x00f3 }
            r8.<init>()     // Catch:{ JSONException -> 0x00f3 }
            java.lang.String r9 = "type"
            java.lang.Object r10 = r6.getKey()     // Catch:{ JSONException -> 0x00f3 }
            org.json.JSONObject r8 = r8.put(r9, r10)     // Catch:{ JSONException -> 0x00f3 }
            java.lang.Object r9 = r6.getValue()     // Catch:{ JSONException -> 0x00f3 }
            org.json.JSONObject r8 = r8.put(r1, r9)     // Catch:{ JSONException -> 0x00f3 }
            java.lang.String r9 = "tokenizationSpecification"
            java.util.HashMap<java.lang.String, org.json.JSONObject> r10 = r12.mTokenizationSpecifications     // Catch:{ JSONException -> 0x00f3 }
            java.lang.Object r11 = r6.getKey()     // Catch:{ JSONException -> 0x00f3 }
            java.lang.Object r10 = r10.get(r11)     // Catch:{ JSONException -> 0x00f3 }
            org.json.JSONObject r8 = r8.put(r9, r10)     // Catch:{ JSONException -> 0x00f3 }
            java.lang.Object r9 = r6.getKey()     // Catch:{ JSONException -> 0x00f3 }
            java.lang.String r10 = "CARD"
            if (r9 != r10) goto L_0x00ee
            java.lang.Object r6 = r6.getValue()     // Catch:{ JSONException -> 0x00b3 }
            org.json.JSONObject r6 = (org.json.JSONObject) r6     // Catch:{ JSONException -> 0x00b3 }
            r6.get(r0)     // Catch:{ JSONException -> 0x00b3 }
            goto L_0x00ee
        L_0x00b3:
            org.json.JSONObject r6 = r8.getJSONObject(r1)     // Catch:{ JSONException -> 0x00f3 }
            java.lang.String r9 = "billingAddressRequired"
            java.lang.Boolean r10 = r12.isBillingAddressRequired()     // Catch:{ JSONException -> 0x00f3 }
            org.json.JSONObject r9 = r6.put(r9, r10)     // Catch:{ JSONException -> 0x00f3 }
            java.lang.String r10 = "allowPrepaidCards"
            java.lang.Boolean r11 = r12.getAllowPrepaidCards()     // Catch:{ JSONException -> 0x00f3 }
            r9.put(r10, r11)     // Catch:{ JSONException -> 0x00f3 }
            java.lang.Boolean r9 = r12.isBillingAddressRequired()     // Catch:{ JSONException -> 0x00f3 }
            boolean r9 = r9.booleanValue()     // Catch:{ JSONException -> 0x00f3 }
            if (r9 == 0) goto L_0x00ee
            org.json.JSONObject r9 = new org.json.JSONObject     // Catch:{ JSONException -> 0x00f3 }
            r9.<init>()     // Catch:{ JSONException -> 0x00f3 }
            java.lang.String r10 = "format"
            java.lang.String r11 = r12.billingAddressFormatToString()     // Catch:{ JSONException -> 0x00f3 }
            org.json.JSONObject r9 = r9.put(r10, r11)     // Catch:{ JSONException -> 0x00f3 }
            java.lang.Boolean r10 = r12.isPhoneNumberRequired()     // Catch:{ JSONException -> 0x00f3 }
            org.json.JSONObject r9 = r9.put(r7, r10)     // Catch:{ JSONException -> 0x00f3 }
            r6.put(r0, r9)     // Catch:{ JSONException -> 0x00f3 }
        L_0x00ee:
            r4.put(r8)     // Catch:{ JSONException -> 0x00f3 }
            goto L_0x006e
        L_0x00f3:
            goto L_0x006e
        L_0x00f6:
            ...
            r0.<init>()
            java.lang.String r1 = r12.getGoogleMerchantId()     // Catch:{ JSONException -> 0x0121 }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ JSONException -> 0x0121 }
            if (r1 != 0) goto L_0x010e
            java.lang.String r1 = "merchantId"
            java.lang.String r3 = r12.getGoogleMerchantId()     // Catch:{ JSONException -> 0x0121 }
            r0.put(r1, r3)     // Catch:{ JSONException -> 0x0121 }
        L_0x010e:
            java.lang.String r1 = r12.getGoogleMerchantName()     // Catch:{ JSONException -> 0x0121 }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ JSONException -> 0x0121 }
            if (r1 != 0) goto L_0x0121
            java.lang.String r1 = "merchantName"
            java.lang.String r3 = r12.getGoogleMerchantName()     // Catch:{ JSONException -> 0x0121 }
            r0.put(r1, r3)     // Catch:{ JSONException -> 0x0121 }
        L_0x0121:
            ...
            r6 = 2
            org.json.JSONObject r3 = r1.put(r3, r6)     // Catch:{ JSONException -> 0x0170 }
            java.lang.String r6 = "apiVersionMinor"
            r7 = 0
            org.json.JSONObject r3 = r3.put(r6, r7)     // Catch:{ JSONException -> 0x0170 }
            java.lang.String r6 = "allowedPaymentMethods"
            org.json.JSONObject r3 = r3.put(r6, r4)     // Catch:{ JSONException -> 0x0170 }
            java.lang.String r4 = "emailRequired"
            java.lang.Boolean r6 = r12.isEmailRequired()     // Catch:{ JSONException -> 0x0170 }
            org.json.JSONObject r3 = r3.put(r4, r6)     // Catch:{ JSONException -> 0x0170 }
            java.lang.String r4 = "shippingAddressRequired"
            java.lang.Boolean r6 = r12.isShippingAddressRequired()     // Catch:{ JSONException -> 0x0170 }
            org.json.JSONObject r3 = r3.put(r4, r6)     // Catch:{ JSONException -> 0x0170 }
            java.lang.String r4 = "environment"
            java.lang.String r6 = r12.mEnvironment     // Catch:{ JSONException -> 0x0170 }
            org.json.JSONObject r3 = r3.put(r4, r6)     // Catch:{ JSONException -> 0x0170 }
            java.lang.String r4 = "merchantInfo"
            org.json.JSONObject r0 = r3.put(r4, r0)     // Catch:{ JSONException -> 0x0170 }
            java.lang.String r3 = "transactionInfo"
            r0.put(r3, r2)     // Catch:{ JSONException -> 0x0170 }
            java.lang.Boolean r0 = r12.isShippingAddressRequired()     // Catch:{ JSONException -> 0x0170 }
            boolean r0 = r0.booleanValue()     // Catch:{ JSONException -> 0x0170 }
            if (r0 == 0) goto L_0x0170
            java.lang.String r0 = "shippingAddressParameters"
            r1.put(r0, r5)     // Catch:{ JSONException -> 0x0170 }
        L_0x0170:
