...
public class ThreeDSecure {
    ...
    public static void prepareLookup(final BraintreeFragment braintreeFragment, final ThreeDSecureRequest threeDSecureRequest, final ThreeDSecurePrepareLookupListener threeDSecurePrepareLookupListener) {
        ...
        try {
            jSONObject.put("authorizationFingerprint", braintreeFragment.getAuthorization().getBearer()).put("braintreeLibraryVersion", "Android-3.14.1").put("nonce", threeDSecureRequest.getNonce()).put("clientMetadata", new JSONObject().put("requestedThreeDSecureVersion", "2").put("sdkVersion", "3.14.1"));
    ...
    public static void configureCardinal(BraintreeFragment braintreeFragment, Configuration configuration, ThreeDSecureRequest threeDSecureRequest) {
        ...
        cardinalConfigurationParameters.setTimeout(PhotoshopDirectory.TAG_LIGHTROOM_WORKFLOW);
        ...
        if (i == -1) {
            ...
            if (data != null) {
                ...
                if (fromJson.isSuccess()) {
                    ...
                    braintreeFragment.postCallback((Exception) new ErrorWithResponse(TypedValues.CycleType.TYPE_CUSTOM_WAVE_SHAPE, queryParameter));
                }
            } else {
