    ...
    public boolean setupFillPaint(Paint paint, float f) {
        ...
        if (i2 != 0) {
            if (i2 != 1) {
                ...
                paint2.setShader(new LinearGradient(f2, f3, f4, f5, iArr, fArr, Shader.TileMode.CLAMP));
            }
            return true;
        }
        paint2.setARGB((int) (fArr3.length > 4 ? fArr3[4] * f * 255.0f : f * 255.0f), (int) (fArr3[1] * 255.0f), (int) (fArr3[2] * 255.0f), (int) (fArr3[3] * 255.0f));
        return true;
    }
