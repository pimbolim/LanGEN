...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public void setColor(ReactEditText reactEditText, Integer num) {
        if (num == null) {
            ...
            sb.append(context != null ? context.getClass().getCanonicalName() : AbstractJsonLexerKt.NULL);
    ...
    public void setTextContentType(ReactEditText reactEditText, String str) {
        ...
        } else if (HintConstants.AUTOFILL_HINT_USERNAME.equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_USERNAME);
        } else if (HintConstants.AUTOFILL_HINT_PASSWORD.equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_PASSWORD);
        } else if ("email".equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_EMAIL_ADDRESS);
        } else if ("name".equals(str)) {
            setAutofillHints(reactEditText, "name");
        } else if ("tel".equals(str)) {
            setAutofillHints(reactEditText, "phone");
        } else if ("street-address".equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_POSTAL_ADDRESS);
        } else if ("postal-code".equals(str)) {
            setAutofillHints(reactEditText, "postalCode");
        } else if ("cc-number".equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_CREDIT_CARD_NUMBER);
        } else if ("cc-csc".equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_CREDIT_CARD_SECURITY_CODE);
        } else if ("cc-exp".equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_CREDIT_CARD_EXPIRATION_DATE);
        } else if ("cc-exp-month".equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_CREDIT_CARD_EXPIRATION_MONTH);
        } else if ("cc-exp-year".equals(str)) {
            setAutofillHints(reactEditText, HintConstants.AUTOFILL_HINT_CREDIT_CARD_EXPIRATION_YEAR);
                ...
                if (i7 != 0 || i6 != 0) {
                    ...
                    if (i7 != i6 || !substring.equals(substring2)) {
                        ...
                        if (javaOnlyMap != null && javaOnlyMap.hasKey("fragments")) {
                            ...
                            String string = javaOnlyMap.getString(TypedValues.Custom.S_STRING);
                            StringBuilder sb = new StringBuilder();
                            sb.append(string.substring(0, i5));
                            sb.append(charSequence2);
                            String str3 = "";
                            sb.append(string.length() > i9 ? string.substring(i9) : str3);
                            javaOnlyMap.putString(TypedValues.Custom.S_STRING, sb.toString());
                            ...
                            while (i10 < javaOnlyArray.size() && !z) {
                                ...
                                String string2 = javaOnlyMap2.getString(TypedValues.Custom.S_STRING);
                                ...
                                if (length < i5) {
                                    ...
                                    javaOnlyMap2.putString(TypedValues.Custom.S_STRING, sb2.toString());
                                    if (length2 < i6) {
                                        i5 += length2;
                                        i6 -= length2;
                                        charSequence2 = str2;
                        ...
                        if (!(this.mEditText.mStateWrapper == null || javaOnlyMap == null)) {
                            ...
                            for (int i13 = 0; i13 < javaOnlyMap.getArray("fragments").size(); i13++) {
                                ...
                                writableNativeMap3.putString(TypedValues.Custom.S_STRING, map.getString(TypedValues.Custom.S_STRING));
                                writableNativeArray.pushMap(writableNativeMap3);
                            }
                            writableNativeMap2.putString(TypedValues.Custom.S_STRING, javaOnlyMap.getString(TypedValues.Custom.S_STRING));
    ...
    public Object updateState(ReactEditText reactEditText, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper) {
        ...
        if (!state.getBoolean("hasThemeData")) {
            ...
            if (reactContext instanceof ThemedReactContext) {
                ...
                sb.append(reactContext != null ? reactContext.getClass().getName() : AbstractJsonLexerKt.NULL);
                ReactSoftException.logSoftException(str, new IllegalStateException(sb.toString()));
            }
        }
