...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    private WritableMap serializeEventData() {
        ...
        createMap2.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, (double) PixelUtil.toDIPFromPixel((float) this.mScrollY));
        ...
        createMap5.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, this.mYVelocity);
