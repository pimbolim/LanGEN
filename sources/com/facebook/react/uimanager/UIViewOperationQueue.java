...
public class UIViewOperationQueue {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x003f, code lost:
        ...
        com.facebook.systrace.Systrace.beginAsyncSection(0, "batchedExecutionTime", 0, androidx.compose.animation.core.AnimationKt.MillisToNanos * r2);
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:?, code lost:
            ...
            r1.execute();
            r0 = r8.this$0;
            com.facebook.react.uimanager.UIViewOperationQueue.access$2902(r0, com.facebook.react.uimanager.UIViewOperationQueue.access$2900(r0) + (android.os.SystemClock.uptimeMillis() - r2));
         */
        ...
        private void dispatchPendingNonBatchedOperations(long r9) {
            ...
            L_0x0014:
                ...
                monitor-enter(r0)
                com.facebook.react.uimanager.UIViewOperationQueue r1 = com.facebook.react.uimanager.UIViewOperationQueue.this     // Catch:{ all -> 0x0055 }
                java.util.ArrayDeque r1 = r1.mNonBatchedOperations     // Catch:{ all -> 0x0055 }
            ...
            L_0x0029:
                ...
                com.facebook.react.uimanager.UIViewOperationQueue$UIOperation r1 = (com.facebook.react.uimanager.UIViewOperationQueue.UIOperation) r1     // Catch:{ all -> 0x0055 }
                monitor-exit(r0)     // Catch:{ all -> 0x0055 }
                long r2 = android.os.SystemClock.uptimeMillis()     // Catch:{ Exception -> 0x004d }
                r1.execute()     // Catch:{ Exception -> 0x004d }
                com.facebook.react.uimanager.UIViewOperationQueue r0 = com.facebook.react.uimanager.UIViewOperationQueue.this     // Catch:{ Exception -> 0x004d }
                long r4 = r0.mNonBatchedExecutionTotalTime     // Catch:{ Exception -> 0x004d }
                long r6 = android.os.SystemClock.uptimeMillis()     // Catch:{ Exception -> 0x004d }
                long r6 = r6 - r2
                long r4 = r4 + r6
                long unused = r0.mNonBatchedExecutionTotalTime = r4     // Catch:{ Exception -> 0x004d }
                goto L_0x0000
            L_0x004d:
                r9 = move-exception
