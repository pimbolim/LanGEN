...
public class UIImplementation {
    ...
    public void manageChildren(int i, ReadableArray readableArray, ReadableArray readableArray2, ReadableArray readableArray3, ReadableArray readableArray4, ReadableArray readableArray5) {
        ...
        synchronized (this.uiImplementationThreadLock) {
            try {
                ...
                while (i17 >= 0) {
                    if (iArr[i17] != i18) {
                        reactShadowNode3.removeChildAt(iArr[i17]);
                        i18 = iArr[i17];
                        i17--;
                    } else {
                ...
                while (true) {
                    ...
                    if (i19 < i20) {
                        ...
                        for (int i21 = 0; i21 < i4; i21++) {
                            removeShadowNode(this.mShadowNodeRegistry.getNode(iArr4[i21]));
                        }
                        return;
                    }
                }
    ...
    public void updateViewHierarchy() {
        ...
        L_0x000a:
            ...
            com.facebook.react.uimanager.ShadowNodeRegistry r4 = r7.mShadowNodeRegistry     // Catch:{ all -> 0x0077 }
            int r4 = r4.getRootTag(r3)     // Catch:{ all -> 0x0077 }
            ...
            com.facebook.systrace.SystraceMessage$Builder r5 = com.facebook.systrace.SystraceMessage.beginSection(r1, r5)     // Catch:{ all -> 0x0077 }
            ...
            com.facebook.systrace.Systrace.endSection(r1)     // Catch:{ all -> 0x0077 }
