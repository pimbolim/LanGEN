...
public class JavaTimerManager {
    ...
    private class IdleCallbackRunnable implements Runnable {
        ...
        public void run() {
            boolean access$1400;
            if (!this.mCancelled) {
                long uptimeMillis = SystemClock.uptimeMillis() - (this.mFrameStartTime / AnimationKt.MillisToNanos);
    ...
    public void createTimer(int i, long j, boolean z) {
        Timer timer = new Timer(i, (SystemClock.nanoTime() / AnimationKt.MillisToNanos) + j, (int) j, z);
