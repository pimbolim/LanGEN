...
public class TimePickerDialogFragment extends DialogFragment {
    ...
    static Dialog createDialog(Bundle bundle, Context context, TimePickerDialog.OnTimeSetListener onTimeSetListener) {
        ...
        if (!(bundle2 == null || bundle.getString(ModeProp.name, (String) null) == null)) {
            timePickerMode = TimePickerMode.valueOf(bundle.getString(ModeProp.name).toUpperCase(Locale.US));
        }
        if (bundle2 != null) {
