...
public class CameraRollManager extends NativeCameraRollManagerSpec {
    ...
    private static class GetMediaTask extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            Cursor query;
            StringBuilder sb = new StringBuilder(ThreeDSecureRequest.VERSION_1);
    ...
    private static boolean putImageInfo(ContentResolver contentResolver, Cursor cursor, WritableMap writableMap, int i, int i2, int i3, int i4, int i5) {
        ...
        if (string != null && string.startsWith("video")) {
            try {
                openAssetFileDescriptor = contentResolver.openAssetFileDescriptor(parse, JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR);
        ...
        if (f <= 0.0f || f2 <= 0.0f) {
            try {
                AssetFileDescriptor openAssetFileDescriptor2 = contentResolver.openAssetFileDescriptor(parse, JWKParameterNames.RSA_OTHER_PRIMES__PRIME_FACTOR);
