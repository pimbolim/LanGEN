...
public class DatePickerDialogFragment extends DialogFragment {
    ...
    static Dialog createDialog(Bundle bundle, Context context, DatePickerDialog.OnDateSetListener onDateSetListener) {
        ...
        if (bundle != null && bundle.containsKey(DateProp.name)) {
            instance.setTimeInMillis(bundle.getLong(DateProp.name));
        }
        ...
        if (!(bundle == null || bundle.getString(ModeProp.name, (String) null) == null)) {
            datePickerMode = DatePickerMode.valueOf(bundle.getString(ModeProp.name).toUpperCase(Locale.US));
        }
