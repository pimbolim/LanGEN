...
public class PipelineDraweeController extends AbstractDraweeController<CloseableReference<CloseableImage>, ImageInfo> {
    ...
    public synchronized com.facebook.imagepipeline.listener.RequestListener getRequestListener() {
        /*
            ...
            monitor-enter(r3)
            r0 = 0
            com.facebook.drawee.backends.pipeline.info.ImageOriginListener r1 = r3.mImageOriginListener     // Catch:{ all -> 0x0023 }
            if (r1 == 0) goto L_0x0011
            com.facebook.drawee.backends.pipeline.info.ImageOriginRequestListener r0 = new com.facebook.drawee.backends.pipeline.info.ImageOriginRequestListener     // Catch:{ all -> 0x0023 }
            java.lang.String r1 = r3.getId()     // Catch:{ all -> 0x0023 }
            com.facebook.drawee.backends.pipeline.info.ImageOriginListener r2 = r3.mImageOriginListener     // Catch:{ all -> 0x0023 }
            r0.<init>(r1, r2)     // Catch:{ all -> 0x0023 }
        L_0x0011:
            java.util.Set<com.facebook.imagepipeline.listener.RequestListener> r1 = r3.mRequestListeners     // Catch:{ all -> 0x0023 }
            if (r1 == 0) goto L_0x0021
            com.facebook.imagepipeline.listener.ForwardingRequestListener r2 = new com.facebook.imagepipeline.listener.ForwardingRequestListener     // Catch:{ all -> 0x0023 }
            r2.<init>((java.util.Set<com.facebook.imagepipeline.listener.RequestListener>) r1)     // Catch:{ all -> 0x0023 }
            if (r0 == 0) goto L_0x001f
            r2.addRequestListener(r0)     // Catch:{ all -> 0x0023 }
        L_0x001f:
            monitor-exit(r3)
            return r2
        L_0x0021:
