    ...
    public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
        if (this.filePathCallback != null || this.filePathCallbackLegacy != null) {
            ...
            if (i != 1) {
                if (i == 3) {
                    if (i2 != -1) {
                        this.filePathCallbackLegacy.onReceiveValue((Object) null);
                    } else if (z) {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$reactnativecommunity$webview$RNCWebViewModule$MimeType = r0
            ...
            L_0x0012:
                int[] r0 = $SwitchMap$com$reactnativecommunity$webview$RNCWebViewModule$MimeType     // Catch:{ NoSuchFieldError -> 0x001d }
