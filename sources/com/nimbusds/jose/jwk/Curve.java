...
public final class Curve implements Serializable {
    public static final Curve Ed25519 = new Curve(EdDSAParameterSpec.Ed25519, EdDSAParameterSpec.Ed25519, (String) null);
    public static final Curve Ed448 = new Curve(EdDSAParameterSpec.Ed448, EdDSAParameterSpec.Ed448, (String) null);
    ...
    public static final Curve X25519 = new Curve(XDHParameterSpec.X25519, XDHParameterSpec.X25519, (String) null);
    public static final Curve X448 = new Curve(XDHParameterSpec.X448, XDHParameterSpec.X448, (String) null);
