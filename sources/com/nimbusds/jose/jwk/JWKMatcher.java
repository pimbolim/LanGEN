...
public class JWKMatcher {
    ...
    public static class Builder {
        ...
        public Builder keyTypes(KeyType... keyTypeArr) {
            keyTypes((Set<KeyType>) new LinkedHashSet(Arrays.asList(keyTypeArr)));
            return this;
        }
        ...
        public Builder keyUses(KeyUse... keyUseArr) {
            keyUses((Set<KeyUse>) new LinkedHashSet(Arrays.asList(keyUseArr)));
            return this;
        }
        ...
        public Builder keyOperations(KeyOperation... keyOperationArr) {
            keyOperations((Set<KeyOperation>) new LinkedHashSet(Arrays.asList(keyOperationArr)));
            return this;
        }
        ...
        public Builder algorithms(Algorithm... algorithmArr) {
            algorithms((Set<Algorithm>) new LinkedHashSet(Arrays.asList(algorithmArr)));
            return this;
        }
        ...
        public Builder keyIDs(String... strArr) {
            keyIDs((Set<String>) new LinkedHashSet(Arrays.asList(strArr)));
            return this;
        }
        ...
        public Builder keySizes(int... iArr) {
            ...
            keySizes((Set<Integer>) linkedHashSet);
            return this;
        }
        ...
        public Builder curves(Curve... curveArr) {
            curves((Set<Curve>) new LinkedHashSet(Arrays.asList(curveArr)));
            return this;
        }
        ...
        public Builder x509CertSHA256Thumbprints(Base64URL... base64URLArr) {
            return x509CertSHA256Thumbprints((Set<Base64URL>) new LinkedHashSet(Arrays.asList(base64URLArr)));
        }
    ...
    public JWKMatcher(Set<KeyType> set, Set<KeyUse> set2, Set<KeyOperation> set3, Set<Algorithm> set4, Set<String> set5, boolean z, boolean z2, int i, int i2) {
        this(set, set2, set3, set4, set5, z, z2, i, i2, (Set<Curve>) null);
    }
    ...
    public JWKMatcher(Set<KeyType> set, Set<KeyUse> set2, Set<KeyOperation> set3, Set<Algorithm> set4, Set<String> set5, boolean z, boolean z2, int i, int i2, Set<Curve> set6) {
        this(set, set2, set3, set4, set5, z, z2, i, i2, (Set<Integer>) null, set6);
    }
    ...
    public JWKMatcher(Set<KeyType> set, Set<KeyUse> set2, Set<KeyOperation> set3, Set<Algorithm> set4, Set<String> set5, boolean z, boolean z2, boolean z3, boolean z4, int i, int i2, Set<Integer> set6, Set<Curve> set7) {
        this(set, set2, set3, set4, set5, z, z2, z3, z4, i, i2, set6, set7, (Set<Base64URL>) null);
    }
    ...
    public boolean matches(JWK jwk) {
        ...
        if (set3 != null && ((!set3.contains((Object) null) || jwk.getKeyOperations() != null) && (jwk.getKeyOperations() == null || !this.ops.containsAll(jwk.getKeyOperations())))) {
            return false;
        }
