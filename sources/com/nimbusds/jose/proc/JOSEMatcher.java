...
public class JOSEMatcher {
    ...
    public static class Builder {
        ...
        public Builder joseClasses(Class<? extends JOSEObject>... clsArr) {
            joseClasses((Set<Class<? extends JOSEObject>>) new HashSet(Arrays.asList(clsArr)));
            return this;
        }
        ...
        public Builder algorithms(Algorithm... algorithmArr) {
            algorithms((Set<Algorithm>) new HashSet(Arrays.asList(algorithmArr)));
            return this;
        }
        ...
        public Builder encryptionMethods(EncryptionMethod... encryptionMethodArr) {
            encryptionMethods((Set<EncryptionMethod>) new HashSet(Arrays.asList(encryptionMethodArr)));
            return this;
        }
        ...
        public Builder jwkURLs(URI... uriArr) {
            jwkURLs((Set<URI>) new HashSet(Arrays.asList(uriArr)));
            return this;
        }
        ...
        public Builder keyIDs(String... strArr) {
            keyIDs((Set<String>) new HashSet(Arrays.asList(strArr)));
            return this;
        }
