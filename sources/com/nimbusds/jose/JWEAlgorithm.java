...
public final class JWEAlgorithm extends Algorithm {
    ...
    public static final class Family extends AlgorithmFamily<JWEAlgorithm> {
        ...
        public static final Family ECDH_1PU = new Family(JWEAlgorithm.ECDH_1PU, JWEAlgorithm.ECDH_1PU_A128KW, JWEAlgorithm.ECDH_1PU_A192KW, JWEAlgorithm.ECDH_1PU_A256KW);
    ...
    public static JWEAlgorithm parse(String str) {
        ...
        if (str.equals(jWEAlgorithm23.getName())) {
            return jWEAlgorithm23;
        }
