...
public class AESCBC {
    ...
    public static AuthenticatedCipherText encryptWithConcatKDF(JWEHeader jWEHeader, SecretKey secretKey, Base64URL base64URL, byte[] bArr, byte[] bArr2, Provider provider, Provider provider2) throws JOSEException {
        ...
        return new AuthenticatedCipherText(encrypt, HMAC.compute(generateCIK, (jWEHeader.toBase64URL() + "." + base64URL + "." + Base64URL.encode(bArr) + "." + Base64URL.encode(encrypt)).getBytes(StandardCharset.UTF_8), provider2));
    }
