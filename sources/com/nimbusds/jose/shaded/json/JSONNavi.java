...
public class JSONNavi<T> {
    ...
    public static JSONNavi<JSONObject> newInstanceObject() {
        JSONNavi<JSONObject> jSONNavi = new JSONNavi<>(JSONValue.defaultReader.getMapper(JSONObject.class));
        jSONNavi.object();
        return jSONNavi;
    }

    public static JSONNavi<JSONArray> newInstanceArray() {
        JSONNavi<JSONArray> jSONNavi = new JSONNavi<>(JSONValue.defaultReader.getMapper(JSONArray.class));
        jSONNavi.array();
        return jSONNavi;
    }
    ...
    public JSONNavi(String str, JsonReaderI<T> jsonReaderI) {
        T parse = JSONValue.parse(str, jsonReaderI);
        this.root = parse;
        this.mapper = jsonReaderI;
        this.current = parse;
        this.readonly = true;
    ...
    public JSONNavi(String str, Class<T> cls) {
        this.root = JSONValue.parse(str, cls);
        this.mapper = JSONValue.defaultReader.getMapper(cls);
    ...
    public JSONNavi<T> set(String str, long j) {
        return set(str, (Number) Long.valueOf(j));
    }

    public JSONNavi<T> set(String str, int i) {
        return set(str, (Number) Integer.valueOf(i));
    }

    public JSONNavi<T> set(String str, double d) {
        return set(str, (Number) Double.valueOf(d));
    }

    public JSONNavi<T> set(String str, float f) {
        return set(str, (Number) Float.valueOf(f));
    }
    ...
    public JSONNavi<T> object() {
        ...
        if (this.current == null && this.readonly) {
            failure("Can not create Object child in readonly", (Object) null);
        }
        if (this.current == null) {
            ...
            if (isArray()) {
                failure("can not use Object feature on Array.", (Object) null);
            }
            failure("Can not use current position as Object", (Object) null);
        }
        if (this.root == null) {
    ...
    public JSONNavi<T> array() {
        ...
        if (this.current == null && this.readonly) {
            failure("Can not create Array child in readonly", (Object) null);
        }
        if (this.current == null) {
    ...
    public JSONNavi<?> atNext() {
        ...
        Object obj = this.current;
        if (!(obj instanceof List)) {
            return failure("current node is not an Array", (Object) null);
        }
