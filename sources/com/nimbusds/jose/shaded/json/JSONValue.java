...
public class JSONValue {
    ...
    public static <T> T parse(InputStream inputStream, Class<T> cls) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(inputStream, defaultReader.getMapper(cls));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static <T> T parse(byte[] bArr, Class<T> cls) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(bArr, defaultReader.getMapper(cls));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static <T> T parse(Reader reader, Class<T> cls) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(reader, defaultReader.getMapper(cls));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static <T> T parse(Reader reader, T t) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(reader, new UpdaterMapper(defaultReader, t));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    protected static <T> T parse(Reader reader, JsonReaderI<T> jsonReaderI) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(reader, jsonReaderI);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static <T> T parse(String str, Class<T> cls) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(str, defaultReader.getMapper(cls));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static <T> T parse(InputStream inputStream, T t) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(inputStream, new UpdaterMapper(defaultReader, t));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static <T> T parse(String str, T t) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(str, new UpdaterMapper(defaultReader, t));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    protected static <T> T parse(byte[] bArr, JsonReaderI<T> jsonReaderI) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(bArr, jsonReaderI);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    protected static <T> T parse(String str, JsonReaderI<T> jsonReaderI) {
        try {
            return new JSONParser(JSONParser.DEFAULT_PERMISSIVE_MODE).parse(str, jsonReaderI);
        } catch (Exception unused) {
            return null;
        }
    }
