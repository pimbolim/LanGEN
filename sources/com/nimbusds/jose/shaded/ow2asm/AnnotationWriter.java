...
final class AnnotationWriter extends AnnotationVisitor {
    ...
    static AnnotationWriter create(SymbolTable symbolTable2, int i, TypePath typePath, String str, AnnotationWriter annotationWriter) {
        ByteVector byteVector = new ByteVector();
    ...
    static int computeAnnotationsSize(AnnotationWriter annotationWriter, AnnotationWriter annotationWriter2, AnnotationWriter annotationWriter3, AnnotationWriter annotationWriter4) {
        int i = 0;
        if (annotationWriter != null) {
            i = 0 + annotationWriter.computeAnnotationsSize("RuntimeVisibleAnnotations");
        }
        ...
        return annotationWriter4 != null ? i + annotationWriter4.computeAnnotationsSize("RuntimeInvisibleTypeAnnotations") : i;
    }
