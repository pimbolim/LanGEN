...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, 289, 97, 352, 49, 304, 112, 37, OlympusRawInfoMakernoteDirectory.TagWbRbLevelsEveningSunlight, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, ExifDirectoryBase.TAG_TILE_WIDTH, 19, 274, 82, 7, 262, 70, 22, 385, Opcodes.INSTANCEOF, 448, 145, StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB, 208, 133, 388, 196, 168, 162, 138, 42};
            ...
            if (charAt == '+' || charAt == '$' || charAt == '%' || charAt == '/') {
                ...
                if (charAt != '$') {
                    if (charAt != '%') {
                        ...
                        i = charAt2 + SignatureVisitor.EXTENDS;
                    } else if (charAt2 != 'U') {
                        if (charAt2 == 'V') {
                            c = '@';
                        } else if (charAt2 == 'W') {
