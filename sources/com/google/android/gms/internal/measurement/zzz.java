...
public class zzz {
    ...
    public final List<Bundle> getConditionalUserProperties(String str, String str2) {
        ...
        List<Bundle> list = (List) zzl.zza(zzl.zzb((long) CoroutineLiveDataKt.DEFAULT_TIMEOUT), List.class);
    ...
    public final Map<String, Object> getUserProperties(String str, String str2, boolean z) {
        ...
        Bundle zzb2 = zzl.zzb((long) CoroutineLiveDataKt.DEFAULT_TIMEOUT);
    ...
    public final Bundle zza(Bundle bundle, boolean z) {
        ...
        if (z) {
            return zzl.zzb((long) CoroutineLiveDataKt.DEFAULT_TIMEOUT);
        }
        return null;
    }
