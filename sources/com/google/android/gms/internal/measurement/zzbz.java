...
public class zzbz {
    ...
    private static void zza(ContentResolver contentResolver) {
        if (zzzz == null) {
            ...
            zzaae = new Object();
            zzaaf = false;
            contentResolver.registerContentObserver(CONTENT_URI, true, new zzby((Handler) null));
    ...
    public static java.lang.String zza(android.content.ContentResolver r13, java.lang.String r14, java.lang.String r15) {
        /*
            ...
            java.lang.Object r0 = zzaae     // Catch:{ all -> 0x00a7 }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzzz     // Catch:{ all -> 0x00a7 }
            boolean r1 = r1.containsKey(r14)     // Catch:{ all -> 0x00a7 }
            r2 = 0
            if (r1 == 0) goto L_0x001e
            java.util.HashMap<java.lang.String, java.lang.String> r13 = zzzz     // Catch:{ all -> 0x00a7 }
        ...
        L_0x001c:
            ...
            return r2
        L_0x001e:
            java.lang.String[] r1 = zzaag     // Catch:{ all -> 0x00a7 }
        ...
        L_0x0023:
            ...
            boolean r0 = zzaaf     // Catch:{ all -> 0x00a7 }
            if (r0 == 0) goto L_0x003a
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzzz     // Catch:{ all -> 0x00a7 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00a7 }
            if (r0 == 0) goto L_0x005c
        L_0x003a:
            java.lang.String[] r0 = zzaag     // Catch:{ all -> 0x00a7 }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzzz     // Catch:{ all -> 0x00a7 }
            java.util.Map r13 = zza(r13, r0)     // Catch:{ all -> 0x00a7 }
            r1.putAll(r13)     // Catch:{ all -> 0x00a7 }
            zzaaf = r6     // Catch:{ all -> 0x00a7 }
            java.util.HashMap<java.lang.String, java.lang.String> r13 = zzzz     // Catch:{ all -> 0x00a7 }
    ...
    private static Map<String, String> zza(ContentResolver contentResolver, String... strArr) {
        Cursor query = contentResolver.query(zzzv, (String[]) null, (String) null, strArr, (String) null);
