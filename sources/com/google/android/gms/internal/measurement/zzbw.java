...
public final class zzbw extends zziq<zzbw> {
    ...
    public final void zza(zzio zzio) throws IOException {
        ...
        zzbq.zza[] zzaArr = this.zzzm;
        if (zzaArr != null && zzaArr.length > 0) {
            int i2 = 0;
            while (true) {
                zzbq.zza[] zzaArr2 = this.zzzm;
                if (i2 >= zzaArr2.length) {
                    break;
                }
                zzbq.zza zza = zzaArr2[i2];
                if (zza != null) {
                    zzio.zze(4, zza);
                }
                i2++;
    ...
    public final /* synthetic */ zziw zza(zzil zzil) throws IOException {
        while (true) {
            ...
            if (zzsg == 8) {
                ...
                int i = zzb + length;
                zzbq.zza[] zzaArr2 = new zzbq.zza[i];
                if (length != 0) {
                    System.arraycopy(zzaArr, 0, zzaArr2, 0, length);
                }
                while (length < i - 1) {
                    zzaArr2[length] = (zzbq.zza) zzil.zza(zzbq.zza.zzkj());
                    zzil.zzsg();
                    length++;
                }
                zzaArr2[length] = (zzbq.zza) zzil.zza(zzbq.zza.zzkj());
                ...
                int i2 = zzb2 + length2;
                zzbx[] zzbxArr2 = new zzbx[i2];
                if (length2 != 0) {
                    System.arraycopy(zzbxArr, 0, zzbxArr2, 0, length2);
                }
                while (length2 < i2 - 1) {
                ...
                int i3 = zzb3 + length3;
                zzbv[] zzbvArr2 = new zzbv[i3];
                if (length3 != 0) {
                    System.arraycopy(zzbvArr, 0, zzbvArr2, 0, length3);
                }
                while (length3 < i3 - 1) {
