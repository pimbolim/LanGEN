...
public final class zzjp implements zzjq {
    ...
    static {
        ...
        zzapy = zzct.zze("measurement.config.cache_time", DateUtils.MILLIS_PER_HOUR);
        ...
        zzaqh = zzct.zze("measurement.alarm_manager.minimum_interval", DateUtils.MILLIS_PER_MINUTE);
        zzaqi = zzct.zze("measurement.upload.minimum_delay", 500);
        zzaqj = zzct.zze("measurement.monitoring.sample_period_millis", DateUtils.MILLIS_PER_DAY);
        ...
        zzaqm = zzct.zze("measurement.config.cache_time.service", DateUtils.MILLIS_PER_DAY);
        zzaqn = zzct.zze("measurement.service_client.idle_disconnect_millis", CoroutineLiveDataKt.DEFAULT_TIMEOUT);
        zzaqo = zzct.zzt("measurement.log_tag.service", "FA-SVC");
        zzaqp = zzct.zze("measurement.upload.stale_data_deletion_interval", DateUtils.MILLIS_PER_DAY);
        ...
        zzaqs = zzct.zze("measurement.upload.interval", DateUtils.MILLIS_PER_HOUR);
        ...
        zzarg = zzct.zze("measurement.upload.window_interval", DateUtils.MILLIS_PER_HOUR);
    }
}
