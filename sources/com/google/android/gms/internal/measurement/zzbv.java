    ...
    public final /* synthetic */ zziw zza(zzil zzil) throws IOException {
        while (true) {
            ...
            if (zzsg == 8) {
                ...
                int i = zzb + length;
                zzbk.zzd[] zzdArr2 = new zzbk.zzd[i];
                if (length != 0) {
                    System.arraycopy(zzdArr, 0, zzdArr2, 0, length);
                }
                while (length < i - 1) {
                ...
                int i2 = zzb2 + length2;
                zzbk.zza[] zzaArr2 = new zzbk.zza[i2];
                if (length2 != 0) {
                    System.arraycopy(zzaArr, 0, zzaArr2, 0, length2);
                }
                while (length2 < i2 - 1) {
