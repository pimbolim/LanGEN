...
public abstract class zzee extends zzdm {
    ...
    /* access modifiers changed from: package-private */
    public abstract void zza(zzgi zzgi, zzgx zzgx) throws IOException;
    ...
    static final class zzd extends zzee {
        ...
        public final void zzc(byte b) throws IOException {
            ...
            throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(this.zzaen), Long.valueOf(this.zzael), 1}));
        }
    ...
    static class zza extends zzee {
        ...
        public final void zzbf(int i) throws IOException {
            if (!zzee.zzaec || zzdi.zzrv() || zztg() < 5) {
                ...
                this.position = i15 + 1;
                zzhv.zza(bArr11, (long) i15, (byte) (i12 >>> 7));
            }
        }
