...
public class zzaf {
    ...
    static String zzi(Bundle bundle) throws IOException {
        if (bundle != null) {
            ...
            String string2 = bundle.getString(ReactVideoView.EVENT_PROP_ERROR);
            if (string2 != null) {
    ...
    public final void zzh(Intent intent) {
        ...
        if (intent != null) {
            ...
            if ("com.google.android.c2dm.intent.REGISTRATION".equals(action) || "com.google.android.gms.iid.InstanceID".equals(action)) {
                ...
                if (stringExtra == null) {
                    String stringExtra2 = intent.getStringExtra(ReactVideoView.EVENT_PROP_ERROR);
    ...
    private final android.os.Bundle zzk(android.os.Bundle r9) throws java.io.IOException {
        /*
            ...
            monitor-enter(r2)
            java.util.Map<java.lang.String, java.lang.Object> r3 = r8.zzcz     // Catch:{ all -> 0x01e2 }
            r3.put(r1, r0)     // Catch:{ all -> 0x01e2 }
            monitor-exit(r2)     // Catch:{ all -> 0x01e2 }
        ...
        L_0x00df:
            ...
            r5.send(r3)     // Catch:{ RemoteException -> 0x00f7 }
            goto L_0x0187
        L_0x00f7:
            java.lang.String r3 = "InstanceID"
            boolean r3 = android.util.Log.isLoggable(r3, r4)
        ...
        L_0x0107:
            ...
            monitor-enter(r9)
            android.content.BroadcastReceiver r3 = zzcy     // Catch:{ all -> 0x0147 }
            if (r3 != 0) goto L_0x0140
            com.google.android.gms.iid.zzah r3 = new com.google.android.gms.iid.zzah     // Catch:{ all -> 0x0147 }
            r3.<init>(r8)     // Catch:{ all -> 0x0147 }
            zzcy = r3     // Catch:{ all -> 0x0147 }
            java.lang.String r3 = "InstanceID"
            boolean r3 = android.util.Log.isLoggable(r3, r4)     // Catch:{ all -> 0x0147 }
            if (r3 == 0) goto L_0x0126
            java.lang.String r3 = "InstanceID"
            java.lang.String r4 = "Registered GSF callback receiver"
            android.util.Log.d(r3, r4)     // Catch:{ all -> 0x0147 }
        L_0x0126:
            android.content.IntentFilter r3 = new android.content.IntentFilter     // Catch:{ all -> 0x0147 }
            java.lang.String r4 = "com.google.android.c2dm.intent.REGISTRATION"
            r3.<init>(r4)     // Catch:{ all -> 0x0147 }
            android.content.Context r4 = r8.zzl     // Catch:{ all -> 0x0147 }
            java.lang.String r4 = r4.getPackageName()     // Catch:{ all -> 0x0147 }
            r3.addCategory(r4)     // Catch:{ all -> 0x0147 }
            android.content.Context r4 = r8.zzl     // Catch:{ all -> 0x0147 }
            android.content.BroadcastReceiver r5 = zzcy     // Catch:{ all -> 0x0147 }
            java.lang.String r6 = "com.google.android.c2dm.permission.SEND"
            r7 = 0
            r4.registerReceiver(r5, r3, r6, r7)     // Catch:{ all -> 0x0147 }
        L_0x0140:
        ...
        L_0x014a:
            ...
            r9.obj = r2
            com.google.android.gms.iid.MessengerCompat r3 = r8.zzdb     // Catch:{ RemoteException -> 0x0168 }
            r3.send(r9)     // Catch:{ RemoteException -> 0x0168 }
            goto L_0x0187
        L_0x0168:
        ...
        L_0x0187:
            ...
            monitor-enter(r9)
            java.util.Map<java.lang.String, java.lang.Object> r0 = r8.zzcz     // Catch:{ all -> 0x01d7 }
            java.lang.Object r0 = r0.remove(r1)     // Catch:{ all -> 0x01d7 }
            boolean r1 = r0 instanceof android.os.Bundle     // Catch:{ all -> 0x01d7 }
            if (r1 == 0) goto L_0x019f
            android.os.Bundle r0 = (android.os.Bundle) r0     // Catch:{ all -> 0x01d7 }
            monitor-exit(r9)     // Catch:{ all -> 0x01d7 }
            return r0
        L_0x019f:
            boolean r1 = r0 instanceof java.lang.String     // Catch:{ all -> 0x01d7 }
            if (r1 == 0) goto L_0x01ab
            java.io.IOException r1 = new java.io.IOException     // Catch:{ all -> 0x01d7 }
            java.lang.String r0 = (java.lang.String) r0     // Catch:{ all -> 0x01d7 }
        ...
        L_0x01ab:
            ...
            java.lang.String r2 = java.lang.String.valueOf(r0)     // Catch:{ all -> 0x01d7 }
            int r2 = r2.length()     // Catch:{ all -> 0x01d7 }
            int r2 = r2 + 12
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x01d7 }
            r3.<init>(r2)     // Catch:{ all -> 0x01d7 }
            java.lang.String r2 = "No response "
            r3.append(r2)     // Catch:{ all -> 0x01d7 }
            r3.append(r0)     // Catch:{ all -> 0x01d7 }
            java.lang.String r0 = r3.toString()     // Catch:{ all -> 0x01d7 }
            android.util.Log.w(r1, r0)     // Catch:{ all -> 0x01d7 }
