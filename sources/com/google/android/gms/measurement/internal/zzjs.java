...
public final class zzjs extends zzge {
    ...
    private static final List<String> zzua = Collections.unmodifiableList(Arrays.asList(new String[]{"source", "medium", FirebaseAnalytics.Param.CAMPAIGN, FirebaseAnalytics.Param.TERM, "content"}));
    private int zzag;
    ...
    public final android.os.Bundle zza(java.lang.String r18, java.lang.String r19, android.os.Bundle r20, java.util.List<java.lang.String> r21, boolean r22, boolean r23) {
        ...
        L_0x0083:
            ...
            boolean r1 = zza((android.os.Bundle) r11, (int) r3)
            if (r1 == 0) goto L_0x009a
            java.lang.String r1 = zza((java.lang.String) r15, (int) r5, (boolean) r2)
            r11.putString(r4, r1)
    ...
    static boolean zzb(List<String> list, List<String> list2) {
    ...
    public final zzai zza(String str, String str2, Bundle bundle, String str3, long j, boolean z, boolean z2) {
        ...
        if (zzbl(str2) == 0) {
            ...
            return new zzai(str2, new zzah(zzg(zza(str, str2, bundle3, CollectionUtils.listOf("_o"), false, false))), str3, j);
        }
    ...
    public static ArrayList<Bundle> zzd(List<zzq> list) {
        ...
        for (zzq next : list) {
            Bundle bundle = new Bundle();
            bundle.putString(PaymentMethodOptionsParams.WeChatPay.PARAM_APP_ID, next.packageName);
            ...
            bundle.putBoolean("active", next.active);
