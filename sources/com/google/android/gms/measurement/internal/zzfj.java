...
public class zzfj implements zzgh {
    ...
    private zzfj(zzgm zzgm) {
        ...
        zzr zzr = new zzr(zzgm.zzob);
        this.zzfv = zzr;
        zzak.zza(zzr);
        Context context = zzgm.zzob;
        this.zzob = context;
        this.zzv = zzgm.zzv;
        this.zzoc = zzgm.zzoc;
        this.zzod = zzgm.zzod;
        ...
        this.zzac = instance;
        this.zzdr = instance.currentTimeMillis();
        ...
        if (context.getApplicationContext() instanceof Application) {
            ...
            if (zzq.getContext().getApplicationContext() instanceof Application) {
                ...
                if (zzq.zzpu == null) {
                    zzq.zzpu = new zzhj(zzq, (zzgo) null);
                }
                if (z2) {
        ...
        zzfc.zza((Runnable) new zzfl(this, zzgm));
    }
    ...
    public final void start() {
        ...
        if (zzie()) {
            ...
            if (!TextUtils.isEmpty(zzr().getGmpAppId()) || !TextUtils.isEmpty(zzr().zzah())) {
                ...
                zzs().zza((AtomicReference<String>) new AtomicReference());
            }
        } else if (isEnabled()) {
    ...
    public final void zza(zzp zzp) {
        ...
        if (!this.zzoe.zzbr().booleanValue() || ((Boolean) zzap.second).booleanValue()) {
            ...
            zzhv.zzaa().zzb((Runnable) new zzhn(zzhv, zzag, zza, (byte[]) null, (Map<String, String>) null, zzfi));
        }
    }
