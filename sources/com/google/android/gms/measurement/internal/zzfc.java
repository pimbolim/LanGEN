...
public final class zzfc extends zzge {
    ...
    public final void zza(Runnable runnable) throws IllegalStateException {
        ...
        zza((zzfh<?>) new zzfh(this, runnable, false, "Task exception on worker thread"));
    }
    ...
    public final <T> T zza(java.util.concurrent.atomic.AtomicReference<T> r1, long r2, java.lang.String r4, java.lang.Runnable r5) {
        /*
            ...
            r2.zza((java.lang.Runnable) r5)     // Catch:{ all -> 0x005c }
    ...
    private final void zza(zzfh<?> zzfh) {
        synchronized (this.zzng) {
            ...
            zzfg zzfg = this.zzna;
            if (zzfg == null) {
                zzfg zzfg2 = new zzfg(this, "Measurement Worker", this.zznc);
                this.zzna = zzfg2;
                zzfg2.setUncaughtExceptionHandler(this.zzne);
                this.zzna.start();
            } else {
                zzfg.zzhr();
            }
    ...
    public final void zzb(Runnable runnable) throws IllegalStateException {
        ...
        synchronized (this.zzng) {
            ...
            zzfg zzfg = this.zznb;
            if (zzfg == null) {
                zzfg zzfg2 = new zzfg(this, "Measurement Network", this.zznd);
                this.zznb = zzfg2;
                zzfg2.setUncaughtExceptionHandler(this.zznf);
                this.zznb.start();
            } else {
                zzfg.zzhr();
            }
