...
public final class zzfk extends zzdw {
    ...
    public final byte[] zza(zzai zzai, String str) {
        ...
        long nanoTime = this.zzkz.zzx().nanoTime() / AnimationKt.MillisToNanos;
        try {
            ...
            this.zzkz.zzab().zzgr().zza("Log and bundle processed. event, size, time_ms", this.zzkz.zzy().zzaj(zzai.name), Integer.valueOf(bArr.length), Long.valueOf((this.zzkz.zzx().nanoTime() / AnimationKt.MillisToNanos) - nanoTime));
            return bArr;
