...
public final class WalletConstants {
    ...
    public static final int ERROR_CODE_APP_LABEL_UNAVAILABLE = 415;
    ...
    public static final int ERROR_CODE_ILLEGAL_CALLER = 414;
    ...
    public static final int ERROR_CODE_USER_CANCELLED = 416;
    ...
    public static final int PAYMENT_CARD_RECOGNITION_TYPE_OCR = 1;
    ...
    public static final Account zza = new Account("ACCOUNT_NO_WALLET", AccountType.GOOGLE);
