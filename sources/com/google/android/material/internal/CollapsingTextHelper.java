...
public final class CollapsingTextHelper {
    ...
    private float getCollapsedTextLeftBound(int i, int i2) {
        ...
        return ((i2 & GravityCompat.END) == 8388613 || (i2 & 5) == 5) ? this.isRtl ? (float) this.collapsedBounds.left : ((float) this.collapsedBounds.right) - this.collapsedTextWidth : this.isRtl ? ((float) this.collapsedBounds.right) - this.collapsedTextWidth : (float) this.collapsedBounds.left;
    }
    ...
    private float getCollapsedTextRightBound(RectF rectF, int i, int i2) {
        ...
        return ((i2 & GravityCompat.END) == 8388613 || (i2 & 5) == 5) ? this.isRtl ? rectF.left + this.collapsedTextWidth : (float) this.collapsedBounds.right : this.isRtl ? (float) this.collapsedBounds.right : rectF.left + this.collapsedTextWidth;
    }
    ...
    private void calculateOffsets(float f) {
        ...
        if (this.fadeModeEnabled) {
            ...
            this.textPaint.setAlpha((int) (calculateFadeModeTextAlpha(f) * ((float) alpha)));
        }
    ...
    private void calculateBaseOffsets(boolean z) {
        ...
        if (staticLayout5 != null) {
            f2 = this.maxLines > 1 ? (float) staticLayout5.getLineStart(0) : staticLayout5.getLineLeft(0);
        }
        ...
        if (i4 == 1) {
            this.expandedDrawX = ((float) this.expandedBounds.centerX()) - (measureText / 2.0f);
        } else if (i4 != 5) {
            this.expandedDrawX = (float) this.expandedBounds.left;
        } else {
            this.expandedDrawX = ((float) this.expandedBounds.right) - measureText;
        }
        clearTexture();
