...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        L_0x0084:
            ...
            android.content.res.TypedArray r13 = r7.obtainStyledAttributes(r13, r0)
            int r0 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x01c1 }
            int r0 = r13.getDimensionPixelSize(r0, r11)     // Catch:{ all -> 0x01c1 }
            float r0 = (float) r0     // Catch:{ all -> 0x01c1 }
            r10.tabTextSize = r0     // Catch:{ all -> 0x01c1 }
            int r0 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x01c1 }
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        public void tweenIndicatorPosition(View view, View view2, float f) {
            if (view != null && view.getWidth() > 0) {
                TabIndicatorInterpolator access$1300 = TabLayout.this.tabIndicatorInterpolator;
                TabLayout tabLayout = TabLayout.this;
                access$1300.setIndicatorBoundsForOffset(tabLayout, view, view2, f, tabLayout.tabSelectedIndicator);
            } else {
