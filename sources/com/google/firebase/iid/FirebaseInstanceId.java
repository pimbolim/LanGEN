...
public class FirebaseInstanceId {
    ...
    public Task<InstanceIdResult> getInstanceId() {
        return zza(zzan.zza(this.zzau), ProxyConfig.MATCH_ALL_SCHEMES);
    }
    ...
    public final zzay zzk() {
        return zzb(zzan.zza(this.zzau), ProxyConfig.MATCH_ALL_SCHEMES);
    }
    ...
    public final String zzl() throws IOException {
        return getToken(zzan.zza(this.zzau), ProxyConfig.MATCH_ALL_SCHEMES);
    }
    ...
    /* access modifiers changed from: package-private */
    public final boolean zza(zzay zzay2) {
