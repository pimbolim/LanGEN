...
public final class zzb {
    ...
    public final zza zzf(Bundle bundle) {
        ...
        if (intent == null) {
            ...
            pendingIntent = PendingIntent.getActivity(context, atomicInteger.incrementAndGet(), intent, BasicMeasure.EXACTLY);
            if (zzk(bundle)) {
                Intent intent2 = new Intent("com.google.firebase.messaging.NOTIFICATION_OPEN");
                zza(intent2, bundle);
                intent2.putExtra("pending_intent", pendingIntent);
                pendingIntent = zza(atomicInteger.incrementAndGet(), intent2);
            }
        }
    ...
    public static boolean zzh(Bundle bundle) {
        return ThreeDSecureRequest.VERSION_1.equals(zza(bundle, "gcm.n.e")) || zza(bundle, "gcm.n.icon") != null;
    }
    ...
    private final boolean zzb(int i) {
        ...
        try {
            if (!(this.zzag.getResources().getDrawable(i, (Resources.Theme) null) instanceof AdaptiveIconDrawable)) {
                return true;
            }
    ...
    private final PendingIntent zza(int i, Intent intent) {
        return PendingIntent.getBroadcast(this.zzag, i, new Intent("com.google.firebase.MESSAGING_EVENT").setComponent(new ComponentName(this.zzag, "com.google.firebase.iid.FirebaseInstanceIdReceiver")).putExtra("wrapped_intent", intent), BasicMeasure.EXACTLY);
    }

    private static boolean zzk(Bundle bundle) {
        return bundle != null && ThreeDSecureRequest.VERSION_1.equals(bundle.getString("google.c.a.e"));
    }
}
