...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public RemoteMessage build() {
            Bundle bundle = new Bundle();
            for (Map.Entry next : this.zzef.entrySet()) {
                bundle.putString((String) next.getKey(), (String) next.getValue());
            }
            bundle.putAll(this.zzee);
            this.zzee.remove(TypedValues.TransitionType.S_FROM);
    ...
    public final String getFrom() {
        return this.zzee.getString(TypedValues.TransitionType.S_FROM);
    }
    ...
    public final int getPriority() {
        ...
        if (string == null) {
            if (ThreeDSecureRequest.VERSION_1.equals(this.zzee.getString("google.priority_reduced"))) {
                return 2;
            }
            string = this.zzee.getString("google.priority");
        }
