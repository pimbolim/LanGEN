...
public final class FirebaseAnalytics {
    ...
    public final void logEvent(String str, Bundle bundle) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zza(Stripe3ds2AuthParams.FIELD_APP, str, bundle, true);
        }
    }
    ...
    public final void setUserProperty(String str, String str2) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb(Stripe3ds2AuthParams.FIELD_APP, str, (Object) str2, false);
        }
    }
    ...
    public final void setUserId(String str) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb(Stripe3ds2AuthParams.FIELD_APP, APEZProvider.FILEID, (Object) str, true);
        }
    }
