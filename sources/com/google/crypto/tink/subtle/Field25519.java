...
final class Field25519 {
    ...
    static long[] expand(byte[] bArr) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            jArr[i] = ((((((long) (bArr[iArr[i]] & UByte.MAX_VALUE)) | (((long) (bArr[iArr[i] + 1] & UByte.MAX_VALUE)) << 8)) | (((long) (bArr[iArr[i] + 2] & UByte.MAX_VALUE)) << 16)) | (((long) (bArr[iArr[i] + 3] & UByte.MAX_VALUE)) << 24)) >> EXPAND_SHIFT[i]) & ((long) MASK[i & 1]);
        }
        return jArr;
    }
