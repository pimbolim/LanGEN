...
class IterableByteBufferInputStream extends InputStream {
    ...
    public int read() throws IOException {
        ...
        if (this.hasArray) {
            byte b = this.currentArray[this.currentByteBufferPos + this.currentArrayOffset] & UByte.MAX_VALUE;
            updateCurrentByteBufferPos(1);
            return b;
        }
        byte b2 = UnsafeUtil.getByte(((long) this.currentByteBufferPos) + this.currentAddress) & UByte.MAX_VALUE;
        updateCurrentByteBufferPos(1);
        return b2;
    }
