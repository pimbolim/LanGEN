...
public class PngChunkReader {
    private static final byte[] PNG_SIGNATURE_BYTES = {-119, 80, 78, 71, 13, 10, JSONParserBase.EOI, 10};

    public Iterable<PngChunk> extract(SequentialReader sequentialReader, Set<PngChunkType> set) throws PngProcessingException, IOException {
