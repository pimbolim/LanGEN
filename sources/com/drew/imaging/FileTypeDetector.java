...
public class FileTypeDetector {
    ...
    static {
        ...
        byteTrie.addPath(FileType.Png, new byte[]{-119, 80, 78, 71, 13, 10, JSONParserBase.EOI, 10, 0, 0, 0, 13, 73, 72, 68, 82});
        ...
        byteTrie.addPath(FileType.Crw, "II".getBytes(), new byte[]{JSONParserBase.EOI, 0, 0, 0}, "HEAPCCDR".getBytes());
        ...
        byteTrie.addPath(FileType.Cfbf, new byte[]{-48, -49, 17, -32, -95, -79, JSONParserBase.EOI, -31, 0});
