...
public class QuickTimeDictionary {
    ...
    static {
        ...
        _videoCompressionTypes.put(ReactNativeBlobUtilConst.RNFB_RESPONSE_PATH, "Vector");
    ...
    public static String lookup(int i, String str) {
        return (!_dictionary.containsKey(Integer.valueOf(i)) || !_dictionary.get(Integer.valueOf(i)).containsKey(str)) ? BinData.UNKNOWN : (String) _dictionary.get(Integer.valueOf(i)).get(str);
    }
