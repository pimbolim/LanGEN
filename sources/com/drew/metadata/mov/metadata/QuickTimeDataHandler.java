...
public class QuickTimeDataHandler extends QuickTimeMetadataHandler {
    ...
    /* access modifiers changed from: protected */
    public void processKeys(SequentialByteArrayReader sequentialByteArrayReader) throws IOException {
    ...
    /* access modifiers changed from: protected */
    public void processData(byte[] bArr, SequentialByteArrayReader sequentialByteArrayReader) throws IOException {
