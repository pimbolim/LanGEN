...
public class IccDescriptor extends TagDescriptor<IccDirectory> {
    ...
    private java.lang.String getTagDataString(int r18) {
        /*
            ...
            r0 = r17
            r1 = r18
            com.drew.metadata.Directory r2 = r0._directory     // Catch:{ IOException -> 0x020a }
            com.drew.metadata.icc.IccDirectory r2 = (com.drew.metadata.icc.IccDirectory) r2     // Catch:{ IOException -> 0x020a }
            byte[] r2 = r2.getByteArray(r1)     // Catch:{ IOException -> 0x020a }
            if (r2 != 0) goto L_0x0017
            com.drew.metadata.Directory r2 = r0._directory     // Catch:{ IOException -> 0x020a }
            com.drew.metadata.icc.IccDirectory r2 = (com.drew.metadata.icc.IccDirectory) r2     // Catch:{ IOException -> 0x020a }
            java.lang.String r1 = r2.getString(r1)     // Catch:{ IOException -> 0x020a }
            return r1
        L_0x0017:
            com.drew.lang.ByteArrayReader r1 = new com.drew.lang.ByteArrayReader     // Catch:{ IOException -> 0x020a }
            r1.<init>(r2)     // Catch:{ IOException -> 0x020a }
            r3 = 0
            int r4 = r1.getInt32(r3)     // Catch:{ IOException -> 0x020a }
            java.lang.String r5 = ")"
            java.lang.String r6 = "("
            r7 = 7
            r8 = 16
        ...
        L_0x0043:
            ...
            return r1
        L_0x004c:
            int r1 = r1.getInt32(r14)     // Catch:{ IOException -> 0x020a }
            java.lang.String r1 = com.drew.metadata.icc.IccReader.getStringFromInt32(r1)     // Catch:{ IOException -> 0x020a }
            return r1
        L_0x0055:
            int r4 = r1.getInt32(r14)     // Catch:{ IOException -> 0x020a }
        ...
        L_0x0061:
            ...
            int r9 = r3 * 12
            int r9 = r9 + r8
            int r10 = r1.getInt32(r9)     // Catch:{ IOException -> 0x020a }
            java.lang.String r10 = com.drew.metadata.icc.IccReader.getStringFromInt32(r10)     // Catch:{ IOException -> 0x020a }
            int r11 = r9 + 4
            int r11 = r1.getInt32(r11)     // Catch:{ IOException -> 0x020a }
            int r9 = r9 + 8
            int r9 = r1.getInt32(r9)     // Catch:{ IOException -> 0x020a }
        ...
        L_0x009b:
            ...
            return r1
        L_0x00a0:
            int r2 = r1.getInt32(r14)     // Catch:{ IOException -> 0x020a }
            float r4 = r1.getS15Fixed16(r12)     // Catch:{ IOException -> 0x020a }
            float r5 = r1.getS15Fixed16(r8)     // Catch:{ IOException -> 0x020a }
            r6 = 20
            float r6 = r1.getS15Fixed16(r6)     // Catch:{ IOException -> 0x020a }
            r8 = 24
            int r8 = r1.getInt32(r8)     // Catch:{ IOException -> 0x020a }
            r10 = 28
            float r10 = r1.getS15Fixed16(r10)     // Catch:{ IOException -> 0x020a }
            r12 = 32
            int r1 = r1.getInt32(r12)     // Catch:{ IOException -> 0x020a }
        ...
        L_0x017d:
            int r6 = r5 * 2
            int r6 = r6 + r12
            int r6 = r1.getUInt16(r6)     // Catch:{ IOException -> 0x020a }
            ...
            double r8 = r8 / r13
            java.lang.String r6 = formatDoubleAsString(r8, r7, r3)     // Catch:{ IOException -> 0x020a }
        ...
        L_0x01aa:
            ...
            int r8 = r3 * 12
            int r8 = r8 + r14
            float r9 = r1.getS15Fixed16(r8)     // Catch:{ IOException -> 0x020a }
            int r11 = r8 + 4
            float r11 = r1.getS15Fixed16(r11)     // Catch:{ IOException -> 0x020a }
            int r8 = r8 + 8
            float r8 = r1.getS15Fixed16(r8)     // Catch:{ IOException -> 0x020a }
        ...
        L_0x01f0:
            ...
            java.lang.String r6 = com.drew.metadata.icc.IccReader.getStringFromInt32(r4)     // Catch:{ IOException -> 0x020a }
