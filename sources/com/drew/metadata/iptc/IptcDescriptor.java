...
public class IptcDescriptor extends TagDescriptor<IptcDirectory> {
    ...
    public String getDateDescription(int i) {
        ...
        return string.substring(0, 4) + AbstractJsonLexerKt.COLON + string.substring(4, 6) + AbstractJsonLexerKt.COLON + string.substring(6);
    }
    ...
    public String getTimeDescription(int i) {
        ...
        return string.substring(0, 2) + AbstractJsonLexerKt.COLON + string.substring(2, 4) + AbstractJsonLexerKt.COLON + string.substring(4);
    }
