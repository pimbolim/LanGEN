...
public abstract class ExifDescriptorBase<T extends Directory> extends TagDescriptor<T> {
    ...
    private String getUnicodeDescription(int i) {
        ...
        try {
            return new String(byteArray, CharEncoding.UTF_16LE).trim();
    ...
    public String getSubjectDistanceRangeDescription() {
        return getIndexedDescription(ExifDirectoryBase.TAG_SUBJECT_DISTANCE_RANGE, BinData.UNKNOWN, "Macro", "Close view", "Distant view");
    }

    public String getSensitivityTypeRangeDescription() {
        return getIndexedDescription(ExifDirectoryBase.TAG_SENSITIVITY_TYPE, BinData.UNKNOWN, "Standard Output Sensitivity", "Recommended Exposure Index", "ISO Speed", "Standard Output Sensitivity and Recommended Exposure Index", "Standard Output Sensitivity and ISO Speed", "Recommended Exposure Index and ISO Speed", "Standard Output Sensitivity, Recommended Exposure Index and ISO Speed");
    }
    ...
    public String get35mmFilmEquivFocalLengthDescription() {
        ...
        return integer.intValue() == 0 ? BinData.UNKNOWN : getFocalLengthDescription((double) integer.intValue());
    }
    ...
    public String getUserCommentDescription() {
        ...
        hashMap.put("UNICODE", CharEncoding.UTF_16LE);
    ...
    public String getCfaPattern2Description() {
        ...
        if (intArray == null) {
            ...
            for (int i = 0; i < byteArray.length; i++) {
                iArr[i + 2] = byteArray[i] & UByte.MAX_VALUE;
            }
    ...
    public String getFocalPlaneXResolutionDescription() {
        ...
        if (focalPlaneResolutionUnitDescription == null) {
            ...
            str = StringUtils.SPACE + focalPlaneResolutionUnitDescription.toLowerCase();
        }
        sb.append(str);
        return sb.toString();
    }
