...
public class OlympusFocusInfoMakernoteDescriptor extends TagDescriptor<OlympusFocusInfoMakernoteDirectory> {
    ...
    public String getExternalFlashZoomDescription() {
        ...
        String format = String.format(TimeModel.NUMBER_FORMAT, new Object[]{Short.valueOf((short) intArray[0])});
        if (intArray.length > 1) {
            format = format + StringUtils.SPACE + String.format(TimeModel.NUMBER_FORMAT, new Object[]{Short.valueOf((short) intArray[1])});
        }
        if (format.equals("0")) {
            return "Off";
        }
        if (format.equals(ThreeDSecureRequest.VERSION_1)) {
            return "On";
        }
        if (format.equals("0 0")) {
            return "Off";
