...
public class PanasonicMakernoteDescriptor extends TagDescriptor<PanasonicMakernoteDirectory> {
    ...
    private String getTransformDescription(int i) {
        ...
        try {
            ...
            return "Unknown (" + uInt16 + StringUtils.SPACE + uInt162 + ")";
    ...
    public String getFlashWarningDescription() {
        return getIndexedDescription(98, BinData.NO, "Yes (Flash required but disabled)");
    }
    ...
    public String getAfAreaModeDescription() {
        ...
        if (i == 0) {
            ...
            return "Unknown (" + intArray[0] + StringUtils.SPACE + intArray[1] + ")";
        } else if (i == 1) {
            int i3 = intArray[1];
            if (i3 == 0) {
