...
public class FileUtil {
    ...
    public static void saveBytes(java.io.File r2, byte[] r3) throws java.io.IOException {
        /*
            r0 = 0
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] readBytes(java.io.File r5) throws java.io.IOException {
        /*
            long r0 = r5.length()
            int r1 = (int) r0
            byte[] r0 = new byte[r1]
