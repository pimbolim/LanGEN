...
class RNSVGRenderableManager extends ReactContextBaseJavaModule {
    ...
    public boolean isPointInFill(int i, ReadableMap readableMap) {
        ...
        if (renderableViewByTag.hitTest(new float[]{((float) readableMap.getDouble("x")) * f, ((float) readableMap.getDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE)) * f}) != -1) {
            return true;
        }
        return false;
    }
    ...
    public boolean isPointInStroke(int i, ReadableMap readableMap) {
        ...
        try {
            ...
            int i3 = (int) (readableMap.getDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE) * d);
    ...
    public WritableMap getPointAtLength(int i, ReadableMap readableMap) {
        ...
        try {
            ...
            createMap.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, (double) (fArr[1] / f2));
    ...
    public WritableMap getBBox(int i, ReadableMap readableMap) {
        ...
        try {
            ...
            createMap.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, (double) (rectF.top / f));
    ...
    public WritableMap getCTM(int i) {
        ...
        createMap.putDouble(JWKParameterNames.RSA_EXPONENT, (double) (fArr[2] / f));
