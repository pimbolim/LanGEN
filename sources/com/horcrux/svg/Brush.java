...
class Brush {
    ...
    public void setupPaint(Paint paint, RectF rectF, float f, float f2) {
        ...
        if (this.mType == BrushType.LINEAR_GRADIENT) {
            ...
            double val8 = getVal(this.mPoints[2], d17, f, textSize);
            double d18 = (double) height;
            double d19 = val8;
            double val9 = getVal(this.mPoints[3], d18, f, textSize) / d19;
            double d20 = d17;
            double d21 = val9;
            double val10 = getVal(this.mPoints[4], d20, f, textSize) + ((double) f4);
            double d22 = d18 / d21;
            double d23 = val10;
            RadialGradient radialGradient = new RadialGradient((float) d23, (float) (getVal(this.mPoints[5], d22, f, textSize) + (((double) f5) / d21)), (float) d19, iArr, fArr, Shader.TileMode.CLAMP);
