...
class FontData {
    ...
    static class AbsoluteFontWeight {
        ...
        private static final int[] absoluteFontWeights = {400, 700, 100, 200, 300, 400, 500, 600, 700, LeicaMakernoteDirectory.TAG_CAMERA_TEMPERATURE, TypedValues.Custom.TYPE_INT};
    ...
    private FontData() {
        ...
        this.absoluteFontWeight = StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB;
