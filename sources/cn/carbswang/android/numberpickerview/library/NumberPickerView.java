...
public class NumberPickerView extends View {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.mViewWidth = i;
        this.mViewHeight = i2;
        this.mItemHeight = i2 / this.mShownCount;
        ...
        if (getOneRecycleSize() > 1) {
            if (this.mHasInit) {
                ...
                i5 = this.mCurrDrawFirstItemIndex + ((this.mShownCount - 1) / 2);
            }
    ...
    public void setDividerHeight(int i) {
        if (this.mDividerHeight != i) {
            ...
            this.mPaintDivider.setStrokeWidth((float) i);
            postInvalidate();
        }
    }

    public void setItemPaddingHorizontal(int i) {
        this.mItemPaddingHorizontal = i;
        postInvalidate();
    }
    ...
    private void drawContent(Canvas canvas) {
        ...
        while (i2 < this.mShownCount + 1) {
            ...
            if (indexByRawIndex >= 0 && indexByRawIndex < getOneRecycleSize()) {
                ...
                canvas.drawText(charSequence.toString(), (float) (this.mPaintText.getTextAlign() == Paint.Align.RIGHT ? this.mViewWidth - (this.mItemPaddingHorizontal * 2) : this.mItemPaddingHorizontal * 2), f5 + ((float) (this.mItemHeight / 2)) + f, this.mPaintText);
