...
final class d extends c {
    ...
    private JSONObject f() {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("version", a((Object) c.b(new File("proc/version"))));
            ...
            jSONObject.put(ViewProps.DISPLAY, a((Object) Build.DISPLAY));
            ...
            jSONObject.put("time", a((Object) Long.valueOf(Build.TIME)));
        } catch (JSONException e) {
            lib.android.paypal.com.magnessdk.b.a.a((Class<?>) d.class, 3, (Throwable) e);
        }
        return jSONObject;
    ...
    public JSONObject a() {
        ...
        try {
            ...
            jSONObject.put(PaymentMethodOptionsParams.WeChatPay.PARAM_APP_ID, this.bp);
            jSONObject.put(lib.android.paypal.com.magnessdk.a.b.f, this.bu);
            jSONObject.put(AnalyticsFields.APP_VERSION, this.bq);
            long j = this.bH;
            Long l = null;
            ...
            jSONObject.put(AnalyticsFields.OS_VERSION, this.bt);
                        ...
                        if (i != 47) {
                            if (i != 52) {
                                if (i == 86) {
                                    ...
                                    this.bJ = a2;
                                    c.bf = a2.optString(MessageExtension.FIELD_ID);
                                } else if (i != 88) {
                                    if (i == 8) {
                                        this.bB = a.f;
                                    } else if (i != 9) {
