...
public final class b extends h {
    ...
    public void a() {
        ...
        this.j.put(NetworkConstantsKt.HEADER_CONTENT_TYPE, ShareTarget.ENCODING_TYPE_URL_ENCODED);
        ...
        if (jSONObject != null) {
            ...
            this.j.put("app-id", this.l.optString("app_id", BinData.UNKNOWN));
            this.j.put("app-version", this.l.optString("app_version", BinData.UNKNOWN));
    ...
    public void c() {
        ...
        a();
        try {
            MagnesNetworking createHttpClient = this.m.createHttpClient(ShareTarget.METHOD_POST);
