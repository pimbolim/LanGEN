...
public final class a extends h {
    ...
    public void a() {
        this.h.put(NetworkConstantsKt.HEADER_USER_AGENT, String.format("%s/%s/%s/%s/Android", new Object[]{this.f.optString(PaymentMethodOptionsParams.WeChatPay.PARAM_APP_ID), this.f.optString(AnalyticsFields.APP_VERSION), this.f.optString(AnalyticsFields.APP_VERSION), this.f.optString("app_guid")}));
        this.h.put(NetworkConstantsKt.HEADER_ACCEPT_LANGUAGE, "en-us");
    }
    ...
    public void c() {
        try {
            ...
            if (this.g == -1) {
                sb.append("&s=");
                sb.append(this.f.optString(PaymentMethodOptionsParams.WeChatPay.PARAM_APP_ID));
            } else {
                sb.append("&a=");
                sb.append(this.g);
            }
            ...
            MagnesNetworking createHttpClient = this.j.createHttpClient(ShareTarget.METHOD_GET);
