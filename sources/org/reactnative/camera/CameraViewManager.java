...
public class CameraViewManager extends ViewGroupManager<RNCameraView> {
    ...
    public void setAutoFocusPointOfInterest(RNCameraView rNCameraView, ReadableMap readableMap) {
        if (readableMap != null) {
            rNCameraView.setAutoFocusPointOfInterest((float) readableMap.getDouble("x"), (float) readableMap.getDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE));
        }
    }
    ...
    public void setRectOfInterest(RNCameraView rNCameraView, ReadableMap readableMap) {
        if (readableMap != null) {
            rNCameraView.setRectOfInterest((float) readableMap.getDouble("x"), (float) readableMap.getDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE), (float) readableMap.getDouble("width"), (float) readableMap.getDouble("height"));
        }
    }
