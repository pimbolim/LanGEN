...
public class TextRecognizerAsyncTask extends AsyncTask<Void, Void, List<Text.TextBlock>> {
    ...
    public List<Text.TextBlock> doInBackground(Void... voidArr) {
        ...
        return ((Text) this.mTextRecognizer.process(RNFrameFactory.buildFrame(this.mImageData, this.mWidth, this.mHeight, this.mRotation).getFrame()).getResult()).getTextBlocks();
    }
    ...
    private WritableMap serializeBounds(Rect rect) {
        ...
        createMap.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, ((double) i2) * this.mScaleY);
