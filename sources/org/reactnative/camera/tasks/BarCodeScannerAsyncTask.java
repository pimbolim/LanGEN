...
public class BarCodeScannerAsyncTask extends AsyncTask<Void, Void, Result> {
    ...
    public com.google.zxing.Result doInBackground(java.lang.Void... r16) {
        ...
        L_0x000e:
            ...
            float r2 = r2 * r0
            int r0 = (int) r2
            byte[] r2 = r10.mImageData     // Catch:{ NotFoundException -> 0x005a, all -> 0x0058 }
            r6 = 0
            r1 = r15
            r3 = r4
            r4 = r5
            ...
            r8 = r14
            r9 = r0
            com.google.zxing.BinaryBitmap r1 = r1.generateBitmapFromImageData(r2, r3, r4, r5, r6, r7, r8, r9)     // Catch:{ NotFoundException -> 0x005a, all -> 0x0058 }
            com.google.zxing.MultiFormatReader r2 = r10.mMultiFormatReader     // Catch:{ NotFoundException -> 0x005a, all -> 0x0058 }
            com.google.zxing.Result r0 = r2.decodeWithState(r1)     // Catch:{ NotFoundException -> 0x005a, all -> 0x0058 }
            return r0
        L_0x0058:
            r0 = move-exception
            goto L_0x00bb
        L_0x005a:
            byte[] r1 = r10.mImageData     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            int r2 = r10.mWidth     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            int r3 = r10.mHeight     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            byte[] r2 = r15.rotateImage(r1, r2, r3)     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            int r3 = r10.mHeight     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            int r4 = r10.mWidth     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            r5 = 0
            int r1 = r3 - r0
            int r6 = r1 - r13
            r1 = r15
            ...
            r8 = r0
            r9 = r14
            com.google.zxing.BinaryBitmap r1 = r1.generateBitmapFromImageData(r2, r3, r4, r5, r6, r7, r8, r9)     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            com.google.zxing.MultiFormatReader r2 = r10.mMultiFormatReader     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            com.google.zxing.Result r0 = r2.decodeWithState(r1)     // Catch:{ NotFoundException -> 0x007c, all -> 0x0058 }
            return r0
        L_0x007c:
            byte[] r2 = r10.mImageData     // Catch:{ NotFoundException -> 0x0099, all -> 0x0058 }
            int r3 = r10.mWidth     // Catch:{ NotFoundException -> 0x0099, all -> 0x0058 }
            int r4 = r10.mHeight     // Catch:{ NotFoundException -> 0x0099, all -> 0x0058 }
            r5 = 1
            int r1 = r3 - r14
            int r6 = r1 - r12
            int r1 = r4 - r0
            ...
            r8 = r14
            r9 = r0
            com.google.zxing.BinaryBitmap r1 = r1.generateBitmapFromImageData(r2, r3, r4, r5, r6, r7, r8, r9)     // Catch:{ NotFoundException -> 0x0099, all -> 0x0058 }
            com.google.zxing.MultiFormatReader r2 = r10.mMultiFormatReader     // Catch:{ NotFoundException -> 0x0099, all -> 0x0058 }
            com.google.zxing.Result r0 = r2.decodeWithState(r1)     // Catch:{ NotFoundException -> 0x0099, all -> 0x0058 }
            return r0
        L_0x0099:
            byte[] r1 = r10.mImageData     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            int r2 = r10.mWidth     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            int r3 = r10.mHeight     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            byte[] r2 = r15.rotateImage(r1, r2, r3)     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            int r3 = r10.mHeight     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            int r4 = r10.mWidth     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            r5 = 1
            int r1 = r4 - r14
            int r7 = r1 - r12
            r1 = r15
            ...
            r8 = r0
            r9 = r14
            com.google.zxing.BinaryBitmap r0 = r1.generateBitmapFromImageData(r2, r3, r4, r5, r6, r7, r8, r9)     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            com.google.zxing.MultiFormatReader r1 = r10.mMultiFormatReader     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            com.google.zxing.Result r0 = r1.decodeWithState(r0)     // Catch:{ NotFoundException -> 0x00be, all -> 0x0058 }
            return r0
        L_0x00bb:
            r0.printStackTrace()
        L_0x00be:
