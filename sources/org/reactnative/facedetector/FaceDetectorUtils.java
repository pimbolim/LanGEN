...
public class FaceDetectorUtils {
    ...
    public static WritableMap serializeFace(Face face, double d, double d2, int i, int i2, int i3, int i4) {
        ...
        for (FaceLandmark faceLandmark : face.getAllLandmarks()) {
            createMap.putMap(landmarkNames[faceLandmark.getLandmarkType()], mapFromPoint(faceLandmark.getPosition(), d, d2, i, i2, i3, i4));
        }
        ...
        createMap2.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, ((double) i6) * d2);
    ...
    public static WritableMap mapFromPoint(PointF pointF, double d, double d2, int i, int i2, int i3, int i4) {
        ...
        createMap.putDouble(JWKParameterNames.ELLIPTIC_CURVE_Y_COORDINATE, ((double) pointF.y) * d2);
        return createMap;
    }
