...
public class PSSSigner implements Signer {
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        try {
            ...
            if ((255 & bArr5[0]) == (bArr5[0] & length) && bArr5[bArr5.length - 1] == this.trailer) {
                int length2 = bArr5.length;
                int i = this.hLen;
                byte[] maskGenerator = maskGenerator(bArr5, (length2 - i) - 1, i, (bArr5.length - i) - 1);
                    ...
                    if (i3 != ((length3 - i4) - i5) - 2) {
                        ...
                        while (true) {
                            ...
                            if (length5 == bArr14.length) {
                                ...
                                clearBlock(this.block);
                                return true;
                            } else if ((this.block[i7] ^ bArr14[length5]) != 0) {
                                clearBlock(bArr14);
                                clearBlock(this.block);
                                return false;
                            } else {
