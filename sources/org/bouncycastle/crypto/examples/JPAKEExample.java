...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        printStream6.println("(Secret passwords used by Alice and Bob: \"" + HintConstants.AUTOFILL_HINT_PASSWORD + "\" and \"" + HintConstants.AUTOFILL_HINT_PASSWORD + "\")\n");
        SHA256Digest sHA256Digest = new SHA256Digest();
        JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup2 = jPAKEPrimeOrderGroup;
        SHA256Digest sHA256Digest2 = sHA256Digest;
        SecureRandom secureRandom = new SecureRandom();
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", HintConstants.AUTOFILL_HINT_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup2, sHA256Digest2, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", HintConstants.AUTOFILL_HINT_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup2, sHA256Digest2, secureRandom);
