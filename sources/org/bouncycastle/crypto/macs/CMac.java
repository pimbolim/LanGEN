...
public class CMac implements Mac {
    ...
    private byte[] doubleLu(byte[] bArr) {
        ...
        byte b = (-shiftLeft(bArr, bArr2)) & UByte.MAX_VALUE;
        int length = bArr.length - 3;
        byte b2 = bArr2[length];
        byte[] bArr3 = this.poly;
        bArr2[length] = (byte) (b2 ^ (bArr3[1] & b));
        int length2 = bArr.length - 2;
        bArr2[length2] = (byte) ((bArr3[2] & b) ^ bArr2[length2]);
        int length3 = bArr.length - 1;
        bArr2[length3] = (byte) ((b & bArr3[3]) ^ bArr2[length3]);
        return bArr2;
    }
