...
public final class DigestFactory {
    ...
    public static Digest createSHA3_224() {
        return new SHA3Digest((int) CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY);
    }
    ...
    public static Digest createSHA3_384() {
        return new SHA3Digest((int) BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT);
    }
    ...
    public static Digest createSHA512_224() {
        return new SHA512tDigest((int) CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY);
    }
