...
public class JPAKEPrimeOrderGroup {
    ...
    JPAKEPrimeOrderGroup(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, boolean z) {
        JPAKEUtil.validateNotNull(bigInteger, JWKParameterNames.RSA_FIRST_PRIME_FACTOR);
        JPAKEUtil.validateNotNull(bigInteger2, JWKParameterNames.RSA_SECOND_PRIME_FACTOR);
