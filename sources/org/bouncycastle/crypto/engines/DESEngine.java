...
public class DESEngine implements BlockCipher {
    ...
    private static final int[] SP5 = {256, 34078976, 34078720, 1107296512, 524288, 256, BasicMeasure.EXACTLY, 34078720, 1074266368, 524288, 33554688, 1074266368, 1107296512, 1107820544, 524544, BasicMeasure.EXACTLY, 33554432, 1074266112, 1074266112, 0, 1073742080, 1107820800, 1107820800, 33554688, 1107820544, 1073742080, 0, 1107296256, 34078976, 33554432, 1107296256, 524544, 524288, 1107296512, 256, 33554432, BasicMeasure.EXACTLY, 34078720, 1107296512, 1074266368, 33554688, BasicMeasure.EXACTLY, 1107820544, 34078976, 1074266368, 256, 33554432, 1107820544, 1107820800, 524544, 1107296256, 1107820800, 34078720, 0, 1074266112, 1107296256, 524544, 33554688, 1073742080, 524288, 0, 1074266112, 34078976, 1073742080};
    private static final int[] SP6 = {536870928, 541065216, 16384, 541081616, 541065216, 16, 541081616, 4194304, 536887296, 4210704, 4194304, 536870928, 4194320, 536887296, PropertyOptions.DELETE_EXISTING, CanonMakernoteDirectory.TAG_CUSTOM_PICTURE_STYLE_FILE_NAME, 0, 4194320, 536887312, 16384, 4210688, 536887312, 16, 541065232, 541065232, 0, 4210704, 541081600, CanonMakernoteDirectory.TAG_CUSTOM_PICTURE_STYLE_FILE_NAME, 4210688, 541081600, PropertyOptions.DELETE_EXISTING, 536887296, 16, 541065232, 4210688, 541081616, 4194304, CanonMakernoteDirectory.TAG_CUSTOM_PICTURE_STYLE_FILE_NAME, 536870928, 4194304, 536887296, PropertyOptions.DELETE_EXISTING, CanonMakernoteDirectory.TAG_CUSTOM_PICTURE_STYLE_FILE_NAME, 536870928, 541081616, 4210688, 541065216, 4210704, 541081600, 0, 541065232, 16, 16384, 541065216, 4210704, 16384, 4194320, 536887312, 0, 541081600, PropertyOptions.DELETE_EXISTING, 4194320, 536887312};
    ...
    private static final byte[] pc1 = {56, 48, 40, 32, 24, Tnaf.POW_2_WIDTH, 8, 0, 57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, JSONParserBase.EOI, 18, 10, 2, 59, 51, 43, 35, 62, 54, 46, 38, 30, 22, 14, 6, 61, 53, 45, 37, 29, 21, 13, 5, 60, 52, 44, 36, 28, 20, 12, 4, 27, 19, 11, 3};
    private static final byte[] pc2 = {13, Tnaf.POW_2_WIDTH, 10, 23, 0, 4, 2, 27, 14, 5, 20, 9, 22, 18, 11, 3, 25, 7, 15, 6, JSONParserBase.EOI, 19, 12, 1, 40, 51, 30, 36, 46, 54, 29, 39, 50, 44, 32, 47, 43, 48, 38, 55, 33, 52, 45, 41, 49, 35, 28, 31};
    ...
    public int[] generateWorkingKey(boolean z, byte[] bArr) {
        ...
        for (int i10 = 0; i10 != 32; i10 += 2) {
            ...
            int i12 = i10 + 1;
            int i13 = iArr[i12];
            iArr[i10] = ((16515072 & i13) >>> 10) | ((i11 & 16515072) << 6) | ((i11 & JSONParser.MODE_JSON_SIMPLE) << 10) | ((i13 & JSONParser.MODE_JSON_SIMPLE) >>> 6);
