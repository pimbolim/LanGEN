    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        while (i7 < i && i8 < (this.ROUNDS + 1) * (this.BC / 8)) {
            ...
            while (i9 < i4) {
                ...
                jArr2[i9] = (((long) (bArr3[i9][i7] & UByte.MAX_VALUE)) << ((i8 * 8) % i10)) | jArr2[i9];
                i9++;
                i4 = 4;
            }
            i7++;
        ...
        while (i8 < (this.ROUNDS + 1) * (this.BC / i3)) {
            ...
            while (i12 < 4) {
                ...
                i12++;
                bArr4[c] = (byte) (bArr4[c] ^ S[bArr3[i12 % 4][i - 1] & UByte.MAX_VALUE]);
            }
            byte[] bArr5 = bArr3[c];
            int i13 = i11 + 1;
            ...
            if (i <= 6) {
                ...
                while (true) {
                    ...
                    while (i16 < i2) {
                        ...
                        bArr7[i14] = (byte) (bArr7[i14] ^ bArr3[i16][i14 - 1]);
                        i16++;
                        i2 = 4;
                    }
                    i14++;
                ...
                for (int i17 = 0; i17 < 4; i17++) {
                    ...
                    bArr8[4] = (byte) (bArr8[4] ^ S[bArr3[i17][3] & UByte.MAX_VALUE]);
                }
                int i18 = 5;
                while (i18 < i) {
                    int i19 = 0;
            ...
            while (i20 < i && i8 < (this.ROUNDS + 1) * (this.BC / i3)) {
                for (int i21 = 0; i21 < 4; i21++) {
                    ...
                    jArr3[i21] = (((long) (bArr3[i21][i20] & UByte.MAX_VALUE)) << ((i8 * 8) % i22)) | jArr3[i21];
                }
                i20++;
                i8++;
                i3 = 8;
