...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private byte lRot8(byte b, int i) {
        return (byte) (((b & UByte.MAX_VALUE) >>> (8 - i)) | (b << i));
    }
