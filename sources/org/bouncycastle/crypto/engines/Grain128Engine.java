    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                int i3 = i2 + 3;
                int i4 = i2 + 2;
                byte b = (bArr3[i3] << 24) | ((bArr3[i4] << Tnaf.POW_2_WIDTH) & 16711680);
                int i5 = i2 + 1;
                iArr[i] = (bArr3[i2] & UByte.MAX_VALUE) | b | ((bArr3[i5] << 8) & 65280);
                int[] iArr2 = this.lfsr;
                byte[] bArr4 = this.workingIV;
                iArr2[i] = (bArr4[i2] & UByte.MAX_VALUE) | (bArr4[i3] << 24) | ((bArr4[i4] << Tnaf.POW_2_WIDTH) & 16711680) | ((bArr4[i5] << 8) & 65280);
                i2 += 4;
                i++;
            } else {
                return;
