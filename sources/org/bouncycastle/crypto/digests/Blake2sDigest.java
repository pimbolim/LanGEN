...
public class Blake2sDigest implements ExtendedDigest {
    ...
    private void compress(byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < 10; i4++) {
            ...
            G(iArr[bArr2[i4][2]], iArr[bArr2[i4][3]], 1, 5, 9, 13);
            G(iArr[bArr2[i4][4]], iArr[bArr2[i4][5]], 2, 6, 10, 14);
            G(iArr[bArr2[i4][6]], iArr[bArr2[i4][7]], 3, 7, 11, 15);
            G(iArr[bArr2[i4][8]], iArr[bArr2[i4][9]], 0, 5, 10, 15);
            G(iArr[bArr2[i4][10]], iArr[bArr2[i4][11]], 1, 6, 11, 12);
            G(iArr[bArr2[i4][12]], iArr[bArr2[i4][13]], 2, 7, 8, 13);
            G(iArr[bArr2[i4][14]], iArr[bArr2[i4][15]], 3, 4, 9, 14);
        }
        while (true) {
