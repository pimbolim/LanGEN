...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    /* JADX WARNING: type inference failed for: r15v6, types: [org.bouncycastle.asn1.ASN1Primitive] */
    ...
    private void populateFromPubKeyInfo(org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r15) {
        ...
        L_0x013c:
            ...
            r1.<init>()
            int r1 = r1.getByteLength((org.bouncycastle.math.ec.ECCurve) r6)
            int r4 = r15.length
            int r4 = r4 - r3
            if (r1 < r4) goto L_0x0157
            org.bouncycastle.asn1.ASN1Primitive r15 = org.bouncycastle.asn1.ASN1Primitive.fromByteArray(r15)     // Catch:{ IOException -> 0x0151 }
            r0 = r15
        ...
        L_0x0157:
            ...
            r15.<init>((org.bouncycastle.math.ec.ECCurve) r6, (org.bouncycastle.asn1.ASN1OctetString) r0)
