...
class RFC3280CertPathUtilities {
    ...
    protected static void checkCRLs(org.bouncycastle.jcajce.PKIXCertRevocationCheckerParameters r23, org.bouncycastle.jcajce.PKIXExtendedParameters r24, java.util.Date r25, java.util.Date r26, java.security.cert.X509Certificate r27, java.security.cert.X509Certificate r28, java.security.PublicKey r29, java.util.List r30, org.bouncycastle.jcajce.util.JcaJceHelper r31) throws org.bouncycastle.jce.provider.AnnotatedException, org.bouncycastle.jce.provider.RecoverableCertPathValidatorException {
        /*
            java.lang.String r0 = CRL_DISTRIBUTION_POINTS     // Catch:{ Exception -> 0x019b }
            r13 = r27
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r13, r0)     // Catch:{ Exception -> 0x019b }
            ...
            java.util.Map r2 = r24.getNamedCRLStoreMap()     // Catch:{ AnnotatedException -> 0x0192 }
            r15 = r26
            r12 = r31
            java.util.List r2 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getAdditionalStoresFromCRLDistributionPoint(r0, r2, r15, r12)     // Catch:{ AnnotatedException -> 0x0192 }
        ...
        L_0x0033:
            ...
            org.bouncycastle.asn1.x509.DistributionPoint[] r7 = r0.getDistributionPoints()     // Catch:{ Exception -> 0x00a6 }
        ...
        L_0x0053:
            ...
            r2 = r7[r6]     // Catch:{ AnnotatedException -> 0x0089 }
            r1 = r23
            r3 = r17
            r4 = r25
            r5 = r26
            ...
            r11 = r30
            r12 = r31
            checkCRL(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12)     // Catch:{ AnnotatedException -> 0x0087 }
            r19 = 1
            goto L_0x0092
        L_0x0087:
            r0 = move-exception
        ...
        L_0x00b7:
            ...
            org.bouncycastle.asn1.x500.X500Name r1 = org.bouncycastle.jce.provider.PrincipalUtils.getIssuerPrincipal((java.security.cert.X509Certificate) r27)     // Catch:{ RuntimeException -> 0x00ff }
            org.bouncycastle.asn1.x509.DistributionPoint r2 = new org.bouncycastle.asn1.x509.DistributionPoint     // Catch:{ AnnotatedException -> 0x00fd }
            org.bouncycastle.asn1.x509.DistributionPointName r3 = new org.bouncycastle.asn1.x509.DistributionPointName     // Catch:{ AnnotatedException -> 0x00fd }
            org.bouncycastle.asn1.x509.GeneralNames r4 = new org.bouncycastle.asn1.x509.GeneralNames     // Catch:{ AnnotatedException -> 0x00fd }
            org.bouncycastle.asn1.x509.GeneralName r5 = new org.bouncycastle.asn1.x509.GeneralName     // Catch:{ AnnotatedException -> 0x00fd }
            r6 = 4
            r5.<init>((int) r6, (org.bouncycastle.asn1.ASN1Encodable) r1)     // Catch:{ AnnotatedException -> 0x00fd }
            r4.<init>((org.bouncycastle.asn1.x509.GeneralName) r5)     // Catch:{ AnnotatedException -> 0x00fd }
            r1 = 0
            r3.<init>(r1, r4)     // Catch:{ AnnotatedException -> 0x00fd }
            r1 = 0
            r2.<init>(r3, r1, r1)     // Catch:{ AnnotatedException -> 0x00fd }
            java.lang.Object r1 = r24.clone()     // Catch:{ AnnotatedException -> 0x00fd }
            r3 = r1
            org.bouncycastle.jcajce.PKIXExtendedParameters r3 = (org.bouncycastle.jcajce.PKIXExtendedParameters) r3     // Catch:{ AnnotatedException -> 0x00fd }
            r1 = r23
            r4 = r25
            r5 = r26
            r6 = r27
            ...
            r11 = r30
            r12 = r31
            checkCRL(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12)     // Catch:{ AnnotatedException -> 0x00fd }
            goto L_0x010b
        L_0x00fd:
            r0 = move-exception
            goto L_0x0109
        L_0x00ff:
            r0 = move-exception
            r1 = r0
            org.bouncycastle.jce.provider.AnnotatedException r0 = new org.bouncycastle.jce.provider.AnnotatedException     // Catch:{ AnnotatedException -> 0x00fd }
            java.lang.String r2 = "Issuer from certificate for CRL could not be reencoded."
            r0.<init>(r2, r1)     // Catch:{ AnnotatedException -> 0x00fd }
            throw r0     // Catch:{ AnnotatedException -> 0x00fd }
        L_0x0109:
            r18 = r19
        L_0x010b:
