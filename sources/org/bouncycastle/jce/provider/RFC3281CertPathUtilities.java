...
class RFC3281CertPathUtilities {
    ...
    protected static void checkCRLs(org.bouncycastle.x509.X509AttributeCertificate r20, org.bouncycastle.jcajce.PKIXExtendedParameters r21, java.util.Date r22, java.util.Date r23, java.security.cert.X509Certificate r24, java.util.List r25, org.bouncycastle.jcajce.util.JcaJceHelper r26) throws java.security.cert.CertPathValidatorException {
        /*
            ...
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r11, r0)     // Catch:{ AnnotatedException -> 0x0186 }
            ...
            r1.<init>()
            java.util.Map r2 = r21.getNamedCRLStoreMap()     // Catch:{ AnnotatedException -> 0x017d }
            r12 = r23
            r13 = r26
            java.util.List r2 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getAdditionalStoresFromCRLDistributionPoint(r0, r2, r12, r13)     // Catch:{ AnnotatedException -> 0x017d }
        ...
        L_0x0046:
            ...
            org.bouncycastle.asn1.x509.DistributionPoint[] r0 = r0.getDistributionPoints()     // Catch:{ Exception -> 0x00ae }
            r6 = 0
            r18 = 0
        L_0x0065:
            int r1 = r0.length     // Catch:{ AnnotatedException -> 0x00a5 }
            if (r6 >= r1) goto L_0x00a2
            int r1 = r15.getCertStatus()     // Catch:{ AnnotatedException -> 0x00a5 }
            if (r1 != r7) goto L_0x00a2
            boolean r1 = r16.isAllReasons()     // Catch:{ AnnotatedException -> 0x00a5 }
            if (r1 != 0) goto L_0x00a2
            java.lang.Object r1 = r14.clone()     // Catch:{ AnnotatedException -> 0x00a5 }
            r3 = r1
            org.bouncycastle.jcajce.PKIXExtendedParameters r3 = (org.bouncycastle.jcajce.PKIXExtendedParameters) r3     // Catch:{ AnnotatedException -> 0x00a5 }
            r1 = r0[r6]     // Catch:{ AnnotatedException -> 0x00a5 }
            r2 = r20
            r4 = r22
            r5 = r23
            r19 = r6
            ...
            r12 = r10
            r10 = r26
            checkCRL(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10)     // Catch:{ AnnotatedException -> 0x00a0 }
            int r6 = r19 + 1
            r10 = r12
            r7 = 11
            r8 = 0
        ...
        L_0x00bc:
            ...
            org.bouncycastle.asn1.x500.X500Name r1 = org.bouncycastle.jce.provider.PrincipalUtils.getEncodedIssuerPrincipal(r20)     // Catch:{ Exception -> 0x0102 }
            org.bouncycastle.asn1.x509.DistributionPoint r2 = new org.bouncycastle.asn1.x509.DistributionPoint     // Catch:{ AnnotatedException -> 0x0100 }
            org.bouncycastle.asn1.x509.DistributionPointName r3 = new org.bouncycastle.asn1.x509.DistributionPointName     // Catch:{ AnnotatedException -> 0x0100 }
            org.bouncycastle.asn1.x509.GeneralNames r4 = new org.bouncycastle.asn1.x509.GeneralNames     // Catch:{ AnnotatedException -> 0x0100 }
            org.bouncycastle.asn1.x509.GeneralName r5 = new org.bouncycastle.asn1.x509.GeneralName     // Catch:{ AnnotatedException -> 0x0100 }
            r6 = 4
            r5.<init>((int) r6, (org.bouncycastle.asn1.ASN1Encodable) r1)     // Catch:{ AnnotatedException -> 0x0100 }
            r4.<init>((org.bouncycastle.asn1.x509.GeneralName) r5)     // Catch:{ AnnotatedException -> 0x0100 }
            r1 = 0
            r3.<init>(r1, r4)     // Catch:{ AnnotatedException -> 0x0100 }
            r1 = 0
            r2.<init>(r3, r1, r1)     // Catch:{ AnnotatedException -> 0x0100 }
            java.lang.Object r1 = r14.clone()     // Catch:{ AnnotatedException -> 0x0100 }
            r3 = r1
            org.bouncycastle.jcajce.PKIXExtendedParameters r3 = (org.bouncycastle.jcajce.PKIXExtendedParameters) r3     // Catch:{ AnnotatedException -> 0x0100 }
            r1 = r2
            r2 = r20
            r4 = r22
            r5 = r23
            ...
            r9 = r25
            r10 = r26
            checkCRL(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10)     // Catch:{ AnnotatedException -> 0x0100 }
            goto L_0x0114
        L_0x0100:
            r0 = move-exception
            goto L_0x010c
