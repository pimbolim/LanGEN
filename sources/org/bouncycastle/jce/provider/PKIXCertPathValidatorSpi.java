                            ...
                            if (build.getTargetConstraints() == null || build.getTargetConstraints().match((Certificate) (X509Certificate) certificates.get(0))) {
                                ...
                                while (size2 >= 0) {
                                    ...
                                    try {
                                        ...
                                        int i20 = i17;
                                        RFC3280CertPathUtilities.processCertA(certPath, build, date, provCrlRevocationChecker2, i16, publicKey, z2, x500Name, trustedCert);
                                        int i21 = i16;
                                        ...
                                        if (i19 != i22) {
                                            ...
                                            } else if (i19 != 1 || !x509Certificate2.equals(trustAnchor2.getTrustedCert())) {
