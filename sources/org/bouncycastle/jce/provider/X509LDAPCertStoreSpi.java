...
public class X509LDAPCertStoreSpi extends CertStoreSpi {
    ...
    private Set certSubjectSerialSearch(X509CertSelector x509CertSelector, String[] strArr, String str, String str2) throws CertStoreException {
        ...
        try {
            ...
            hashSet.addAll(search(str, ProxyConfig.MATCH_ALL_SCHEMES + parseDN(str4, str2) + ProxyConfig.MATCH_ALL_SCHEMES, strArr));
    ...
    private Set getCACertificates(X509CertSelector x509CertSelector) throws CertStoreException {
        ...
        if (certSubjectSerialSearch.isEmpty()) {
            certSubjectSerialSearch.addAll(search((String) null, ProxyConfig.MATCH_ALL_SCHEMES, strArr));
        }
        ...
        if (cRLSelector instanceof X509CRLSelector) {
            ...
            if (x509CRLSelector.getIssuerNames() != null) {
                for (Object next : x509CRLSelector.getIssuerNames()) {
                    ...
                    hashSet2.addAll(search(ldapCertificateRevocationListAttributeName, ProxyConfig.MATCH_ALL_SCHEMES + parseDN + ProxyConfig.MATCH_ALL_SCHEMES, strArr));
                }
            } else {
                hashSet2.addAll(search(ldapCertificateRevocationListAttributeName, ProxyConfig.MATCH_ALL_SCHEMES, strArr));
            }
            hashSet2.addAll(search((String) null, ProxyConfig.MATCH_ALL_SCHEMES, strArr));
            try {
