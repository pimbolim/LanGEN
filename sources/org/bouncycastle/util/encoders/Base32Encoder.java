...
public class Base32Encoder implements Encoder {
    ...
    private void encodeBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i5 = i4 + 1;
        byte b3 = bArr[i4] & UByte.MAX_VALUE;
        int i6 = i5 + 1;
        byte b4 = bArr[i5] & UByte.MAX_VALUE;
        byte b5 = bArr[i6] & UByte.MAX_VALUE;
        int i7 = i2 + 1;
    ...
    public int decode(byte[] bArr, int i, int i2, OutputStream outputStream) throws IOException {
        ...
        int i26 = i25;
        int nextI9 = nextI(bArr2, nextI, i26);
        int nextI10 = nextI(bArr2, nextI9 + 1, i26);
        ...
        return i8 + decodeLastBlock(outputStream, (char) bArr2[nextI9], (char) bArr2[nextI10], (char) bArr2[nextI11], (char) bArr2[nextI12], (char) bArr2[nextI13], (char) bArr2[nextI14], (char) bArr2[nextI15], (char) bArr2[nextI(bArr2, nextI15 + 1, i26)]);
    }
