...
class LongArray implements Cloneable {
    ...
    private static int reduceInPlace(long[] jArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (min2 > 1) {
            int i13 = i10 - min2;
            reduceVectorWise(jArr, i, i10, i13, i3, iArr);
            while (i10 > i13) {
                i10--;
                jArr2[i4 + i10] = 0;
            }
        ...
        if (min > max) {
            reduceWordWise(jArr, i, i10, max, i3, iArr);
        } else {
            max = min;
        }
        if (max > i6) {
            reduceBitWise(jArr, i, max, i6, iArr2);
        }
        return i7;
    }
    ...
    public LongArray modInverse(int i, int[] iArr) {
        ...
        if (degree != 0) {
            ...
            while (true) {
                ...
                int i10 = 1 - i2;
                longArrayArr[i2].addShiftedByBitsSafe(longArrayArr[i10], iArr2[i10], i6);
                int degreeFrom = longArrayArr[i2].degreeFrom(i4);
                if (degreeFrom == 0) {
                    return longArrayArr2[i10];
                }
                int i11 = iArr3[i10];
                longArrayArr2[i2].addShiftedByBitsSafe(longArrayArr2[i10], i11, i6);
                int i12 = i11 + i6;
                if (i12 > i5) {
                    i5 = i12;
                } else if (i12 == i5) {
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i7 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i8, jArr2, 0);
            return reduceResult(jArr2, 0, i9, i6, iArr2);
        }
        int i10 = ((i2 + 7) + 63) >>> 6;
        ...
        iArr3[1] = i10;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i10, i8);
        int i12 = 2;
        int i13 = i10;
        for (int i14 = 16; i12 < i14; i14 = 16) {
            ...
            if ((i12 & 1) == 0) {
                jArr = jArr3;
                i5 = i11;
                shiftUp(jArr3, i13 >>> 1, jArr3, i13, i10, 1);
            } else {
                jArr = jArr3;
                i5 = i11;
                add(jArr, i10, jArr3, i13 - i10, jArr, i13, i10);
            }
            i12++;
            i11 = i5;
            jArr3 = jArr;
        ...
        while (i17 < i7) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                i4 = i17;
                addBoth(jArr7, i18, jArr4, iArr3[((int) j2) & 15], jArr5, iArr3[((int) j3) & 15], i10);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            i16 -= i9;
            if (i16 == 0) {
                return reduceResult(jArr7, 0, i9, i6, iArr2);
            }
            addShiftedUp(jArr7, i16 - i9, jArr7, i16, i9, 8);
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i7 == 1) {
            ...
            multiplyWord(j, longArray2.m_ints, i8, jArr, 0);
            return reduceResult(jArr, 0, i9, i6, iArr2);
        }
        int i10 = 15;
        int i11 = ((i2 + 15) + 63) >>> 6;
        int i12 = i11 * 8;
        ...
        int[] iArr4 = iArr3;
        int i15 = i12;
        interleave(jArr3, 0, jArr2, 0, i7, 4);
        System.arraycopy(longArray2.m_ints, 0, jArr2, i7, i8);
        int i16 = i7;
        int i17 = 1;
        while (i17 < 8) {
            int i18 = i16 + i11;
            shiftUp(jArr2, i7, jArr2, i18, i11, i17);
            i17++;
            i16 = i18;
        }
        int i19 = 0;
        while (true) {
            ...
            do {
                ...
                while (true) {
                    int i23 = ((int) j2) & i10;
                    if (i23 != 0) {
                        add(jArr2, iArr4[i23] + i20, jArr2, i21, i11);
                    }
                    i4 = 1;
                    i22++;
                    if (i22 == 8) {
        ...
        while (true) {
            int i26 = i25 - 1;
            if (i26 <= i4) {
                return reduceResult(jArr2, iArr4[1], i9, i6, iArr2);
            }
            if ((((long) i26) & 1) == 0) {
                addShiftedUp(jArr2, iArr4[i26 >>> 1], jArr2, iArr4[i26], i9, 16);
            } else {
                distribute(jArr2, iArr4[i26], iArr4[i26 - 1], iArr4[1], i9);
            }
            i25 = i26;
            i4 = 1;
        }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        if (i6 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i7, jArr2, 0);
            return reduceResult(jArr2, 0, i8, i5, iArr2);
        }
        int i9 = ((i2 + 7) + 63) >>> 6;
        int[] iArr3 = new int[16];
        int i10 = i9 << 4;
        ...
        iArr3[1] = i9;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i9, i7);
        int i11 = 2;
        int i12 = i9;
        while (i11 < 16) {
            i12 += i9;
            ...
            if ((i11 & 1) == 0) {
                jArr = jArr3;
                i4 = i10;
                shiftUp(jArr3, i12 >>> 1, jArr3, i12, i9, 1);
            } else {
                jArr = jArr3;
                i4 = i10;
                add(jArr, i9, jArr3, i12 - i9, jArr, i12, i9);
            }
            i11++;
            i10 = i4;
            jArr3 = jArr;
        ...
        for (int i14 = 56; i14 >= 0; i14 -= 8) {
            for (int i15 = 1; i15 < i6; i15 += 2) {
                ...
                addBoth(jArr7, i15 - 1, jArr4, iArr3[i16 & 15], jArr5, iArr3[(i16 >>> 4) & 15], i9);
            }
            shiftUp(jArr7, 0, i8, 8);
        }
        for (int i17 = 56; i17 >= 0; i17 -= 8) {
            for (int i18 = 0; i18 < i6; i18 += 2) {
                int i19 = (int) (jArr6[i18] >>> i17);
                addBoth(jArr7, i18, jArr4, iArr3[i19 & 15], jArr5, iArr3[(i19 >>> 4) & 15], i9);
            }
            if (i17 > 0) {
                shiftUp(jArr7, 0, i8, 8);
            }
        }
        return reduceResult(jArr7, 0, i8, i5, iArr2);
    }
    ...
    public LongArray modSquare(int i, int[] iArr) {
        ...
        return new LongArray(jArr, 0, reduceInPlace(jArr, 0, i2, i, iArr));
    }
    ...
    public LongArray modSquareN(int i, int i2, int[] iArr) {
        ...
        while (true) {
            ...
            usedLength = reduceInPlace(jArr, 0, i3, i2, iArr);
        }
    }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        if (i5 == 1) {
            ...
            multiplyWord(j, longArray3.m_ints, i6, jArr2, 0);
            return new LongArray(jArr2, 0, i7);
        }
        int i8 = ((i2 + 7) + 63) >>> 6;
        ...
        iArr2[1] = i8;
        System.arraycopy(longArray3.m_ints, 0, jArr3, i8, i6);
        int i10 = 2;
        int i11 = i8;
        for (int i12 = 16; i10 < i12; i12 = 16) {
            ...
            if ((i10 & 1) == 0) {
                jArr = jArr3;
                i4 = i9;
                shiftUp(jArr3, i11 >>> 1, jArr3, i11, i8, 1);
            } else {
                jArr = jArr3;
                i4 = i9;
                add(jArr, i8, jArr, i11 - i8, jArr3, i11, i8);
            }
            i10++;
            i9 = i4;
            jArr3 = jArr;
        ...
        for (int i15 = 0; i15 < i5; i15++) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                addBoth(jArr7, i16, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[((int) j3) & 15], i8);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            i14 -= i7;
            if (i14 == 0) {
                return new LongArray(jArr7, 0, i7);
            }
            addShiftedUp(jArr7, i14 - i7, jArr7, i14, i7, 8);
        }
    }
    ...
    public LongArray square(int i, int[] iArr) {
        ...
        return new LongArray(jArr, 0, i2);
    }
