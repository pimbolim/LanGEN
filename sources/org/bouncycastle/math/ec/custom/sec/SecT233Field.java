...
public class SecT233Field {
    ...
    protected static void implMulwAcc(long[] jArr, long j, long j2, long[] jArr2, int i) {
        ...
        do {
            int i4 = (int) (j3 >>> i3);
            long j6 = (jArr[(i4 >>> 3) & 7] << 3) ^ jArr[i4 & 7];
            j4 ^= j6 << i3;
            j5 ^= j6 >>> (-i3);
            i3 -= 6;
        } while (i3 > 0);
        jArr2[i] = jArr2[i] ^ (M59 & j4);
        int i5 = i + 1;
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        for (int i2 = 3; i < i2; i2 = 3) {
            int i3 = iArr[i] >>> 6;
            int i4 = iArr[i] & 63;
            createExt64[i3] = createExt64[i3] ^ (j7 << i4);
            int i5 = i3 + 1;
            int i6 = -i4;
            createExt64[i5] = createExt64[i5] ^ ((j6 << i4) | (j7 >>> i6));
            int i7 = i3 + 2;
            createExt64[i7] = createExt64[i7] ^ ((j5 << i4) | (j6 >>> i6));
            int i8 = i3 + 3;
            createExt64[i8] = createExt64[i8] ^ (j5 >>> i6);
            i++;
        }
        reduce(createExt64, jArr3);
        jArr3[0] = jArr3[0] ^ j;
