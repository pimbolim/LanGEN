...
public abstract class Nat160 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 5; i < i3; i3 = 5) {
            ...
            int i4 = i + 0;
            long j14 = (j13 * j) + (((long) iArr3[i4]) & M) + 0;
            iArr3[i4] = (int) j14;
            int i5 = i + 1;
            long j15 = j2;
            long j16 = (j14 >>> 32) + (j13 * j2) + (((long) iArr3[i5]) & M);
            iArr3[i5] = (int) j16;
            int i6 = i + 2;
            long j17 = j5;
            long j18 = (j16 >>> 32) + (j13 * j6) + (((long) iArr3[i6]) & M);
            iArr3[i6] = (int) j18;
            int i7 = i + 3;
            long j19 = (j18 >>> 32) + (j13 * j4) + (((long) iArr3[i7]) & M);
            iArr3[i7] = (int) j19;
            int i8 = i + 4;
            long j20 = (j19 >>> 32) + (j13 * j17) + (((long) iArr3[i8]) & M);
            iArr3[i8] = (int) j20;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i25 = (int) j37;
                iArr2[i21] = (i24 >>> 31) | (i25 << 1);
                int i26 = i25 >>> 31;
                int i27 = (int) j38;
                iArr2[i20] = i26 | (i27 << 1);
                int i28 = i27 >>> 31;
                int i29 = i2 + 9;
                iArr2[i29] = i28 | ((iArr2[i29] + ((int) (j38 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
