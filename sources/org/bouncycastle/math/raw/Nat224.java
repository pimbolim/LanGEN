...
public abstract class Nat224 {
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i6 < 7) {
            ...
            int i7 = i5 + 0;
            long j19 = (j18 * j10) + (((long) iArr3[i7]) & M) + 0;
            iArr3[i7] = (int) j19;
            int i8 = i5 + 1;
            long j20 = j6;
            long j21 = (j19 >>> 32) + (j18 * j12) + (((long) iArr3[i8]) & M);
            iArr3[i8] = (int) j21;
            int i9 = i5 + 2;
            long j22 = (j21 >>> 32) + (j18 * j3) + (((long) iArr3[i9]) & M);
            iArr3[i9] = (int) j22;
            int i10 = i5 + 3;
            long j23 = (j22 >>> 32) + (j18 * j4) + (((long) iArr3[i10]) & M);
            iArr3[i10] = (int) j23;
            int i11 = i5 + 4;
            long j24 = (j23 >>> 32) + (j18 * j5) + (((long) iArr3[i11]) & M);
            iArr3[i11] = (int) j24;
            int i12 = i5 + 5;
            long j25 = (j24 >>> 32) + (j18 * j20) + (((long) iArr3[i12]) & M);
            iArr3[i12] = (int) j25;
            int i13 = i5 + 6;
            long j26 = (j25 >>> 32) + (j18 * j7) + (((long) iArr3[i13]) & M);
            iArr3[i13] = (int) j26;
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 7; i2 < i3; i3 = 7) {
            long j17 = ((long) iArr[i2]) & M;
            int i4 = i2 + 0;
            long j18 = (j17 * j) + (((long) iArr3[i4]) & M) + 0;
            iArr3[i4] = (int) j18;
            int i5 = i2 + 1;
            long j19 = j2;
            long j20 = (j18 >>> 32) + (j17 * j2) + (((long) iArr3[i5]) & M);
            iArr3[i5] = (int) j20;
            int i6 = i2 + 2;
            long j21 = j7;
            long j22 = (j20 >>> 32) + (j17 * j6) + (((long) iArr3[i6]) & M);
            iArr3[i6] = (int) j22;
            int i7 = i2 + 3;
            long j23 = (j22 >>> 32) + (j17 * j4) + (((long) iArr3[i7]) & M);
            iArr3[i7] = (int) j23;
            int i8 = i2 + 4;
            long j24 = (j23 >>> 32) + (j17 * j5) + (((long) iArr3[i8]) & M);
            iArr3[i8] = (int) j24;
            int i9 = i2 + 5;
            long j25 = (j24 >>> 32) + (j17 * j21) + (((long) iArr3[i9]) & M);
            iArr3[i9] = (int) j25;
            int i10 = i2 + 6;
            long j26 = (j25 >>> 32) + (j17 * j8) + (((long) iArr3[i10]) & M);
            iArr3[i10] = (int) j26;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i42 = i41 >>> 31;
                int i43 = i2 + 13;
                iArr2[i43] = i42 | ((iArr2[i43] + ((int) (j71 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
