...
public abstract class Nat {
    ...
    public static int addBothTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            int i7 = i4 + i6;
            long j2 = j + (((long) iArr[i2 + i6]) & M) + (((long) iArr2[i3 + i6]) & M) + (M & ((long) iArr3[i7]));
            iArr3[i7] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i3 + i5;
            long j2 = j + (((long) iArr[i2 + i5]) & M) + (((long) iArr2[i6]) & M);
            iArr2[i6] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int addToEachOther(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            int i5 = i2 + i4;
            int i6 = i3 + i4;
            long j2 = j + (((long) iArr[i5]) & M) + (M & ((long) iArr2[i6]));
            int i7 = (int) j2;
            iArr[i5] = i7;
            iArr2[i6] = i7;
            j = j2 >>> 32;
    ...
    public static int cadd(int i, int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            long j3 = j2 + (((long) iArr[i3]) & M) + (((long) iArr2[i3]) & j);
            iArr3[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int csub(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i7 = 0; i7 < i6; i7++) {
            long j3 = j2 + ((((long) iArr[i3 + i7]) & M) - (((long) iArr2[i4 + i7]) & j));
            iArr3[i5 + i7] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static int lessThan(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        long j = 0;
        for (int i4 = 0; i4 < i; i4++) {
            j = (j + ((((long) iArr[i2 + i4]) & M) - (M & ((long) iArr2[i3 + i4])))) >> 32;
        }
        return (int) j;
    }
    ...
    public static int lessThan(int i, int[] iArr, int[] iArr2) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            j = (j + ((((long) iArr[i2]) & M) - (M & ((long) iArr2[i2])))) >> 32;
        }
        return (int) j;
    }
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i;
            long mulWordAddTo = j + (((long) mulWordAddTo(i, iArr[i2 + i5], iArr2, i3, iArr3, i4)) & M) + (((long) iArr3[i6]) & M);
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long mulWordAddTo = j + (((long) mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2)) & M);
            int i3 = i2 + i;
            long j2 = mulWordAddTo + (((long) iArr3[i3]) & M);
            iArr3[i3] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        int i10 = i3 + 2;
        while (i4 < i) {
            long squareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, i4, iArr2, i3)) & M) + (((long) iArr2[i10]) & M);
            int i11 = i10 + 1;
            iArr2[i10] = (int) squareWordAddTo;
            long j4 = (squareWordAddTo >>> 32) + (((long) iArr2[i11]) & M);
            iArr2[i11] = (int) j4;
            j3 = j4 >>> 32;
            i4++;
            i10 = i11 + 1;
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        int i9 = 2;
        while (i2 < i) {
            long squareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, iArr2)) & M) + (((long) iArr2[i9]) & M);
            int i10 = i9 + 1;
            iArr2[i9] = (int) squareWordAddTo;
            long j4 = (squareWordAddTo >>> 32) + (((long) iArr2[i10]) & M);
            iArr2[i10] = (int) j4;
            j3 = j4 >>> 32;
            i2++;
            i9 = i10 + 1;
    ...
    public static int squareWordAdd(int[] iArr, int i, int i2, int[] iArr2, int i3) {
        int i4 = i2;
        long j = ((long) iArr[i + i4]) & M;
        long j2 = 0;
        int i5 = 0;
        int i6 = i3;
        do {
            int i7 = i4 + i6;
            long j3 = j2 + ((((long) iArr[i + i5]) & M) * j) + (((long) iArr2[i7]) & M);
            iArr2[i7] = (int) j3;
            j2 = j3 >>> 32;
            i6++;
            i5++;
    ...
    public static int subBothFrom(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            int i7 = i4 + i6;
            long j2 = j + (((((long) iArr3[i7]) & M) - (((long) iArr[i2 + i6]) & M)) - (M & ((long) iArr2[i3 + i6])));
            iArr3[i7] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
