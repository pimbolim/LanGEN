...
public class PolynomialGF2mSmallM {
    ...
    private int[] multiply(int[] iArr, int[] iArr2) {
        ...
        if (length2 != length) {
            ...
            System.arraycopy(normalForm, length2, iArr6, 0, i);
        ...
        System.arraycopy(normalForm, 0, iArr7, 0, i2);
        System.arraycopy(normalForm, i2, iArr9, 0, i3);
        System.arraycopy(normalForm2, 0, iArr8, 0, i2);
        System.arraycopy(normalForm2, i2, iArr10, 0, i3);
