...
class NTT {
        ...
        for (int i = 0; i < 10; i += 2) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                while (i4 < 1023) {
                    ...
                    int i6 = i4 + i2;
                    short s2 = sArr[i6] & UShort.MAX_VALUE;
                    int i7 = i5 + 1;
                    short s3 = sArr2[i5];
                    sArr[i4] = (short) (s + s2);
                    sArr[i6] = Reduce.montgomery(s3 * ((s + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - s2));
                    i4 += i2 * 2;
                    i5 = i7;
                }
            }
            ...
            for (int i9 = 0; i9 < i8; i9++) {
                ...
                int i11 = 0;
                while (i10 < 1023) {
                    short s4 = sArr[i10] & UShort.MAX_VALUE;
                    int i12 = i10 + i8;
                    short s5 = sArr[i12] & UShort.MAX_VALUE;
                    int i13 = i11 + 1;
                    short s6 = sArr2[i11];
                    sArr[i10] = Reduce.barrett((short) (s4 + s5));
                    sArr[i12] = Reduce.montgomery(s6 * ((s4 + ExifDirectoryBase.TAG_DATETIME_ORIGINAL) - s5));
                    i10 += i8 * 2;
                    i11 = i13;
                }
            }
    ...
    static void mulCoefficients(short[] sArr, short[] sArr2) {
        for (int i = 0; i < 1024; i++) {
            sArr[i] = Reduce.montgomery((sArr[i] & UShort.MAX_VALUE) * (65535 & sArr2[i]));
        }
    }
}
