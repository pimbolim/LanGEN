...
class ErrorCorrection {
    ...
    static void helpRec(short[] sArr, short[] sArr2, byte[] bArr, byte b) {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            int i5 = i + 512;
            int i6 = i + 768;
            int f = (24577 - (((f(iArr, 0, 4, (sArr2[i2] * 8) + i3) + f(iArr, 1, 5, (sArr2[i4] * 8) + i3)) + f(iArr, 2, 6, (sArr2[i5] * 8) + i3)) + f(iArr, 3, 7, (sArr2[i6] * 8) + i3))) >> 31;
            int i7 = ~f;
    ...
    static void rec(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int i = 0; i < 256; i++) {
            int i2 = i + 0;
            int i3 = i + 768;
            iArr[0] = ((sArr[i2] * 8) + 196624) - (((sArr2[i2] * 2) + sArr2[i3]) * CasioType2MakernoteDirectory.TAG_SELF_TIMER);
            int i4 = i + 256;
            iArr[1] = ((sArr[i4] * 8) + 196624) - (((sArr2[i4] * 2) + sArr2[i3]) * CasioType2MakernoteDirectory.TAG_SELF_TIMER);
            int i5 = i + 512;
            iArr[2] = ((sArr[i5] * 8) + 196624) - (((sArr2[i5] * 2) + sArr2[i3]) * CasioType2MakernoteDirectory.TAG_SELF_TIMER);
