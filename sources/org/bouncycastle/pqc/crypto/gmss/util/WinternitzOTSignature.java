        ...
        if (8 % i5 == 0) {
            ...
            while (i17 < i15) {
                ...
                for (int i21 = 0; i21 < this.w; i21++) {
                    j ^= (long) ((bArr4[i18] & UByte.MAX_VALUE) << (i21 << 3));
                    i18++;
                }
                long j2 = j;
                int i22 = 0;
            ...
            for (int i25 = 0; i25 < i24; i25++) {
                j3 ^= (long) ((bArr4[i18] & UByte.MAX_VALUE) << (i25 << 3));
                i18++;
            }
            int i26 = i24 << 3;
            int i27 = 0;
            ...
            while (i35 <= i33) {
                ...
                long j4 = 0;
                while (i38 < i40) {
                    j4 ^= (long) ((bArr4[i38] & UByte.MAX_VALUE) << (i41 << 3));
                    i41++;
                    i38++;
                    bArr4 = bArr4;
                    i33 = i33;
            ...
            if (i44 < this.mdsize) {
                ...
                while (true) {
                    ...
                    j6 ^= (long) ((bArr7[i44] & UByte.MAX_VALUE) << (i46 << 3));
                    i46++;
                    i44++;
                }
