    ...
    public static HSSPrivateKeyParameters generateHSSKeyPair(HSSKeyGenerationParameters hSSKeyGenerationParameters) {
        ...
        while (i2 < depth) {
            if (i2 == 0) {
                ...
                LMSigParameters lMSigParam = hSSKeyGenerationParameters.getLmsParameters()[i2].getLMSigParam();
                LMOtsParameters lMOTSParam = hSSKeyGenerationParameters.getLmsParameters()[i2].getLMOTSParam();
                int h = 1 << hSSKeyGenerationParameters.getLmsParameters()[i2].getLMSigParam().getH();
                i = i2;
                LMSigParameters lMSigParameters = lMSigParam;
                bArr = bArr4;
                lMSPrivateKeyParametersArr[i] = new PlaceholderLMSPrivateKey(lMSigParameters, lMOTSParam, -1, bArr, h, bArr);
            }
