...
public class SPHINCS256Signer implements MessageSigner {
    ...
    static void compute_authpath_wots(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, Tree.leafaddr leafaddr, byte[] bArr3, byte[] bArr4, int i2) {
        ...
        leafaddr3.subleaf = 0;
        while (leafaddr3.subleaf < 32) {
            Tree.l_tree(hashFunctions2, bArr5, (int) ((leafaddr3.subleaf * 32) + PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID), bArr7, (int) (leafaddr3.subleaf * 67 * 32), bArr4, 0);
            leafaddr3.subleaf++;
        }
        int i3 = 0;
    ...
    public byte[] crypto_sign(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2) {
        ...
        byte[] bArr10 = new byte[PhotoshopDirectory.TAG_PATH_SELECTION_STATE];
        ...
        messageHash2.update(bArr4, 39912, PhotoshopDirectory.TAG_PATH_SELECTION_STATE);
        ...
        zerobytes(bArr21, 0, PhotoshopDirectory.TAG_PATH_SELECTION_STATE);
        return bArr4;
    }
