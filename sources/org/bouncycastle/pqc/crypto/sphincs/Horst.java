...
class Horst {
    ...
    static int horst_verify(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, int i, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i18 = 0; i18 < 32; i18++) {
            ...
            byte[] bArr7 = bArr6;
            hashFunctions3.hash_2n_n_mask(bArr7, i18 * 32, bArr2, i3 + (i18 * 2 * 32), bArr3, OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE);
        }
        ...
        for (int i20 = 0; i20 < 8; i20++) {
            ...
            byte[] bArr9 = bArr6;
            hashFunctions5.hash_2n_n_mask(bArr9, i20 * 32, bArr6, i20 * 2 * 32, bArr3, 768);
        }
        for (int i21 = 0; i21 < 4; i21++) {
            HashFunctions hashFunctions6 = hashFunctions;
            byte[] bArr10 = bArr6;
            hashFunctions6.hash_2n_n_mask(bArr10, i21 * 32, bArr6, i21 * 2 * 32, bArr3, LeicaMakernoteDirectory.TAG_IMAGE_ID_NUMBER);
        }
