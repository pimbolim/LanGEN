...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        id_fieldType = branch;
        prime_field = branch.branch(ThreeDSecureRequest.VERSION_1);
        ...
        ecdsa_with_SHA1 = branch3.branch(ThreeDSecureRequest.VERSION_1);
        ASN1ObjectIdentifier branch4 = aSN1ObjectIdentifier.branch("2");
        id_publicKeyType = branch4;
        id_ecPublicKey = branch4.branch(ThreeDSecureRequest.VERSION_1);
        ASN1ObjectIdentifier branch5 = branch3.branch(ExifInterface.GPS_MEASUREMENT_3D);
        ecdsa_with_SHA2 = branch5;
        ecdsa_with_SHA224 = branch5.branch(ThreeDSecureRequest.VERSION_1);
        ...
        ASN1ObjectIdentifier branch6 = aSN1ObjectIdentifier.branch(ExifInterface.GPS_MEASUREMENT_3D);
        ellipticCurve = branch6;
        ASN1ObjectIdentifier branch7 = branch6.branch("0");
        cTwoCurve = branch7;
        c2pnb163v1 = branch7.branch(ThreeDSecureRequest.VERSION_1);
        ...
        ASN1ObjectIdentifier branch8 = branch6.branch(ThreeDSecureRequest.VERSION_1);
        primeCurve = branch8;
        prime192v1 = branch8.branch(ThreeDSecureRequest.VERSION_1);
        ...
        ASN1ObjectIdentifier branch9 = aSN1ObjectIdentifier3.branch(ExifInterface.GPS_MEASUREMENT_3D);
        x9_42_schemes = branch9;
        dhStatic = branch9.branch(ThreeDSecureRequest.VERSION_1);
        ...
        ASN1ObjectIdentifier branch10 = aSN1ObjectIdentifier4.branch(ThreeDSecureRequest.VERSION_1);
        x9_44_components = branch10;
        id_kdf_kdf2 = branch10.branch(ThreeDSecureRequest.VERSION_1);
