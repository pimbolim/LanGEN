...
public class X509Name extends ASN1Object {
    ...
    static {
        ...
        hashtable7.put(aSN1ObjectIdentifier, Stripe3ds2AuthResult.Ares.VALUE_CHALLENGE);
        ...
        hashtable8.put(aSN1ObjectIdentifier, Stripe3ds2AuthResult.Ares.VALUE_CHALLENGE);
        ...
        hashtable9.put(JWKParameterNames.RSA_OTHER_PRIMES__FACTOR_CRT_COEFFICIENT, aSN1ObjectIdentifier52);
        ...
        hashtable9.put(JWKParameterNames.RSA_EXPONENT, aSN1ObjectIdentifier61);
        ...
        hashtable9.put(HintConstants.AUTOFILL_HINT_GENDER, aSN1ObjectIdentifier28);
    ...
    public X509Name(boolean z, Hashtable hashtable, String str, X509NameEntryConverter x509NameEntryConverter) {
        ...
        while (x509NameTokenizer.hasMoreTokens()) {
            ...
            if (nextToken.indexOf(43) > 0) {
                X509NameTokenizer x509NameTokenizer2 = new X509NameTokenizer(nextToken, SignatureVisitor.EXTENDS);
    ...
    private void addEntry(Hashtable hashtable, String str, Boolean bool) {
        X509NameTokenizer x509NameTokenizer = new X509NameTokenizer(str, SignatureVisitor.INSTANCEOF);
        String nextToken = x509NameTokenizer.nextToken();
