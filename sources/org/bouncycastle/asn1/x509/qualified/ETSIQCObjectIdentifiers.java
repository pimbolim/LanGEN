...
public interface ETSIQCObjectIdentifiers {
    ...
    static {
        ...
        id_etsi_qct_esign = aSN1ObjectIdentifier.branch(ThreeDSecureRequest.VERSION_1);
        id_etsi_qct_eseal = aSN1ObjectIdentifier.branch("2");
        id_etsi_qct_web = aSN1ObjectIdentifier.branch(ExifInterface.GPS_MEASUREMENT_3D);
    }
}
