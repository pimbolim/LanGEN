...
public interface GMObjectIdentifiers {
    ...
    static {
        ...
        sm2encrypt_recommendedParameters = branch.branch(ThreeDSecureRequest.VERSION_1);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = sm_scheme;
        sm9keyagreement = aSN1ObjectIdentifier2.branch("302.2");
        sm9encrypt = aSN1ObjectIdentifier2.branch("302.3");
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier2.branch("401");
        sm3 = branch2;
        hmac_sm3 = branch2.branch("2");
        sm2sign_with_sm3 = aSN1ObjectIdentifier2.branch("501");
        sm2sign_with_sha1 = aSN1ObjectIdentifier2.branch("502");
        sm2sign_with_sha256 = aSN1ObjectIdentifier2.branch("503");
        sm2sign_with_sha512 = aSN1ObjectIdentifier2.branch("504");
        sm2sign_with_sha224 = aSN1ObjectIdentifier2.branch("505");
        sm2sign_with_sha384 = aSN1ObjectIdentifier2.branch("506");
        sm2sign_with_rmd160 = aSN1ObjectIdentifier2.branch("507");
        sm2sign_with_whirlpool = aSN1ObjectIdentifier2.branch("520");
        sm2sign_with_blake2b512 = aSN1ObjectIdentifier2.branch("521");
        sm2sign_with_blake2s256 = aSN1ObjectIdentifier2.branch("522");
    }
}
