...
public interface BCObjectIdentifiers {
    ...
    static {
        ...
        bc_pbe = branch;
        ASN1ObjectIdentifier branch2 = branch.branch(ThreeDSecureRequest.VERSION_1);
        bc_pbe_sha1 = branch2;
        ...
        bc_pbe_sha1_pkcs5 = branch2.branch(ThreeDSecureRequest.VERSION_1);
        ASN1ObjectIdentifier branch4 = branch2.branch("2");
        bc_pbe_sha1_pkcs12 = branch4;
        bc_pbe_sha256_pkcs5 = branch3.branch(ThreeDSecureRequest.VERSION_1);
        ...
        bc_sig = branch6;
        ASN1ObjectIdentifier branch7 = branch6.branch(ThreeDSecureRequest.VERSION_1);
        sphincs256 = branch7;
        sphincs256_with_BLAKE512 = branch7.branch(ThreeDSecureRequest.VERSION_1);
        ...
        xmss = branch8;
        ASN1ObjectIdentifier branch9 = branch8.branch(ThreeDSecureRequest.VERSION_1);
        ...
        xmss_mt = branch13;
        ASN1ObjectIdentifier branch14 = branch13.branch(ThreeDSecureRequest.VERSION_1);
        ...
        qTESLA = branch18;
        qTESLA_Rnd1_I = branch18.branch(ThreeDSecureRequest.VERSION_1);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = bc;
        ASN1ObjectIdentifier branch19 = aSN1ObjectIdentifier2.branch(ExifInterface.GPS_MEASUREMENT_3D);
        bc_exch = branch19;
        newHope = branch19.branch(ThreeDSecureRequest.VERSION_1);
        ASN1ObjectIdentifier branch20 = aSN1ObjectIdentifier2.branch("4");
        bc_ext = branch20;
        linkedCertificate = branch20.branch(ThreeDSecureRequest.VERSION_1);
    }
}
