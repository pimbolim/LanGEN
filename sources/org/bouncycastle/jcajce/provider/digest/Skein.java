...
public class Skein {
    ...
    public static class HMacKeyGenerator_256_224 extends BaseKeyGenerator {
        public HMacKeyGenerator_256_224() {
            super("HMACSkein-256-224", CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY, new CipherKeyGenerator());
        }
    }
    ...
    public static class HMacKeyGenerator_512_224 extends BaseKeyGenerator {
        public HMacKeyGenerator_512_224() {
            super("HMACSkein-512-224", CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY, new CipherKeyGenerator());
        }
    }
    ...
    public static class HashMac_256_224 extends BaseMac {
        public HashMac_256_224() {
            super(new HMac(new SkeinDigest(256, CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY)));
        }
    }
    ...
    public static class HashMac_512_224 extends BaseMac {
        public HashMac_512_224() {
            super(new HMac(new SkeinDigest(512, CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY)));
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            addSkeinMacAlgorithm(configurableProvider, 256, CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY);
            ...
            addSkeinMacAlgorithm(configurableProvider, 512, CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY);
    ...
    public static class SkeinMacKeyGenerator_256_224 extends BaseKeyGenerator {
        public SkeinMacKeyGenerator_256_224() {
            super("Skein-MAC-256-224", CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY, new CipherKeyGenerator());
        }
    }
    ...
    public static class SkeinMacKeyGenerator_512_224 extends BaseKeyGenerator {
        public SkeinMacKeyGenerator_512_224() {
            super("Skein-MAC-512-224", CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY, new CipherKeyGenerator());
        }
    }
    ...
    public static class SkeinMac_256_224 extends BaseMac {
        public SkeinMac_256_224() {
            super(new SkeinMac(256, CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY));
        }
    }
    ...
    public static class SkeinMac_512_224 extends BaseMac {
        public SkeinMac_512_224() {
            super(new SkeinMac(512, CanonMakernoteDirectory.TAG_SENSOR_INFO_ARRAY));
        }
    }
