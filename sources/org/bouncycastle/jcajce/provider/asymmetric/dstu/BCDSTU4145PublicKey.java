...
public class BCDSTU4145PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r14v3, resolved type: org.bouncycastle.jce.spec.ECNamedCurveSpec} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r14v5, resolved type: java.security.spec.ECParameterSpec} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r14v9, resolved type: java.security.spec.ECParameterSpec} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r14v21, resolved type: org.bouncycastle.jce.spec.ECNamedCurveSpec} */
    ...
    private void populateFromPubKeyInfo(org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r14) {
        ...
        L_0x0029:
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r14 = org.bouncycastle.asn1.x9.X9ECParameters.getInstance(r1)
        ...
        L_0x005f:
            ...
            org.bouncycastle.crypto.params.ECDomainParameters r1 = org.bouncycastle.asn1.ua.DSTU4145NamedCurves.getByOID(r14)
        ...
        L_0x0136:
            ...
            goto L_0x014c
        L_0x0148:
            java.security.spec.ECParameterSpec r14 = org.bouncycastle.jcajce.provider.asymmetric.util.EC5Util.convertToSpec((org.bouncycastle.asn1.x9.X9ECParameters) r14)
        L_0x014c:
            r13.ecSpec = r14
