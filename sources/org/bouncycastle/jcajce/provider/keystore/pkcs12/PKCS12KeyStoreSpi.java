...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    private void doStore(OutputStream outputStream, char[] cArr, boolean z) throws IOException {
        ...
        if (size != 0) {
            Objects.requireNonNull(cArr2, "no password supplied for PKCS#12 KeyStore");
        } else if (cArr2 == null) {
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:152:0x0492  */
    /* JADX WARNING: Removed duplicated region for block: B:156:0x04b1  */
    ...
    public void engineLoad(java.io.InputStream r23, char[] r24) throws java.io.IOException {
        ...
        L_0x0009:
            ...
            org.bouncycastle.asn1.ASN1Primitive r0 = r0.readObject()     // Catch:{ Exception -> 0x05e1 }
            org.bouncycastle.asn1.pkcs.Pfx r0 = org.bouncycastle.asn1.pkcs.Pfx.getInstance(r0)     // Catch:{ Exception -> 0x05e1 }
            ...
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r1 = r8.macAlgorithm     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r2 = r1.getAlgorithm()     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            int r4 = r8.itCount     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            r6 = 0
            r1 = r22
            r3 = r15
            r5 = r24
            r7 = r0
            byte[] r1 = r1.calculatePbeMac(r2, r3, r4, r5, r6, r7)     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            byte[] r14 = r14.getDigest()     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            boolean r1 = org.bouncycastle.util.Arrays.constantTimeAreEqual(r1, r14)     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            if (r1 != 0) goto L_0x00eb
            int r1 = r9.length     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            ...
            r15 = r7
            r7 = r0
            byte[] r0 = r1.calculatePbeMac(r2, r3, r4, r5, r6, r7)     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            boolean r0 = org.bouncycastle.util.Arrays.constantTimeAreEqual(r0, r14)     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            if (r0 == 0) goto L_0x00aa
            r0 = 1
            goto L_0x00ec
        L_0x00aa:
            java.io.IOException r0 = new java.io.IOException     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            r0.<init>(r15)     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            throw r0     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
        L_0x00b0:
            r15 = r7
            java.io.IOException r0 = new java.io.IOException     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
            r0.<init>(r15)     // Catch:{ IOException -> 0x00d3, Exception -> 0x00b7 }
        ...
        L_0x04ab:
            ...
            java.io.ByteArrayInputStream r3 = new java.io.ByteArrayInputStream     // Catch:{ Exception -> 0x05ba }
            org.bouncycastle.asn1.ASN1Encodable r2 = r2.getCertValue()     // Catch:{ Exception -> 0x05ba }
            org.bouncycastle.asn1.ASN1OctetString r2 = (org.bouncycastle.asn1.ASN1OctetString) r2     // Catch:{ Exception -> 0x05ba }
            byte[] r2 = r2.getOctets()     // Catch:{ Exception -> 0x05ba }
            r3.<init>(r2)     // Catch:{ Exception -> 0x05ba }
            java.security.cert.CertificateFactory r2 = r8.certFact     // Catch:{ Exception -> 0x05ba }
            java.security.cert.Certificate r2 = r2.generateCertificate(r3)     // Catch:{ Exception -> 0x05ba }
