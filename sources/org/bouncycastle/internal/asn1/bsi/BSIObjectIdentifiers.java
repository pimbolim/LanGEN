...
public interface BSIObjectIdentifiers {
    ...
    static {
        ...
        ecdsa_plain_SHA1 = branch2.branch(ThreeDSecureRequest.VERSION_1);
        ...
        algorithm = aSN1ObjectIdentifier.branch(ThreeDSecureRequest.VERSION_1);
        ASN1ObjectIdentifier branch3 = branch.branch("5.1");
        ecka_eg = branch3;
        ASN1ObjectIdentifier branch4 = branch3.branch(ThreeDSecureRequest.VERSION_1);
        ecka_eg_X963kdf = branch4;
        ecka_eg_X963kdf_SHA1 = branch4.branch(ThreeDSecureRequest.VERSION_1);
        ecka_eg_X963kdf_SHA224 = branch4.branch("2");
        ecka_eg_X963kdf_SHA256 = branch4.branch(ExifInterface.GPS_MEASUREMENT_3D);
        ...
        ecka_eg_SessionKDF_3DES = branch5.branch(ThreeDSecureRequest.VERSION_1);
        ecka_eg_SessionKDF_AES128 = branch5.branch("2");
        ecka_eg_SessionKDF_AES192 = branch5.branch(ExifInterface.GPS_MEASUREMENT_3D);
