...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch(ThreeDSecureRequest.VERSION_1);
        id_isismtt_cp = branch;
        id_isismtt_cp_accredited = branch.branch(ThreeDSecureRequest.VERSION_1);
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch(ExifInterface.GPS_MEASUREMENT_3D);
        id_isismtt_at = branch2;
        id_isismtt_at_dateOfCertGen = branch2.branch(ThreeDSecureRequest.VERSION_1);
        id_isismtt_at_procuration = branch2.branch("2");
        id_isismtt_at_admission = branch2.branch(ExifInterface.GPS_MEASUREMENT_3D);
