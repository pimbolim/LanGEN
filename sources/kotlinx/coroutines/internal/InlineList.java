...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m6189boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <E> Object m6190constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6192equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof InlineList) && Intrinsics.areEqual(obj, ((InlineList) obj2).m6198unboximpl());
    }
    ...
    public static int m6195hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static String m6197toStringimpl(Object obj) {
        return "InlineList(holder=" + obj + ')';
    }

    public boolean equals(Object obj) {
        return m6192equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m6195hashCodeimpl(this.holder);
    }

    public String toString() {
        return m6197toStringimpl(this.holder);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m6198unboximpl() {
        return this.holder;
    }
    ...
    public static /* synthetic */ Object m6191constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m6190constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM  reason: not valid java name */
    public static final Object m6196plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        } else if (obj == null) {
            return m6190constructorimpl(e);
        } else {
            ...
            arrayList.add(obj);
            arrayList.add(e);
            return m6190constructorimpl(arrayList);
        }
    }

    /* renamed from: forEachReversed-impl  reason: not valid java name */
    public static final void m6194forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj != null) {
            if (!(obj instanceof ArrayList)) {
