...
public final class FastServiceLoader {
    ...
    private final java.util.List<java.lang.String> parse(java.net.URL r6) {
        ...
        L_0x0064:
            ...
            r6 = r0
            java.io.BufferedReader r6 = (java.io.BufferedReader) r6     // Catch:{ all -> 0x0083 }
            kotlinx.coroutines.internal.FastServiceLoader r1 = INSTANCE     // Catch:{ all -> 0x0083 }
            java.util.List r6 = r1.parseFile(r6)     // Catch:{ all -> 0x0083 }
