...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public final void handleBuilderException(Throwable th) {
        if (trySelect()) {
            ...
            resumeWith(Result.m4709constructorimpl(ResultKt.createFailure(th)));
    ...
    public void onTimeout(long j, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        if (j > 0) {
            disposeOnSelect(DelayKt.getDelay(getContext()).invokeOnTimeout(j, new SelectBuilderImpl$onTimeout$$inlined$Runnable$1(this, function1), getContext()));
        } else if (trySelect()) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj2 == SelectKt.UNDECIDED) {
                    if (_result$FU.compareAndSet(this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(obj, (Function1) null, 1, (Object) null))) {
                        return;
                    }
                    ...
                    if (Result.m4715isFailureimpl(obj)) {
                        ...
                        continuation.resumeWith(Result.m4709constructorimpl(ResultKt.createFailure(r4)));
                        return;
                    }
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj == SelectKt.UNDECIDED) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m4709constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        } else {
    ...
    public Object trySelectOther(LockFreeLinkedListNode.PrepareOp prepareOp) {
        while (true) {
            ...
            if (obj == SelectKt.getNOT_SELECTED()) {
                if (prepareOp == null) {
                    if (_state$FU.compareAndSet(this, SelectKt.getNOT_SELECTED(), (Object) null)) {
                        break;
                    }
                } else {
