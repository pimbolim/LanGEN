...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    public /* synthetic */ boolean cancel(Throwable th) {
        CancellationException cancellationException$default = th == null ? null : toCancellationException$default(this, th, (String) null, 1, (Object) null);
        if (cancellationException$default == null) {
            cancellationException$default = new JobCancellationException(cancellationExceptionMessage(), (Throwable) null, this);
        }
