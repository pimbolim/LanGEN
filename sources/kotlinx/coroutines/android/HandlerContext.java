...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public DisposableHandle invokeOnTimeout(long j, Runnable runnable, CoroutineContext coroutineContext) {
        if (this.handler.postDelayed(runnable, RangesKt.coerceAtMost(j, (long) DurationKt.MAX_MILLIS))) {
            return new DisposableHandle(runnable) {
                ...
                public final void dispose() {
                    HandlerContext.m6139invokeOnTimeout$lambda3(HandlerContext.this, this.f$1);
                }
            };
        }
        cancelOnRejection(coroutineContext, runnable);
    ...
    public static final void m6139invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
