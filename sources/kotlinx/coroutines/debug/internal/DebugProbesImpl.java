...
public final class DebugProbesImpl {
    ...
    private final Function1<Boolean, Unit> getDynamicAttach() {
        ...
        try {
            ...
            if (newInstance != null) {
                obj = Result.m4709constructorimpl((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(newInstance, 1));
    ...
    public final String enhanceStackTraceWithThreadDumpAsJson(DebugCoroutineInfo debugCoroutineInfo) {
        ...
        for (StackTraceElement next : enhanceStackTraceWithThreadDump) {
            ...
            sb.append(fileName == null ? null : toStringWithQuotes(fileName));
            sb.append(",\n                    \"lineNumber\": ");
            sb.append(next.getLineNumber());
            sb.append("\n                }\n                ");
            arrayList.add(StringsKt.trimIndent(sb.toString()));
        }
        return AbstractJsonLexerKt.BEGIN_LIST + CollectionsKt.joinToString$default(arrayList, (CharSequence) null, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 63, (Object) null) + AbstractJsonLexerKt.END_LIST;
    }
    ...
    private final void dumpCoroutinesSynchronized(java.io.PrintStream r14) {
        ...
        L_0x001c:
            java.util.concurrent.locks.ReentrantReadWriteLock$WriteLock r0 = r0.writeLock()
            r0.lock()
            kotlinx.coroutines.debug.internal.DebugProbesImpl r4 = INSTANCE     // Catch:{ all -> 0x00f7 }
            boolean r5 = r4.isInstalled$kotlinx_coroutines_core()     // Catch:{ all -> 0x00f7 }
            if (r5 == 0) goto L_0x00eb
            java.lang.String r5 = "Coroutines dump "
            java.text.SimpleDateFormat r6 = dateFormat     // Catch:{ all -> 0x00f7 }
            long r7 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x00f7 }
            java.lang.Long r7 = java.lang.Long.valueOf(r7)     // Catch:{ all -> 0x00f7 }
            java.lang.String r6 = r6.format(r7)     // Catch:{ all -> 0x00f7 }
            java.lang.String r5 = kotlin.jvm.internal.Intrinsics.stringPlus(r5, r6)     // Catch:{ all -> 0x00f7 }
            r14.print(r5)     // Catch:{ all -> 0x00f7 }
            java.util.Set r4 = r4.getCapturedCoroutines()     // Catch:{ all -> 0x00f7 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x00f7 }
            kotlin.sequences.Sequence r4 = kotlin.collections.CollectionsKt.asSequence(r4)     // Catch:{ all -> 0x00f7 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2 r5 = kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$1$2.INSTANCE     // Catch:{ all -> 0x00f7 }
            kotlin.jvm.functions.Function1 r5 = (kotlin.jvm.functions.Function1) r5     // Catch:{ all -> 0x00f7 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.filter(r4, r5)     // Catch:{ all -> 0x00f7 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$lambda-19$$inlined$sortedBy$1 r5 = new kotlinx.coroutines.debug.internal.DebugProbesImpl$dumpCoroutinesSynchronized$lambda-19$$inlined$sortedBy$1     // Catch:{ all -> 0x00f7 }
            r5.<init>()     // Catch:{ all -> 0x00f7 }
            java.util.Comparator r5 = (java.util.Comparator) r5     // Catch:{ all -> 0x00f7 }
            kotlin.sequences.Sequence r4 = kotlin.sequences.SequencesKt.sortedWith(r4, r5)     // Catch:{ all -> 0x00f7 }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ all -> 0x00f7 }
        L_0x0063:
            boolean r5 = r4.hasNext()     // Catch:{ all -> 0x00f7 }
            if (r5 == 0) goto L_0x00dd
            java.lang.Object r5 = r4.next()     // Catch:{ all -> 0x00f7 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl$CoroutineOwner r5 = (kotlinx.coroutines.debug.internal.DebugProbesImpl.CoroutineOwner) r5     // Catch:{ all -> 0x00f7 }
            kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl r6 = r5.info     // Catch:{ all -> 0x00f7 }
            java.util.List r7 = r6.lastObservedStackTrace()     // Catch:{ all -> 0x00f7 }
            kotlinx.coroutines.debug.internal.DebugProbesImpl r8 = INSTANCE     // Catch:{ all -> 0x00f7 }
            java.lang.String r9 = r6.getState()     // Catch:{ all -> 0x00f7 }
            java.lang.Thread r10 = r6.lastObservedThread     // Catch:{ all -> 0x00f7 }
            java.util.List r9 = r8.enhanceStackTraceWithThreadDumpImpl(r9, r10, r7)     // Catch:{ all -> 0x00f7 }
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x00f7 }
            java.lang.String r11 = "RUNNING"
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r11)     // Catch:{ all -> 0x00f7 }
            if (r10 == 0) goto L_0x009a
            if (r9 != r7) goto L_0x009a
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x00f7 }
            java.lang.String r11 = " (Last suspension stacktrace, not an actual stacktrace)"
            java.lang.String r10 = kotlin.jvm.internal.Intrinsics.stringPlus(r10, r11)     // Catch:{ all -> 0x00f7 }
            goto L_0x009e
        L_0x009a:
            java.lang.String r10 = r6.getState()     // Catch:{ all -> 0x00f7 }
        L_0x009e:
            ...
            kotlin.coroutines.Continuation<T> r5 = r5.delegate     // Catch:{ all -> 0x00f7 }
            r11.append(r5)     // Catch:{ all -> 0x00f7 }
            java.lang.String r5 = ", state: "
            r11.append(r5)     // Catch:{ all -> 0x00f7 }
            r11.append(r10)     // Catch:{ all -> 0x00f7 }
            java.lang.String r5 = r11.toString()     // Catch:{ all -> 0x00f7 }
            r14.print(r5)     // Catch:{ all -> 0x00f7 }
            boolean r5 = r7.isEmpty()     // Catch:{ all -> 0x00f7 }
            if (r5 == 0) goto L_0x00d9
            java.lang.String r5 = "\n\tat "
            java.lang.String r7 = "Coroutine creation stacktrace"
            java.lang.StackTraceElement r7 = kotlinx.coroutines.internal.StackTraceRecoveryKt.artificialFrame(r7)     // Catch:{ all -> 0x00f7 }
            java.lang.String r5 = kotlin.jvm.internal.Intrinsics.stringPlus(r5, r7)     // Catch:{ all -> 0x00f7 }
            r14.print(r5)     // Catch:{ all -> 0x00f7 }
            java.util.List r5 = r6.getCreationStackTrace()     // Catch:{ all -> 0x00f7 }
            r8.printStackTrace(r14, r5)     // Catch:{ all -> 0x00f7 }
            goto L_0x0063
        L_0x00d9:
            r8.printStackTrace(r14, r9)     // Catch:{ all -> 0x00f7 }
            goto L_0x0063
        L_0x00dd:
            kotlin.Unit r14 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00f7 }
        L_0x00df:
        ...
        L_0x00eb:
            ...
            java.lang.IllegalStateException r4 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00f7 }
            java.lang.String r14 = r14.toString()     // Catch:{ all -> 0x00f7 }
            r4.<init>(r14)     // Catch:{ all -> 0x00f7 }
            throw r4     // Catch:{ all -> 0x00f7 }
        L_0x00f7:
            r14 = move-exception
        L_0x00f8:
    ...
    private final List<StackTraceElement> enhanceStackTraceWithThreadDumpImpl(String str, Thread thread, List<StackTraceElement> list) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            DebugProbesImpl debugProbesImpl = this;
            obj = Result.m4709constructorimpl(thread.getStackTrace());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m4709constructorimpl(ResultKt.createFailure(th));
        }
