...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public /* synthetic */ ExperimentalCoroutineDispatcher(int i, int i2) {
        this(i, i2, TasksKt.IDLE_WORKER_KEEP_ALIVE_NS, (String) null, 8, (DefaultConstructorMarker) null);
    }
    ...
    public final CoroutineDispatcher blocking(int i) {
        if (i > 0) {
            return new LimitingDispatcher(this, i, (String) null, 1);
        }
    ...
    public final CoroutineDispatcher limited(int i) {
        ...
        if (i > 0) {
            ...
            if (z) {
                return new LimitingDispatcher(this, i, (String) null, 0);
            }
