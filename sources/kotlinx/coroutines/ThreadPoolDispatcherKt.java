...
public final class ThreadPoolDispatcherKt {
    ...
    public static final ExecutorCoroutineDispatcher newFixedThreadPoolContext(int i, String str) {
        ...
        if (z) {
            return ExecutorsKt.from((ExecutorService) Executors.newScheduledThreadPool(i, new ThreadFactory(i, str, new AtomicInteger()) {
                ...
                public final Thread newThread(Runnable runnable) {
                    return ThreadPoolDispatcherKt.m6136newFixedThreadPoolContext$lambda1(this.f$0, this.f$1, this.f$2, runnable);
                }
            }));
        }
    ...
    public static final Thread m6136newFixedThreadPoolContext$lambda1(int i, String str, AtomicInteger atomicInteger, Runnable runnable) {
        if (i != 1) {
