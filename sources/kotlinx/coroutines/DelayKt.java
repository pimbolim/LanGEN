...
public final class DelayKt {
    ...
    public static final Object m6133delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m6134toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m6134toDelayMillisLRDsOJo(long j) {
        if (Duration.m5994compareToLRDsOJo(j, Duration.Companion.m6097getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6013getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
