...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m6181debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m6134toDelayMillisLRDsOJo(j));
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope coroutineScope, long j, long j2) {
        ...
        if (j >= 0) {
            ...
            if (z) {
                return ProduceKt.produce$default(coroutineScope, (CoroutineContext) null, 0, new FlowKt__DelayKt$fixedPeriodTicker$3(j2, j, (Continuation<? super FlowKt__DelayKt$fixedPeriodTicker$3>) null), 1, (Object) null);
            }
    ...
    public static final <T> Flow<T> m6182sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m6134toDelayMillisLRDsOJo(j));
    }
}
