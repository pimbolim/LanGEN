...
public class ArrayChannel<E> extends AbstractChannel<E> {
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:38:0x0084 A[Catch:{ all -> 0x00bf }] */
    /* JADX WARNING: Removed duplicated region for block: B:39:0x0090 A[Catch:{ all -> 0x00bf }] */
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r9) {
        /*
            ...
            r0.lock()
            int r1 = r8.size     // Catch:{ all -> 0x00bf }
            if (r1 != 0) goto L_0x0017
            kotlinx.coroutines.channels.Closed r9 = r8.getClosedForSend()     // Catch:{ all -> 0x00bf }
            if (r9 != 0) goto L_0x0013
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00bf }
        L_0x0013:
            r0.unlock()
            return r9
        L_0x0017:
            java.lang.Object[] r2 = r8.buffer     // Catch:{ all -> 0x00bf }
            int r3 = r8.head     // Catch:{ all -> 0x00bf }
            r4 = r2[r3]     // Catch:{ all -> 0x00bf }
            r5 = 0
            r2[r3] = r5     // Catch:{ all -> 0x00bf }
            int r2 = r1 + -1
            r8.size = r2     // Catch:{ all -> 0x00bf }
            kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00bf }
            int r3 = r8.capacity     // Catch:{ all -> 0x00bf }
            r6 = 1
            if (r1 != r3) goto L_0x007b
        L_0x002b:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r3 = r8.describeTryPoll()     // Catch:{ all -> 0x00bf }
            r7 = r3
            kotlinx.coroutines.internal.AtomicDesc r7 = (kotlinx.coroutines.internal.AtomicDesc) r7     // Catch:{ all -> 0x00bf }
            java.lang.Object r7 = r9.performAtomicTrySelect(r7)     // Catch:{ all -> 0x00bf }
            if (r7 != 0) goto L_0x0048
            java.lang.Object r5 = r3.getResult()     // Catch:{ all -> 0x00bf }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r5)     // Catch:{ all -> 0x00bf }
            r2 = r5
            kotlinx.coroutines.channels.Send r2 = (kotlinx.coroutines.channels.Send) r2     // Catch:{ all -> 0x00bf }
            java.lang.Object r2 = r2.getPollResult()     // Catch:{ all -> 0x00bf }
        L_0x0046:
            r3 = 1
            goto L_0x007c
        L_0x0048:
            kotlinx.coroutines.internal.Symbol r3 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00bf }
            if (r7 != r3) goto L_0x004d
            goto L_0x007b
        L_0x004d:
            java.lang.Object r3 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00bf }
            if (r7 != r3) goto L_0x0052
            goto L_0x002b
        L_0x0052:
            java.lang.Object r2 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00bf }
            if (r7 != r2) goto L_0x0064
            r8.size = r1     // Catch:{ all -> 0x00bf }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00bf }
            int r1 = r8.head     // Catch:{ all -> 0x00bf }
            r9[r1] = r4     // Catch:{ all -> 0x00bf }
            r0.unlock()
            return r7
        L_0x0064:
            boolean r2 = r7 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00bf }
        ...
        L_0x006b:
            ...
            java.lang.String r1 = kotlin.jvm.internal.Intrinsics.stringPlus(r1, r7)     // Catch:{ all -> 0x00bf }
        ...
        L_0x007b:
            r3 = 0
        L_0x007c:
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00bf }
            if (r2 == r7) goto L_0x0090
            boolean r7 = r2 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00bf }
            if (r7 != 0) goto L_0x0090
            r8.size = r1     // Catch:{ all -> 0x00bf }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00bf }
            int r7 = r8.head     // Catch:{ all -> 0x00bf }
            int r7 = r7 + r1
            int r1 = r9.length     // Catch:{ all -> 0x00bf }
            int r7 = r7 % r1
            r9[r7] = r2     // Catch:{ all -> 0x00bf }
            goto L_0x00a6
        L_0x0090:
            boolean r9 = r9.trySelect()     // Catch:{ all -> 0x00bf }
            if (r9 != 0) goto L_0x00a6
            r8.size = r1     // Catch:{ all -> 0x00bf }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00bf }
            int r1 = r8.head     // Catch:{ all -> 0x00bf }
            r9[r1] = r4     // Catch:{ all -> 0x00bf }
            java.lang.Object r9 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00bf }
            r0.unlock()
            return r9
        L_0x00a6:
            int r9 = r8.head     // Catch:{ all -> 0x00bf }
            int r9 = r9 + r6
            java.lang.Object[] r1 = r8.buffer     // Catch:{ all -> 0x00bf }
            int r1 = r1.length     // Catch:{ all -> 0x00bf }
            int r9 = r9 % r1
            r8.head = r9     // Catch:{ all -> 0x00bf }
            kotlin.Unit r9 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00bf }
            r0.unlock()
