...
public class LinkedListChannel<E> extends AbstractChannel<E> {
    ...
    public Object offerSelectInternal(E e, SelectInstance<?> selectInstance) {
        ...
        while (true) {
            ...
            if (obj != AbstractChannelKt.OFFER_FAILED && obj != AtomicKt.RETRY_ATOMIC) {
                ...
                throw new IllegalStateException(Intrinsics.stringPlus("Invalid result ", obj).toString());
            }
        }
    }
    ...
    public void m6172onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
