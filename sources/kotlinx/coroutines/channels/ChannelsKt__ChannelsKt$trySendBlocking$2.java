...
final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (Result.m4716isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m6169successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m6167closedJP2dKIU(Result.m4712exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m6154boximpl(obj3);
    }
}
