...
public final class TestCoroutineContext implements CoroutineContext {
    ...
    public final void enqueue(Runnable runnable) {
        ...
        long j = this.counter;
        this.counter = 1 + j;
        threadSafeHeap.addLast(new TimedRunnableObsolete(runnable, j, 0, 4, (DefaultConstructorMarker) null));
    }
    ...
    private final class Dispatcher extends EventLoop implements Delay {
        ...
        public void scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
            TimedRunnableObsolete unused = TestCoroutineContext.this.postDelayed(new TestCoroutineContext$Dispatcher$scheduleResumeAfterDelay$$inlined$Runnable$1(cancellableContinuation, this), j);
        }

        public DisposableHandle invokeOnTimeout(long j, Runnable runnable, CoroutineContext coroutineContext) {
            return new TestCoroutineContext$Dispatcher$invokeOnTimeout$1(TestCoroutineContext.this, TestCoroutineContext.this.postDelayed(runnable, j));
        }
