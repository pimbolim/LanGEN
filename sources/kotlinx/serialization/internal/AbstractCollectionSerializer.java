    ...
    public final Collection merge(Decoder decoder, Collection collection) {
        ...
        if (beginStructure.decodeSequentially()) {
            ...
            while (true) {
                ...
                readElement$default(this, beginStructure, builderSize + decodeElementIndex, builder, false, 8, (Object) null);
            }
        }
