...
public abstract class KeyValueSerializer<K, V, R> implements KSerializer<R> {
    ...
    public R deserialize(Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            return toResult(CompositeDecoder.DefaultImpls.decodeSerializableElement$default(beginStructure, getDescriptor(), 0, this.keySerializer, (Object) null, 8, (Object) null), CompositeDecoder.DefaultImpls.decodeSerializableElement$default(beginStructure, getDescriptor(), 1, this.valueSerializer, (Object) null, 8, (Object) null));
        }
