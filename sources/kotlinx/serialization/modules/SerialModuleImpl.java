...
public final class SerialModuleImpl extends SerializersModule {
    ...
    public void dumpTo(SerializersModuleCollector serializersModuleCollector) {
        ...
        for (Map.Entry next3 : this.polyBase2DefaultSerializerProvider.entrySet()) {
            serializersModuleCollector.polymorphicDefaultSerializer((KClass) next3.getKey(), (Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity((Function1) next3.getValue(), 1));
        }
        for (Map.Entry next4 : this.polyBase2DefaultDeserializerProvider.entrySet()) {
            serializersModuleCollector.polymorphicDefaultDeserializer((KClass) next4.getKey(), (Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity((Function1) next4.getValue(), 1));
        }
    }
}
