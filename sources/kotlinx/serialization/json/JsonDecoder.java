...
public interface JsonDecoder extends Decoder, CompositeDecoder {
    ...
    public static final class DefaultImpls {
        ...
        public static <T> T decodeNullableSerializableValue(JsonDecoder jsonDecoder, DeserializationStrategy<T> deserializationStrategy) {
            Intrinsics.checkNotNullParameter(jsonDecoder, "this");
        ...
        public static <T> T decodeSerializableValue(JsonDecoder jsonDecoder, DeserializationStrategy<T> deserializationStrategy) {
            Intrinsics.checkNotNullParameter(jsonDecoder, "this");
            Intrinsics.checkNotNullParameter(deserializationStrategy, "deserializer");
