...
public final class JvmStreamsKt {
    ...
    public static final <T> void encodeToStream(Json json, SerializationStrategy<? super T> serializationStrategy, T t, OutputStream outputStream) {
        ...
        try {
            new StreamingJsonEncoder((JsonStringBuilder) jsonToWriterStringBuilder, json, WriteMode.OBJ, new JsonEncoder[WriteMode.values().length]).encodeSerializableValue(serializationStrategy, t);
        } finally {
    ...
    @ExperimentalSerializationApi
    public static final <T> Sequence<T> decodeToSequence(Json json, InputStream inputStream, DeserializationStrategy<T> deserializationStrategy, DecodeSequenceMode decodeSequenceMode) {
        Intrinsics.checkNotNullParameter(json, "<this>");
        Intrinsics.checkNotNullParameter(inputStream, "stream");
        Intrinsics.checkNotNullParameter(deserializationStrategy, "deserializer");
        Intrinsics.checkNotNullParameter(decodeSequenceMode, "format");
        return SequencesKt.constrainOnce(new JvmStreamsKt$decodeToSequence$$inlined$Sequence$1(JsonIteratorKt.JsonIterator(decodeSequenceMode, json, new ReaderJsonLexer(inputStream, (Charset) null, 2, (DefaultConstructorMarker) null), deserializationStrategy)));
    }
