...
public abstract class JsonContentPolymorphicSerializer<T> implements KSerializer<T> {
    ...
    public final void serialize(Encoder encoder, T t) {
        ...
        if (polymorphic == null && (polymorphic = SerializersKt.serializerOrNull(Reflection.getOrCreateKotlinClass(t.getClass()))) == null) {
    ...
    public final T deserialize(Decoder decoder) {
        ...
        return asJsonDecoder.getJson().decodeFromJsonElement((KSerializer) selectDeserializer(decodeJsonElement), decodeJsonElement);
    }
