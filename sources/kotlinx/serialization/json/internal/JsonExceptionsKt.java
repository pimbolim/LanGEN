...
public final class JsonExceptionsKt {
    ...
    public static final JsonDecodingException JsonDecodingException(int i, String str, CharSequence charSequence) {
        Intrinsics.checkNotNullParameter(str, GraphQLConstants.Keys.MESSAGE);
        Intrinsics.checkNotNullParameter(charSequence, GraphQLConstants.Keys.INPUT);
    ...
    public static final Void throwInvalidFloatingPointDecoded(AbstractJsonLexer abstractJsonLexer, Number number) {
        ...
        AbstractJsonLexer.fail$default(abstractJsonLexer, "Unexpected special floating-point value " + number + ". By default, non-finite floating point values are prohibited because they do not conform JSON specification. It is possible to deserialize them using 'JsonBuilder.allowSpecialFloatingPointValues = true'", 0, 2, (Object) null);
    ...
    public static final JsonDecodingException UnknownKeyException(String str, String str2) {
        Intrinsics.checkNotNullParameter(str, "key");
        Intrinsics.checkNotNullParameter(str2, GraphQLConstants.Keys.INPUT);
