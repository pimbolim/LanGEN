...
public final class JsonDecoderForUnsignedTypes extends AbstractDecoder {
    ...
    public int decodeInt() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, "Failed to parse type '" + "UInt" + "' for input '" + consumeStringLenient + '\'', 0, 2, (Object) null);
    ...
    public long decodeLong() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, "Failed to parse type '" + "ULong" + "' for input '" + consumeStringLenient + '\'', 0, 2, (Object) null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public byte decodeByte() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, "Failed to parse type '" + "UByte" + "' for input '" + consumeStringLenient + '\'', 0, 2, (Object) null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public short decodeShort() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, "Failed to parse type '" + "UShort" + "' for input '" + consumeStringLenient + '\'', 0, 2, (Object) null);
            throw new KotlinNothingValueException();
        }
    }
}
