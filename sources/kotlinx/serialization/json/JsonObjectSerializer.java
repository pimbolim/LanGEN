...
public final class JsonObjectSerializer implements KSerializer<JsonObject> {
    ...
    public JsonObject deserialize(Decoder decoder) {
        ...
        return new JsonObject(BuiltinSerializersKt.MapSerializer(BuiltinSerializersKt.serializer(StringCompanionObject.INSTANCE), JsonElementSerializer.INSTANCE).deserialize(decoder));
    }
}
