...
public abstract class Json implements StringFormat {
    ...
    public static final class Default extends Json {
        ...
        private Default() {
            super(new JsonConfiguration(false, false, false, false, false, false, (String) null, false, false, (String) null, false, false, 4095, (DefaultConstructorMarker) null), SerializersModuleKt.getEmptySerializersModule(), (DefaultConstructorMarker) null);
        }
    }
    ...
    public final <T> T decodeFromJsonElement(DeserializationStrategy<T> deserializationStrategy, JsonElement jsonElement) {
        Intrinsics.checkNotNullParameter(deserializationStrategy, "deserializer");
