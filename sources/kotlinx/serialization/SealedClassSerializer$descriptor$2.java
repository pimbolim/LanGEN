...
final class SealedClassSerializer$descriptor$2 extends Lambda implements Function0<SerialDescriptor> {
    ...
    SealedClassSerializer$descriptor$2(String str, SealedClassSerializer<T> sealedClassSerializer, KSerializer<? extends T>[] kSerializerArr) {
        super(0);
        this.$serialName = str;
    ...
    public final SerialDescriptor invoke() {
        ...
        final KSerializer<? extends T>[] kSerializerArr = this.$subclassSerializers;
