...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m5896getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            setResult(Result.m4708boximpl(obj));
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> r0 = m5896getResultxLWZpok();
                if (r0 == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(r0.m4718unboximpl());
                }
            }
        }
    }
