...
public final class RandomKt {
    ...
    public static final long nextLong(Random random, LongRange longRange) {
        ...
        if (longRange.isEmpty()) {
            throw new IllegalArgumentException(Intrinsics.stringPlus("Cannot get random in empty range: ", longRange));
    ...
    public static final String boundsErrorMessage(Object obj, Object obj2) {
        Intrinsics.checkNotNullParameter(obj, TypedValues.TransitionType.S_FROM);
