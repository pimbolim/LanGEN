...
class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0) {
        ...
        return SequencesKt.sequence(new SequencesKt__SequencesKt$ifEmpty$1(sequence, function0, (Continuation<? super SequencesKt__SequencesKt$ifEmpty$1>) null));
    }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new SequencesKt__SequencesKt$shuffled$1(sequence, random, (Continuation<? super SequencesKt__SequencesKt$shuffled$1>) null));
    }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1) {
        ...
        return SequencesKt.sequence(new SequencesKt__SequencesKt$flatMapIndexed$1(sequence, function2, function1, (Continuation<? super SequencesKt__SequencesKt$flatMapIndexed$1>) null));
    }
