...
public final class TypesJVMKt {
    ...
    public static final String typeToString(Type type) {
        ...
        if (cls.isArray()) {
            ...
            str = Intrinsics.stringPlus(((Class) SequencesKt.last(generateSequence)).getName(), StringsKt.repeat(XMPConst.ARRAY_ITEM_NAME, SequencesKt.count(generateSequence)));
        } else {
            str = cls.getName();
        }
