...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (String str : values) {
            ...
            sb.append(StringsKt.substringAfterLast$default(str, (char) ClassUtils.PACKAGE_SEPARATOR_CHAR, (String) null, 2, (Object) null));
            sb.append("CompanionObject");
            Pair pair = TuplesKt.to(sb.toString(), Intrinsics.stringPlus(str, ".Companion"));
        ...
        for (Map.Entry entry : map2.entrySet()) {
            linkedHashMap.put(entry.getKey(), StringsKt.substringAfterLast$default((String) entry.getValue(), (char) ClassUtils.PACKAGE_SEPARATOR_CHAR, (String) null, 2, (Object) null));
        }
