...
public final class DeepRecursiveKt {
    ...
    public static final Object UNDEFINED_RESULT = Result.m4709constructorimpl(IntrinsicsKt.getCOROUTINE_SUSPENDED());
    ...
    public static final <T, R> R invoke(DeepRecursiveFunction<T, R> deepRecursiveFunction, T t) {
        ...
        return new DeepRecursiveScopeImpl(deepRecursiveFunction.getBlock$kotlin_stdlib(), t).runCallLoop();
    }
