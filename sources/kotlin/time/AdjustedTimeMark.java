...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m5989getAdjustmentUwyO8pc() {
    ...
    public long m5988elapsedNowUwyO8pc() {
        return Duration.m6030minusLRDsOJo(this.mark.m6124elapsedNowUwyO8pc(), m5989getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m5990plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m6031plusLRDsOJo(m5989getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}
