...
public abstract class TimeMark {
    ...
    public abstract long m6124elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m6126plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this, j, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m6125minusLRDsOJo(long j) {
        return m6126plusLRDsOJo(Duration.m6047unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m6028isNegativeimpl(m6124elapsedNowUwyO8pc());
    }
