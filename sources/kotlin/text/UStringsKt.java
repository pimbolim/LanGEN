...
public final class UStringsKt {
    ...
    public static final String m5981toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m5983toStringolVBNx4(short s, int i) {
    ...
    public static final String m5982toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m5980toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m4776unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m5036unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m4854unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m4932unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m4854unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m4803constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m4721boximpl(UByte.m4727constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m4854unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m4803constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m4981boximpl(UShort.m4987constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m4803constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            int i5 = i3 + 1;
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m5056uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m4803constructorimpl(i2 * r5);
            int r6 = UInt.m4803constructorimpl(UInt.m4803constructorimpl(digitOf) + r3);
            if (UnsignedKt.uintCompare(r6, r3) < 0) {
                return null;
            }
            i2 = r6;
            i3 = i5;
        }
        return UInt.m4797boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m4881constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m5058ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m4881constructorimpl(j2 * r9);
            long r4 = ULong.m4881constructorimpl(ULong.m4881constructorimpl(((long) UInt.m4803constructorimpl(digitOf)) & 4294967295L) + r11);
