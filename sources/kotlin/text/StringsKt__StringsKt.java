...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final String trimStart(String str, Function1<? super Character, Boolean> function1) {
        ...
        while (true) {
            ...
            int i2 = i + 1;
            if (!function1.invoke(Character.valueOf(charSequence2.charAt(i))).booleanValue()) {
    ...
    public static final boolean regionMatchesImpl(CharSequence charSequence, int i, CharSequence charSequence2, int i2, int i3, boolean z) {
        ...
        while (i4 < i3) {
            int i5 = i4 + 1;
            if (!CharsKt.equals(charSequence.charAt(i + i4), charSequence2.charAt(i4 + i2), z)) {
                return false;
            }
            i4 = i5;
        }
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
        ...
        String str6 = str5;
        int i4 = i;
        int indexOf$default = !z2 ? StringsKt.indexOf$default(charSequence2, str6, i4, false, 4, (Object) null) : StringsKt.lastIndexOf$default(charSequence2, str6, i4, false, 4, (Object) null);
    ...
    public static final Sequence<String> lineSequence(CharSequence charSequence) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return StringsKt.splitToSequence$default(charSequence, new String[]{FileUploadRequest.LINE_BREAK, "\n", StringUtils.CR}, false, 0, 6, (Object) null);
    }
    ...
    public static final Boolean toBooleanStrictOrNull(String str) {
        ...
        return Intrinsics.areEqual((Object) str, (Object) "false") ? false : null;
    }
    ...
    public static final String trimStart(String str, char... cArr) {
        ...
        while (true) {
            ...
            int i2 = i + 1;
            if (!ArraysKt.contains(cArr, charSequence2.charAt(i))) {
                charSequence = charSequence2.subSequence(i, charSequence2.length());
                break;
            }
            i = i2;
