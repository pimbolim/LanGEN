...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String getExtension(File file) {
        ...
        return StringsKt.substringAfterLast(name, (char) ClassUtils.PACKAGE_SEPARATOR_CHAR, "");
    }
    ...
    public static final String getInvariantSeparatorsPath(File file) {
        ...
        Intrinsics.checkNotNullExpressionValue(path2, ReactNativeBlobUtilConst.RNFB_RESPONSE_PATH);
        return path2;
    }
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file, File file2) {
        ...
        if (i <= i2) {
            while (true) {
                int i3 = i2 - 1;
                if (Intrinsics.areEqual((Object) normalize$FilesKt__UtilsKt2.getSegments().get(i2).getName(), (Object) "..")) {
                    return null;
                }
                sb.append("..");
                if (i2 != i) {
