...
public final class FileTreeWalk implements Sequence<File> {
    ...
    public FileTreeWalk(File file, FileWalkDirection fileWalkDirection) {
        ...
        Intrinsics.checkNotNullParameter(file, ViewProps.START);
    ...
    private final class FileTreeWalkIterator extends AbstractIterator<File> {
        ...
        public FileTreeWalkIterator(FileTreeWalk fileTreeWalk) {
            Intrinsics.checkNotNullParameter(fileTreeWalk, "this$0");
        ...
        private final File gotoNext() {
            ...
            while (true) {
                ...
                if (step == null) {
                    this.state.pop();
                } else if (Intrinsics.areEqual((Object) step, (Object) peek.getRoot()) || !step.isDirectory() || this.state.size() >= this.this$0.maxDepth) {
                    return step;
                } else {
        ...
        private final class BottomUpDirectoryState extends DirectoryState {
            ...
            public BottomUpDirectoryState(FileTreeWalkIterator fileTreeWalkIterator, File file) {
                super(file);
                Intrinsics.checkNotNullParameter(fileTreeWalkIterator, "this$0");
                Intrinsics.checkNotNullParameter(file, "rootDir");
