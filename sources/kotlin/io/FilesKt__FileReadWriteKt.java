...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(java.io.File r11) {
        /*
            ...
            long r2 = r11.length()     // Catch:{ all -> 0x00b0 }
            r4 = 2147483647(0x7fffffff, double:1.060997895E-314)
            java.lang.String r6 = "File "
            int r7 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r7 > 0) goto L_0x008e
            int r3 = (int) r2
            byte[] r2 = new byte[r3]     // Catch:{ all -> 0x00b0 }
            r4 = 0
            r5 = r3
            r7 = 0
        L_0x0022:
            if (r5 <= 0) goto L_0x002e
            int r8 = r1.read(r2, r7, r5)     // Catch:{ all -> 0x00b0 }
        ...
        L_0x002e:
            ...
            byte[] r2 = java.util.Arrays.copyOf(r2, r7)     // Catch:{ all -> 0x00b0 }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r8)     // Catch:{ all -> 0x00b0 }
            goto L_0x0070
        L_0x003b:
            int r5 = r1.read()     // Catch:{ all -> 0x00b0 }
            r7 = -1
            if (r5 != r7) goto L_0x0043
            goto L_0x0070
        L_0x0043:
            kotlin.io.ExposingBufferByteArrayOutputStream r7 = new kotlin.io.ExposingBufferByteArrayOutputStream     // Catch:{ all -> 0x00b0 }
            r10 = 8193(0x2001, float:1.1481E-41)
            r7.<init>(r10)     // Catch:{ all -> 0x00b0 }
            r7.write(r5)     // Catch:{ all -> 0x00b0 }
            java.io.InputStream r1 = (java.io.InputStream) r1     // Catch:{ all -> 0x00b0 }
            r5 = r7
            java.io.OutputStream r5 = (java.io.OutputStream) r5     // Catch:{ all -> 0x00b0 }
            r10 = 2
            kotlin.io.ByteStreamsKt.copyTo$default(r1, r5, r4, r10, r9)     // Catch:{ all -> 0x00b0 }
            int r1 = r7.size()     // Catch:{ all -> 0x00b0 }
            int r1 = r1 + r3
            if (r1 < 0) goto L_0x0074
            byte[] r11 = r7.getBuffer()     // Catch:{ all -> 0x00b0 }
            byte[] r1 = java.util.Arrays.copyOf(r2, r1)     // Catch:{ all -> 0x00b0 }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r8)     // Catch:{ all -> 0x00b0 }
            int r2 = r7.size()     // Catch:{ all -> 0x00b0 }
            byte[] r2 = kotlin.collections.ArraysKt.copyInto((byte[]) r11, (byte[]) r1, (int) r3, (int) r4, (int) r2)     // Catch:{ all -> 0x00b0 }
        L_0x0070:
        ...
        L_0x008e:
            ...
            r4.append(r11)     // Catch:{ all -> 0x00b0 }
            java.lang.String r11 = r4.toString()     // Catch:{ all -> 0x00b0 }
            r1.<init>(r11)     // Catch:{ all -> 0x00b0 }
            throw r1     // Catch:{ all -> 0x00b0 }
        L_0x00b0:
            r11 = move-exception
    ...
    public static /* synthetic */ java.lang.Object useLines$default(java.io.File r1, java.nio.charset.Charset r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) {
        ...
        L_0x0023:
            ...
            r2 = 0
            r4 = r1
            java.io.BufferedReader r4 = (java.io.BufferedReader) r4     // Catch:{ all -> 0x003b }
            kotlin.sequences.Sequence r4 = kotlin.io.TextStreamsKt.lineSequence(r4)     // Catch:{ all -> 0x003b }
            java.lang.Object r3 = r3.invoke(r4)     // Catch:{ all -> 0x003b }
