...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    private final boolean filterInPlace(kotlin.jvm.functions.Function1<? super E, java.lang.Boolean> r12) {
        ...
        L_0x0032:
            ...
            r4 = r7[r4]
            java.lang.Object r7 = r12.invoke(r4)
        ...
        L_0x0068:
            ...
            r10[r4] = r5
            java.lang.Object r4 = r12.invoke(r9)
        ...
        L_0x0096:
            ...
            r8[r1] = r5
            java.lang.Object r1 = r12.invoke(r6)
    ...
    public <T> T[] toArray(T[] tArr) {
        ...
        int i = this.head;
        if (i < access$positiveMod) {
            ArraysKt.copyInto$default(this.elementData, (Object[]) tArr, 0, i, access$positiveMod, 2, (Object) null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
            ArraysKt.copyInto((T[]) objArr, tArr, 0, this.head, objArr.length);
            Object[] objArr2 = this.elementData;
            ArraysKt.copyInto((T[]) objArr2, tArr, objArr2.length - this.head, 0, access$positiveMod);
        }
        if (tArr.length > size()) {
            tArr[size()] = null;
        }
