...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public final String toString(Map.Entry<? extends K, ? extends V> entry) {
        return toString((Object) entry.getKey()) + SignatureVisitor.INSTANCEOF + toString((Object) entry.getValue());
    }
    ...
    public static final class Companion {
        ...
        public final int entryHashCode$kotlin_stdlib(Map.Entry<?, ?> entry) {
            Intrinsics.checkNotNullParameter(entry, JWKParameterNames.RSA_EXPONENT);
            Object key = entry.getKey();
            int i = 0;
