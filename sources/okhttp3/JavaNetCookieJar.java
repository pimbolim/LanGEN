...
public final class JavaNetCookieJar implements CookieJar {
    ...
    public List<Cookie> loadForRequest(HttpUrl httpUrl) {
        try {
            ...
            for (Map.Entry next : this.cookieHandler.get(httpUrl.uri(), Collections.emptyMap()).entrySet()) {
                ...
                if ((RequestHeadersFactory.FraudDetection.HEADER_COOKIE.equalsIgnoreCase(str) || "Cookie2".equalsIgnoreCase(str)) && !((List) next.getValue()).isEmpty()) {
    ...
    private List<Cookie> decodeHeaderAsJavaNetCookies(HttpUrl httpUrl, String str) {
        ...
        while (i < length) {
            ...
            int delimiterOffset2 = Util.delimiterOffset(str, i, delimiterOffset, (char) SignatureVisitor.INSTANCEOF);
