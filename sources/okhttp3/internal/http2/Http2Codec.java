...
public final class Http2Codec implements HttpCodec {
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        return new RealResponseBody(response.header(NetworkConstantsKt.HEADER_CONTENT_TYPE), HttpHeaders.contentLength(response), Okio.buffer((Source) new StreamFinishingSource(this.stream.getSource())));
    }
