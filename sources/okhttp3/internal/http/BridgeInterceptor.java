...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (request.header(NetworkConstantsKt.HEADER_USER_AGENT) == null) {
            newBuilder.header(NetworkConstantsKt.HEADER_USER_AGENT, Version.userAgent());
        }
        ...
        if (z && "gzip".equalsIgnoreCase(proceed.header("Content-Encoding")) && HttpHeaders.hasBody(proceed)) {
            ...
            request2.body(new RealResponseBody(proceed.header(NetworkConstantsKt.HEADER_CONTENT_TYPE), -1, Okio.buffer((Source) gzipSource)));
        }
